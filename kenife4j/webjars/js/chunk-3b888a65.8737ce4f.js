(window.webpackJsonp = window.webpackJsonp || []).push([["chunk-3b888a65"], {
    "1d29": function(e, t) {
        ace.define("ace/theme/eclipse", ["require", "exports", "module", "ace/lib/dom"], (function(e, t, i) {
                "use strict";
                t.isDark = !1,
    ...
    2099: function(e, t) {
        ace.define("ace/snippets", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/lib/lang", "ace/range", "ace/anchor", "ace/keyboard/hash_handler", "ace/tokenizer", "ace/lib/dom", "ace/editor"], (function(e, t, i) {
                ...
                (function() {
                        n.implement(this, o),
                                ...
                                var r = this.tokenizeTmSnippet(t.fmt, "formatString")
                                    ...
                                    , a = e.replace(o, (function() {
                                        ...
                                        for (var e = s.resolveVariables(r, i), t = "E", n = 0; n < e.length; n++) {
                                            ...
                                            if ("object" == typeof o)
                                                if (e[n] = "",
                                                o.changeCase && o.local) {
                                                    var a = e[n + 1];
                                                    a && "string" == typeof a && ("u" == o.changeCase ? e[n] = a[0].toUpperCase() : e[n] = a[0].toLowerCase(),
                                                        e[n + 1] = a.substr(1))
                                                } else
                                                    o.changeCase && (t = o.changeCase);
                                            else
                                                "U" == t ? e[n] = o.toUpperCase() : "L" == t && (e[n] = o.toLowerCase())
                                        }
                                        return e.join("")
                                    }
                                ));
                                    ...
                                    if ("string" == typeof o)
                                        ...
                                        if (o.skip)
                                            ...
                                            if (o.text) {
                                                ...
                                                r && o.fmtString && (r = this.tmStrFormat(r, o)),
                                                    o.processed = n,
                                                    null == o.expectIf ? r && (i.push(r),
                                                        s(o)) : r ? o.skip = o.elseBranch : s(o)
                                            } else
                                                (null != o.tabstopId || null != o.changeCase) && i.push(o)
                                        }
                                    }
                                }
                                function s(t) {
                                ...
                                for (var p = 0; p < s.length; p++) {
                                    ...
                                    if ("object" == typeof h) {
                                        ...
                                        if (c[u])
                                            ...
                                            var f = a[u]
                                                , m = "string" == typeof f.value ? [f.value] : l(f.value);
                                            m.unshift(p + 1, Math.max(0, g - p)),
                                                m.push(h),
                                                c[u] = h,
                                                s.splice.apply(s, m),
                            ...
                            this.expandSnippetForSelection = function(e, t) {
                                var i, n = e.getCursorPosition(), o = e.session.getLine(n.row), r = o.substring(0, n.column), s = o.substr(n.column), a = this.snippetMap;
                                return this.getActiveScopes(e).some((function(e) {
                                        var t = a[e];
                                        return t && (i = this.findMatchingSnippet(t, r, s)),
                                            !!i
                                    }
                                ), this),
                                !!i && (t && t.dryRun || (e.session.doc.removeInLine(n.row, n.column - i.replaceBefore.length, n.column + i.replaceAfter.length),
                            ...
                            this.findMatchingSnippet = function(e, t, i) {
                                for (var n = e.length; n--; ) {
                                    var o = e[n];
                                    if ((!o.startRe || o.startRe.test(t)) && (!o.endRe || o.endRe.test(i)) && (o.startRe || o.endRe))
                            ...
                            this.register = function(e, t) {
                                ...
                                function c(e) {
                                    ...
                                    (e.trigger || e.guard || e.endTrigger || e.endGuard) && (e.startRe = a(e.trigger, e.guard, !0),
                                        e.triggerRe = new RegExp(e.trigger,"",!0),
                                        e.endRe = a(e.endTrigger, e.endGuard, !0),
                                        e.endTriggerRe = new RegExp(e.endTrigger,"",!0))
                                }
                                e || (e = []),
                                    e && e.content ? c(e) : Array.isArray(e) && e.forEach(c),
                                ...
                                for (var t, i = [], n = {}, o = /^#.*|^({[\s\S]*})\s*$|^(\S+) (.*)$|^((?:\n*\t.*)+)/gm; t = o.exec(e); ) {
                                    ...
                                    if (t[4])
                                        ...
                                        if ("regex" == r) {
                                            ...
                                            "snippet" == r ? (n.tabTrigger = s.match(/^\S*/)[0],
                                            n.name || (n.name = s)) : n[r] = s
                                    }
                                }
                                return i
                            }
                ...
                (function() {
                        this.attach = function(e) {
                            ...
                            this.onChange = function(e) {
                                ...
                                !this.$inChange && t) {
                                    ...
                                    if (a && !a.some((function(e) {
                                            return p(e.start, i) <= 0 && p(e.end, n) >= 0
                                        }
                                    )))
                                        return this.detach()
                                }
                                for (var c = this.ranges, l = 0; l < c.length; l++) {
                                    var h = c[l];
                                    h.end.row < i.row || (t && p(i, h.start) < 0 && p(n, h.end) > 0 ? (this.removeRange(h),
                                        l--) : (h.start.row == o && h.start.column > i.column && (h.start.column += s),
                                    h.end.row == o && h.end.column >= i.column && (h.end.column += s),
                                    h.start.row >= o && (h.start.row += r),
                                    h.end.row >= o && (h.end.row += r),
                                    p(h.start, h.end) > 0 && this.removeRange(h)))
                                }
                            ...
                            this.addTabstops = function(e, t, i) {
                                ...
                                e.forEach((function(e, i) {
                                        for (var n = this.$openTabstops[i] || e, a = e.length; a--; ) {
                                            var c = e[a]
                                                , l = s.fromPoints(c.start, c.end || c.start);
                                            g(l.start, t),
                                                g(l.end, t),
                                                l.original = c,
                                                l.tabstop = n,
                                                r.push(l),
                                                n != e ? n.unshift(l) : n[a] = l,
                                                c.fmtString ? (l.linked = !0,
                                                    n.hasLinkedRanges = !0) : n.firstNonLinked || (n.firstNonLinked = l)
                                        }
                                        n.firstNonLinked || (n.hasLinkedRanges = !1),
                                        n === e && (o.push(n),
                                            this.$openTabstops[i] = n),
                            ...
                            this.removeRange = function(e) {
                                ...
                                e.tabstop.length || (-1 != (t = this.tabstops.indexOf(e.tabstop)) && this.tabstops.splice(t, 1),
                                this.tabstops.length || this.detach())
                            }
                            ,
                            this.keyboardHandler = new c,
                ...
                var u = {};
                u.onChange = a.prototype.onChange,
            ...
            ace.define("ace/autocomplete/popup", ["require", "exports", "module", "ace/virtual_renderer", "ace/editor", "ace/range", "ace/lib/event", "ace/lib/lang", "ace/lib/dom"], (function(e, t, i) {
                    ...
                    c.importCssString(".ace_editor.ace_autocomplete .ace_marker-layer .ace_active-line {    background-color: #CAD6FA;    z-index: 1;}.ace_editor.ace_autocomplete .ace_line-hover {    border: 1px solid #abbffe;    margin-top: -1px;    background: rgba(233,233,253,0.4);}.ace_editor.ace_autocomplete .ace_line-hover {    position: absolute;    z-index: 2;}.ace_editor.ace_autocomplete .ace_scroller {   background: none;   border: none;   box-shadow: none;}.ace_rightAlignedText {    color: gray;    display: inline-block;    position: absolute;    right: 4px;    text-align: right;    z-index: -1;}.ace_editor.ace_autocomplete .ace_completion-highlight{    color: #000;    text-shadow: 0 0 0.01em;}.ace_editor.ace_autocomplete {    width: 280px;    z-index: 200000;    background: #fbfbfb;    color: #444;    border: 1px lightgray solid;    position: fixed;    box-shadow: 2px 3px 5px rgba(0,0,0,.2);    line-height: 1.4;}"),
                        t.AcePopup = function(e) {
                            ...
                            i.focus = o,
                                i.$isFocused = !0,
                                i.renderer.$cursorLayer.restartTimer = o,
                            ...
                            var p = new r(-1,0,-1,1 / 0)
                                , h = new r(-1,0,-1,1 / 0);
                            h.id = i.session.addMarker(h, "ace_active-line", "fullLine"),
                                i.setSelectOnHover = function(e) {
                                    e ? p.id && (i.session.removeMarker(p.id),
                                        p.id = null) : p.id = i.session.addMarker(p, "ace_line-hover", "fullLine")
                                }
                                ,
                            ...
                            var d = function() {
                                ...
                                , u = function(e, t) {
                                e !== p.start.row && (p.start.row = p.end.row = e,
                            ...
                            return g.$tokenizeRow = function(e) {
                                ...
                                for (var o, r, s = -1, a = 0; a < t.caption.length; a++)
                                    r = t.caption[a],
                                        s !== (o = t.matchMask & 1 << a ? 1 : 0) ? (n.push({
                                ...
                                if (t.meta) {
                                    var c = i.renderer.$size.scrollerWidth / i.renderer.layerConfig.characterWidth
                                        , l = t.meta;
                                    l.length + t.caption.length > c - 2 && (l = l.substr(0, c - t.caption.length - 3) + "…"),
                                        n.push({
                                ...
                                i.setRow = function(e) {
                                    ...
                                    h.start.row != e && (i.selection.clearSelection(),
                                ...
                                ,
                                i.show = function(e, t, o) {
                                    var r = this.container
                                        , s = window.innerHeight
                                        , a = window.innerWidth
                                        , c = this.renderer
                                        , l = c.$maxLines * t * 1.4
                                        , p = e.top + this.$borderSize;
                                    p > s / 2 && !o && p + t + l > s ? (c.$maxPixelHeight = p - 2 * this.$borderSize,
                                        r.style.top = "",
                                        r.style.bottom = s - p + "px",
                                        i.isTopdown = !1) : (p += t,
                                        c.$maxPixelHeight = s - p - .2 * t,
                                        r.style.top = p + "px",
                                        r.style.bottom = "",
                                        i.isTopdown = !0),
                                        r.style.display = "",
                                    ...
                                    var h = e.left;
                                    h + r.offsetWidth > a && (h = a - r.offsetWidth),
                                        r.style.left = h + "px",
                                        this._signal("show"),
                                        n = null,
                                        i.isOpen = !0
            ...
            ace.define("ace/autocomplete", ["require", "exports", "module", "ace/keyboard/hash_handler", "ace/autocomplete/popup", "ace/autocomplete/util", "ace/lib/event", "ace/lib/lang", "ace/lib/dom", "ace/snippets"], (function(e, t, i) {
                    ...
                    (function() {
                            this.$init = function() {
                                return this.popup = new o(document.body || document.documentElement),
                                ...
                                this.insertMatch = function(e, t) {
                                    ...
                                    if (e.completer && e.completer.insertMatch)
                                        ...
                                        if (this.completions.filterText)
                                            for (var i, n = this.editor.selection.getAllRanges(), o = 0; i = n[o]; o++)
                                ...
                                this.gatherCompletions = function(e, t) {
                                    ...
                                    return e.completers.forEach((function(c, l) {
                                            c.getCompletions(e, i, n, o, (function(i, n) {
                                                    !i && n && (s = s.concat(n)),
                                                        t(null, {
                                                            prefix: r.getCompletionPrefix(e),
                                                            matches: s,
                                                            finished: 0 == --a
                                                        })
                                                }
                                ...
                                this.updateCompletions = function(e) {
                                    if (e && this.base && this.completions) {
                                        ...
                                        if (i == this.completions.filterText)
                                            return;
                                        return this.completions.setFilter(i),
                                            this.completions.filtered.length && (1 != this.completions.filtered.length || this.completions.filtered[0].value != i || this.completions.filtered[0].snippet) ? void this.openPopup(this.editor, i, e) : this.detach()
                                    }
                                ...
                                this.showDocTooltip = function(e) {
                                    ...
                                    t.style.top = i.container.style.top,
                                        ...
                                        window.innerWidth - n.right < 320 ? (t.style.right = window.innerWidth - n.left + "px",
                                            t.style.left = "") : (t.style.left = n.right + 1 + "px",
                                            t.style.right = ""),
            ...
            ace.define("ace/ext/language_tools", ["require", "exports", "module", "ace/snippets", "ace/autocomplete", "ace/config", "ace/lib/lang", "ace/autocomplete/util", "ace/autocomplete/text_completer", "ace/editor", "ace/config"], (function(e, t, i) {
                    ...
                    var d = {
                        ...
                        if (e && !n.files[e]) {
                            ...
                            n.files[e] = {},
                                r.loadModule(t, (function(t) {
                                        t && (n.files[e] = t,
                                        !t.snippets && t.snippetText && (t.snippets = n.parseSnippetFile(t.snippetText)),
                                            n.register(t.snippets || [], t.scope),
                                        t.includeScopes && (n.snippetMap[t.scope].includeScopes = t.includeScopes,
                        ...
                        if ("backspace" === e.command.name)
                            ...
                            a.getCompletionPrefix(t) && !i && (t.completer || (t.completer = new o),
                        ...
                        enableBasicAutocompletion: {
                            set: function(e) {
                                e ? (this.completers || (this.completers = Array.isArray(e) ? e : h),
                                    this.commands.addCommand(o.startCommand)) : this.commands.removeCommand(o.startCommand)
                            },
                            value: !1
                        },
                        ...
                        enableSnippets: {
                            set: function(e) {
                                e ? (this.commands.addCommand(d),
                                    ...
                                    u(0, this)) : (this.commands.removeCommand(d),
