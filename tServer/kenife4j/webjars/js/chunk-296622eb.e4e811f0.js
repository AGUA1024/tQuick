(window.webpackJsonp = window.webpackJsonp || []).push([["chunk-296622eb"], {
    "036e": function(e, t, n) {
        "use strict";
    ...
    "04ca": function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            ,
            t.assertClassAccessorProperty = function(e, t) {
                i("ClassAccessorProperty", e, t)
            }
            ,
        ...
        ,
        t.assertTSInstantiationExpression = function(e, t) {
            i("TSInstantiationExpression", e, t)
        }
        ,
        ...
        function i(e, t, n) {
            if (!(0,
                r.default)(e, t, n))
                throw new Error(`Expected type "${e}" with option ${JSON.stringify(n)}, but instead got "${t.type}".`)
        }
    },
    "075e": function(e, t) {},
    "09ba": function(e, t) {
        ...
        function o(e) {
            ...
            for (var o, s = t.isAbsolute(n), l = n.split(/\/+/), u = 0, p = l.length - 1; p >= 0; p--)
                "." === (o = l[p]) ? l.splice(p, 1) : ".." === o ? u++ : u > 0 && ("" === o ? (l.splice(p + 1, u),
                    u = 0) : (l.splice(p, 2),
                    u--));
            return "" === (n = l.join("/")) && (n = s ? "/" : "."),
                r ? (r.path = n,
    ...
    "09c8": function(e, t, n) {
        ...
        var r = n("4f38").__importDefault(n("41ba"));
        t.default = function(e) {
            var t = e.use(r.default)
                , n = t.Type
                , i = t.builtInTypes
                , a = i.number
                , o = n.or(i.string, i.number, i.boolean, i.null, i.undefined);
            return {
                geq: function(e) {
    ...
    1267: function(e, t, n) {
        ...
        var r = n("4f38")
            , i = r.__importDefault(n("3fe2"))
            , a = r.__importDefault(n("41ba"))
            , o = r.__importDefault(n("09c8"));
        t.default = function(e) {
            e.use(i.default);
            var t = e.use(a.default)
                , n = e.use(o.default).defaults
                , r = t.Type.def
                , s = t.Type.or;
            r("Noop").bases("Statement").build(),
                r("DoExpression").bases("Expression").build("body").field("body", [r("Statement")]),
                r("BindExpression").bases("Expression").build("object", "callee").field("object", s(r("Expression"), null)).field("callee", r("Expression")),
                r("ParenthesizedExpression").bases("Expression").build("expression").field("expression", r("Expression")),
                r("ExportNamespaceSpecifier").bases("Specifier").build("exported").field("exported", r("Identifier")),
                r("ExportDefaultSpecifier").bases("Specifier").build("exported").field("exported", r("Identifier")),
                r("CommentBlock").bases("Comment").build("value", "leading", "trailing"),
                r("CommentLine").bases("Comment").build("value", "leading", "trailing"),
                r("Directive").bases("Node").build("value").field("value", r("DirectiveLiteral")),
                r("DirectiveLiteral").bases("Node", "Expression").build("value").field("value", String, n["use strict"]),
                r("InterpreterDirective").bases("Node").build("value").field("value", String),
                r("BlockStatement").bases("Statement").build("body").field("body", [r("Statement")]).field("directives", [r("Directive")], n.emptyArray),
                r("Program").bases("Node").build("body").field("body", [r("Statement")]).field("directives", [r("Directive")], n.emptyArray).field("interpreter", s(r("InterpreterDirective"), null), n.null),
                r("StringLiteral").bases("Literal").build("value").field("value", String),
                r("NumericLiteral").bases("Literal").build("value").field("value", Number).field("raw", s(String, null), n.null).field("extra", {
                    rawValue: Number,
                    raw: String
                }, (function() {
                        return {
                ...
                r("BigIntLiteral").bases("Literal").build("value").field("value", s(String, Number)).field("extra", {
                    rawValue: String,
                    raw: String
                }, (function() {
                        return {
                ...
                r("NullLiteral").bases("Literal").build().field("value", null, n.null),
                r("BooleanLiteral").bases("Literal").build("value").field("value", Boolean),
                r("RegExpLiteral").bases("Literal").build("pattern", "flags").field("pattern", String).field("flags", String).field("value", RegExp, (function() {
                        return new RegExp(this.pattern,this.flags)
                    }
                ));
            var l = s(r("Property"), r("ObjectMethod"), r("ObjectProperty"), r("SpreadProperty"), r("SpreadElement"));
            r("ObjectExpression").bases("Expression").build("properties").field("properties", [l]),
                r("ObjectMethod").bases("Node", "Function").build("kind", "key", "params", "body", "computed").field("kind", s("method", "get", "set")).field("key", s(r("Literal"), r("Identifier"), r("Expression"))).field("params", [r("Pattern")]).field("body", r("BlockStatement")).field("computed", Boolean, n.false).field("generator", Boolean, n.false).field("async", Boolean, n.false).field("accessibility", s(r("Literal"), null), n.null).field("decorators", s([r("Decorator")], null), n.null),
                r("ObjectProperty").bases("Node").build("key", "value").field("key", s(r("Literal"), r("Identifier"), r("Expression"))).field("value", s(r("Expression"), r("Pattern"))).field("accessibility", s(r("Literal"), null), n.null).field("computed", Boolean, n.false);
            var u = s(r("MethodDefinition"), r("VariableDeclarator"), r("ClassPropertyDefinition"), r("ClassProperty"), r("ClassPrivateProperty"), r("ClassMethod"), r("ClassPrivateMethod"));
            r("ClassBody").bases("Declaration").build("body").field("body", [u]),
                r("ClassMethod").bases("Declaration", "Function").build("kind", "key", "params", "body", "computed", "static").field("key", s(r("Literal"), r("Identifier"), r("Expression"))),
                r("ClassPrivateMethod").bases("Declaration", "Function").build("key", "params", "body", "kind", "computed", "static").field("key", r("PrivateName")),
                ["ClassMethod", "ClassPrivateMethod"].forEach((function(e) {
                        r(e).field("kind", s("get", "set", "method", "constructor"), (function() {
                                return "method"
                            }
                        )).field("body", r("BlockStatement")).field("computed", Boolean, n.false).field("static", s(Boolean, null), n.null).field("abstract", s(Boolean, null), n.null).field("access", s("public", "private", "protected", null), n.null).field("accessibility", s("public", "private", "protected", null), n.null).field("decorators", s([r("Decorator")], null), n.null).field("optional", s(Boolean, null), n.null)
                    }
                ));
            var p = s(r("Property"), r("PropertyPattern"), r("SpreadPropertyPattern"), r("SpreadProperty"), r("ObjectProperty"), r("RestProperty"));
            r("ObjectPattern").bases("Pattern").build("properties").field("properties", [p]).field("decorators", s([r("Decorator")], null), n.null),
                r("SpreadProperty").bases("Node").build("argument").field("argument", r("Expression")),
                r("RestProperty").bases("Node").build("argument").field("argument", r("Expression")),
                r("ForAwaitStatement").bases("Statement").build("left", "right", "body").field("left", s(r("VariableDeclaration"), r("Expression"))).field("right", r("Expression")).field("body", r("Statement")),
                r("Import").bases("Expression").build()
        }
            ,
            e.exports = t.default
    },
    ...
    "16e6": function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.LogicalOperators = t.AssignmentOperators = t.BinaryOperators = void 0,
            t.BinaryOperators = ["==", "!=", "===", "!==", "<", "<=", ">", ">=", "<<", ">>", ">>>", "+", "-", "*", "/", "%", "&", "|", "^", "in", "instanceof"],
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.default = function(e, t, n) {
                if (!t)
                    return !1;
                return (0,
                    i.default)(t.type, e) ? void 0 === n || (0,
                    r.default)(t, n) : !n && "Placeholder" === t.type && e in o.FLIPPED_ALIAS_KEYS && (0,
                    a.default)(t.expectedNode, e)
            }
        ;
        var r = n("392e")
            , i = n("1093")
    ...
    "19fa3": function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        });
        var r = n("4f38")
            , i = r.__importDefault(n("1e1f"))
            , a = r.__importDefault(n("41ba"))
            , o = r.__importDefault(n("09c8"));
        t.default = function(e) {
            e.use(i.default);
            var t = e.use(a.default)
                ...
                , r = t.Type.def
                , s = t.Type.or;
            r("VariableDeclaration").field("declarations", [s(r("VariableDeclarator"), r("Identifier"))]),
                r("Property").field("value", s(r("Expression"), r("Pattern"))),
                r("ArrayPattern").field("elements", [s(r("Pattern"), r("SpreadElement"), null)]),
                r("ObjectPattern").field("properties", [s(r("Property"), r("PropertyPattern"), r("SpreadPropertyPattern"), r("SpreadProperty"))]),
                r("ExportSpecifier").bases("ModuleSpecifier").build("id", "name"),
                r("ExportBatchSpecifier").bases("Specifier").build(),
                r("ExportDeclaration").bases("Declaration").build("default", "declaration", "specifiers", "source").field("default", Boolean).field("declaration", s(r("Declaration"), r("Expression"), null)).field("specifiers", [s(r("ExportSpecifier"), r("ExportBatchSpecifier"))], n.emptyArray).field("source", s(r("Literal"), null), n.null),
                r("Block").bases("Comment").build("value", "leading", "trailing"),
                r("Line").bases("Comment").build("value", "leading", "trailing")
        }
            ,
            e.exports = t.default
    },
    "1aff": function(e, t, n) {
                ...
                for (let l = 0; l < t.length; l++) {
                    ...
                    if (u && !(s.indexOf(u) >= 0)) {
                        ...
                        if ((0,
                            ...
                            r.isTSUnionType)(u))
                            o.has(u.types) || (t.push(...u.types),
                                o.add(u.types));
                        else if ((0,
                            r.isTSTypeReference)(u) && u.typeParameters) {
                            const t = i(u.typeName);
                            if (n.has(t)) {
                                let r = n.get(t);
        ...
        function i(e) {
            return (0,
                r.isIdentifier)(e) ? e.name : `${e.right.name}.${i(e.left)}`
        }
    },
    "1cf8": function(e, t, n) {
        "use strict";
    ...
    "1e1f": function(e, t, n) {
        ...
        var r = n("4f38")
            , i = n("16e6")
            , a = r.__importDefault(n("c8da"))
            , o = r.__importDefault(n("41ba"))
            , s = r.__importDefault(n("09c8"));
        t.default = function(e) {
            e.use(a.default);
            var t = e.use(o.default)
                , n = t.Type.def
                , l = t.Type.or
                , u = e.use(s.default).defaults;
            n("ImportExpression").bases("Expression").build("source").field("source", n("Expression")),
                n("ExportAllDeclaration").build("source", "exported").field("source", n("Literal")).field("exported", l(n("Identifier"), null)),
                n("ChainElement").bases("Node").field("optional", Boolean, u.false),
                n("CallExpression").bases("Expression", "ChainElement"),
                n("MemberExpression").bases("Expression", "ChainElement"),
                n("ChainExpression").bases("Expression").build("expression").field("expression", n("ChainElement")),
                n("OptionalCallExpression").bases("CallExpression").build("callee", "arguments", "optional").field("optional", Boolean, u.true),
                n("OptionalMemberExpression").bases("MemberExpression").build("object", "property", "computed", "optional").field("optional", Boolean, u.true);
            var p = l.apply(void 0, r.__spreadArrays(i.LogicalOperators, ["??"]));
            n("LogicalExpression").field("operator", p)
        }
            ,
            e.exports = t.default
    },
    "21b1": function(e, t, n) {
        ...
        t.default = function(e) {
            var t = e.use(r.default)
                , n = t.getFieldNames
                , i = t.getFieldValue
                , a = t.builtInTypes.array
                , o = t.builtInTypes.object
                , s = t.builtInTypes.Date
                , l = t.builtInTypes.RegExp
                , u = Object.prototype.hasOwnProperty;
            function p(e, t, n) {
                return a.check(n) ? n.length = 0 : n = null,
                    d(e, t, n)
            }
            function c(e) {
            ...
            function d(e, t, n) {
                return e === t || (a.check(e) ? function(e, t, n) {
                    a.assert(e);
                    var r = e.length;
                    if (!a.check(t) || t.length !== r)
                        return n && n.push("length"),
                            !1;
                    for (var i = 0; i < r; ++i) {
                        if (n && n.push(i),
                        i in e != i in t)
                    ...
                    return !0
                }(e, t, n) : o.check(e) ? f(e, t, n) : s.check(e) ? s.check(t) && +e == +t : l.check(e) ? l.check(t) && e.source === t.source && e.global === t.global && e.multiline === t.multiline && e.ignoreCase === t.ignoreCase : e == t)
            }
            function f(e, t, r) {
                if (o.assert(e),
                    !o.check(t))
            ...
            return p.assert = function(e, t) {
                var n = [];
                if (!p(e, t, n)) {
                    if (0 !== n.length)
                        throw new Error("Nodes differ in the following path: " + n.map(c).join(""));
                    if (e !== t)
    ...
    "252a": function(e, t, n) {
        ...
        Object.keys(me).forEach((function(e) {
                "default" !== e && "__esModule" !== e && (Object.prototype.hasOwnProperty.call(r, e) || e in t && t[e] === me[e] || Object.defineProperty(t, e, {
                    enumerable: !0,
                    get: function() {
                        return me[e]
                    }
    ...
    "27b5": function(e, t, n) {
        ...
        function o(e, t=e.key) {
            let n;
            return "method" === e.kind ? o.increment() + "" : (n = (0,
                r.isIdentifier)(t) ? t.name : (0,
                r.isStringLiteral)(t) ? JSON.stringify(t.value) : JSON.stringify((0,
                a.default)((0,
                i.default)(t))),
            e.computed && (n = `[${n}]`),
            e.static && (n = "static:" + n),
    ...
    "27f6": function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.default = function(e) {
                ...
                for (const n of e)
                    t += (0,
                        i.isIdentifierChar)(n.codePointAt(0)) ? n : "-";
                return t = t.replace(/^[-0-9]+/, ""),
    ...
    2908: function(e, t, n) {
        ...
        t.default = function(e) {
            ...
            var t = e.use(a.default)
                , n = t.Type.def
                , r = t.Type.or
                , s = e.use(o.default).defaults;
            n("ForOfStatement").field("await", Boolean, s.false),
                n("SpreadProperty").bases("Node").build("argument").field("argument", n("Expression")),
                n("ObjectExpression").field("properties", [r(n("Property"), n("SpreadProperty"), n("SpreadElement"))]),
                n("TemplateElement").field("value", {
                    cooked: r(String, null),
                    raw: String
                }),
                n("SpreadPropertyPattern").bases("Pattern").build("argument").field("argument", n("Pattern")),
                n("ObjectPattern").field("properties", [r(n("PropertyPattern"), n("Property"), n("RestElement"), n("SpreadPropertyPattern"))])
        }
            ,
            e.exports = t.default
    },
        ...
        o.fromArray = function(e, t) {
            ...
            o.prototype.add = function(e, t) {
                var n = a ? e : r.toSetString(e)
                    , o = a ? this.has(e) : i.call(this._set, n)
    ...
    "2c86": function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.default = function(e, t) {
                if (!e || !t)
                    return e;
                for (const n of r.INHERIT_KEYS.optional)
                    null == e[n] && (e[n] = t[n]);
                for (const n of Object.keys(t))
                    "_" === n[0] && "__clone" !== n && (e[n] = t[n]);
                for (const n of r.INHERIT_KEYS.force)
                    e[n] = t[n];
                return (0,
                    i.default)(e, t),
                    e
    ...
    "36cd": function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.ImportSpecifier = function(e) {
                "type" !== e.importKind && "typeof" !== e.importKind || (this.word(e.importKind),
                    this.space()),
                    this.print(e.imported, e),
                e.local && e.local.name !== e.imported.name && (this.space(),
                    this.word("as"),
                    this.space(),
            ...
            t.ExportSpecifier = function(e) {
                this.print(e.local, e),
                e.exported && e.local.name !== e.exported.name && (this.space(),
                    this.word("as"),
                    this.space(),
                    this.print(e.exported, e))
            }
            ...
            t.ExportAllDeclaration = function(e) {
                this.word("export"),
                    this.space(),
                "type" === e.exportKind && (this.word("type"),
                    this.space()),
                    this.token("*"),
                    this.space(),
                    this.word("from"),
            ...
            t.ImportDeclaration = function(e) {
                ...
                this.print(e.source, e),
                    this.printAssertions(e),
                null != (n = e.attributes) && n.length && (this.space(),
                    this.word("with"),
                    this.space(),
        ...
        ;
        var r = n("252a");
        const {isClassDeclaration: i, isExportDefaultSpecifier: a, isExportNamespaceSpecifier: o, isImportDefaultSpecifier: s, isImportNamespaceSpecifier: l, isStatement: u} = r;
        function p(e) {
            if (e.declaration) {
                ...
                (t.length || !t.length && !n) && (this.token("{"),
                t.length && (this.space(),
                    this.printList(t, e),
                    this.space()),
                    this.token("}")),
    ...
    "3fe2": function(e, t, n) {
        ...
        var r = n("4f38")
            , i = r.__importDefault(n("41ba"))
            , a = r.__importDefault(n("09c8"))
            , o = r.__importDefault(n("1e1f"));
        t.default = function(e) {
            e.use(o.default);
            var t = e.use(i.default)
                , n = t.Type
                , r = t.Type.def
                , s = n.or
                , l = e.use(a.default).defaults;
            r("AwaitExpression").build("argument", "all").field("argument", s(r("Expression"), null)).field("all", Boolean, l.false),
                r("Decorator").bases("Node").build("expression").field("expression", r("Expression")),
                r("Property").field("decorators", s([r("Decorator")], null), l.null),
                r("MethodDefinition").field("decorators", s([r("Decorator")], null), l.null),
                r("PrivateName").bases("Expression", "Pattern").build("id").field("id", r("Identifier")),
                r("ClassPrivateProperty").bases("ClassProperty").build("key", "value").field("key", r("PrivateName")).field("value", s(r("Expression"), null), l.null)
        }
            ,
            e.exports = t.default
    },
    ...
    "41ba": function(e, t, n) {
        ...
        var r = n("4f38")
            ...
            return e.prototype.assert = function(e, t) {
                if (!this.check(e, t)) {
                    var n = m(e);
                    throw new Error(n + " does not match type " + this)
                }
                return !0
            }
                ,
            ...
            return r.__extends(t, e),
                ...
                t.prototype.check = function(e, t) {
                    var n = e === this.value;
                    return n || "function" != typeof t || t(this, e),
                        n
                }
                ,
                t
            ...
            return r.__extends(t, e),
                ...
                ,
                t.prototype.check = function(e, t) {
                    return a.call(e) === a.call({}) && this.fields.every((function(n) {
                            return n.type.check(e[n.name], t)
                        }
                    ))
                }
                ,
            ...
            return e.prototype.isSupertypeOf = function(t) {
                if (t instanceof e) {
                    if (!0 !== this.finalized || !0 !== t.finalized)
                        throw new Error("");
                    return o.call(t.allSupertypes, this.typeName)
                }
                throw new Error(t + " is not a Def")
            }
                ,
                e.prototype.checkAllFields = function(e, t) {
                    var n = this.allFields;
                    if (!0 !== this.finalized)
                        throw new Error("" + this.typeName);
                    return null !== e && "object" == typeof e && Object.keys(n).every((function(r) {
                            var i = n[r]
                                , a = i.type
                                , o = i.getValue(e);
                            return a.check(o, t)
        ...
        var y = function() {
            ...
            return e.prototype.toString = function() {
                ...
                e.prototype.getValue = function(e) {
                    var t = e[this.name];
                    return void 0 !== t || "function" == typeof this.defaultFn && (t = this.defaultFn.call(e)),
                        t
                }
                ,
                e
        ...
        function m(e) {
            return Array.isArray(e) ? "[" + e.map(m).join(", ") + "]" : e && "object" == typeof e ? "{ " + Object.keys(e).map((function(t) {
                    return t + ": " + e[t]
                }
        ...
        t.default = function(e) {
            var t = {
                or: function() {
                    for (var e = [], n = 0; n < arguments.length; n++)
                        e[n] = arguments[n];
                    return new c(e.map((function(e) {
                            return t.from(e)
                        }
                    )))
                },
                from: function(e, r) {
                    if (e instanceof l || e instanceof u || e instanceof p || e instanceof c || e instanceof d)
                        return e;
                    if (e instanceof f)
                        return e.type;
                    if (b.check(e)) {
                        ...
                        return new l(t.from(e[0]))
                    }
                    if (S.check(e))
                        return new p(Object.keys(e).map((function(n) {
                                return new y(n,t.from(e[n], n))
                            }
                        )));
                ...
                def: function(e) {
                    return o.call(_, e) ? _[e] : _[e] = new I(e)
                },
                hasDef: function(e) {
                    return o.call(_, e)
                }
            ...
            function s(e, t) {
                var r = a.call(t)
                    , o = new d(e,(function(e) {
                        return a.call(e) === r
                    }
                ));
                return t && "function" == typeof t.constructor && (n.push(t.constructor),
                    i.push(o)),
                    o
            }
            var h = s("string", "truthy")
                , T = s("function", (function() {}
            ))
                , b = s("array", [])
                , S = s("object", {})
                , E = s("RegExp", /./)
            ...
            var I = function(e) {
                function n(t) {
                    var n = e.call(this, new d(t,(function(e, t) {
                            return n.check(e, t)
                        }
                    )), t) || this;
                    return n
                ...
                return r.__extends(n, e),
                    n.prototype.check = function(e, t) {
                        ...
                        if (null === e || "object" != typeof e)
                            return !1;
                        var n = w(e);
                        return n ? t && n === this ? this.checkAllFields(e, t) : !!this.isSupertypeOf(n) && (!t || n.checkAllFields(e, t) && this.checkAllFields(e, !1)) : ("SourceLocation" === this.typeName || "Position" === this.typeName) && this.checkAllFields(e, t)
                    }
                    ,
                    n.prototype.build = function() {
                        for (var e = this, t = [], n = 0; n < arguments.length; n++)
                            t[n] = arguments[n];
                        if (this.buildParams = t,
                            this.buildable)
                            return this;
                        ...
                        var r = function(t, n, r, i) {
                            if (!o.call(t, n)) {
                                ...
                                if (!o.call(a, n))
                                    throw new Error("" + n);
                                var s, l = a[n], u = l.type;
                                if (i)
                                    s = r;
                                else {
                                    if (!l.defaultFn) {
                                        var p = "no value or default function given for field " + JSON.stringify(n) + " of " + e.typeName + "(" + e.buildParams.map((function(e) {
                                                return a[e]
                                            }
                                        )).join(", ") + ")";
                                        throw new Error(p)
                                    }
                                    s = l.defaultFn.call(t)
                                }
                                if (!u.check(s))
                                    throw new Error(m(s) + " does not match field " + l + " of type " + e.typeName);
                                t[n] = s
                            }
                        }
                            , i = function() {
                            ...
                            if (e.buildParams.forEach((function(e, n) {
                                    n < i ? r(a, e, t[n], !0) : r(a, e, null, !1)
                                }
                            )),
                        ...
                        return i.from = function(t) {
                            ...
                            if (Object.keys(e.allFields).forEach((function(e) {
                                    o.call(t, e) ? r(n, e, t[e], !0) : r(n, e, null, !1)
                                }
                            )),
                            n.type !== e.typeName)
                                throw new Error("");
                            ...
                            ,
                            Object.defineProperty(N, j(this.typeName), {
                                enumerable: !0,
                                value: i
                            }),
                            this
                    ...
                    ,
                    n.prototype.field = function(e, n, r, i) {
                        return this.finalized || (this.ownFields[e] = new y(e,t.from(n),r,i)),
                            this
                    }
                    ,
                    n.prototype.finalize = function() {
                        ...
                        if (!this.finalized) {
                            var t = this.allFields
                                , n = this.allSupertypes;
                            for (var r in this.baseNames.forEach((function(r) {
                                    var i = _[r];
                                    if (!(i instanceof f)) {
                                ...
                                B(t, this.ownFields),
                                n[this.typeName] = this,
                                this.fieldNames.length = 0,
                                t)
                                o.call(t, r) && !t[r].hidden && this.fieldNames.push(r);
                            Object.defineProperty(L, this.typeName, {
                                enumerable: !0,
                                value: this.type
                            }),
                                this.finalized = !0,
                                function(e, t) {
                                    ...
                                    for (var n = Object.create(null), r = 0; r < t.length; ++r) {
                                        ...
                                        if (!0 !== i.finalized)
                                            throw new Error("");
                                        o.call(n, e) && delete t[n[e]],
                                            n[e] = r,
                                            t.push.apply(t, i.baseNames)
                                    }
                                    for (var a = 0, s = a, l = t.length; s < l; ++s)
                                        o.call(t, s) && (t[a++] = t[s]);
                                    t.length = a
                                }(this.typeName, this.supertypeList),
                            this.buildable && this.supertypeList.lastIndexOf("Expression") >= 0 && function(e) {
                                var t = C(e);
                                if (!N[t]) {
                                    var n = N[j(e)];
                                    if (n) {
                                        var r = function() {
                                            for (var e = [], t = 0; t < arguments.length; t++)
                                                e[t] = arguments[t];
                                            return N.expressionStatement(n.apply(N, e))
                                        };
                                        r.from = function() {
                                            for (var e = [], t = 0; t < arguments.length; t++)
                                                e[t] = arguments[t];
                                            return N.expressionStatement(n.from.apply(N, e))
                                        }
                                            ,
                                            N[t] = r
                                    }
            ...
            function C(e) {
                return (e = j(e)).replace(/(Expression)?$/, "Statement")
            }
            var L = {};
            function k(e) {
                var t = w(e);
            ...
            return {
                ...
                computeSupertypeLookupTable: function(e) {
                    for (var t = {}, n = Object.keys(_), r = n.length, i = 0; i < r; ++i) {
                        var a = n[i]
                            , s = _[a];
                        if (!0 !== s.finalized)
                            throw new Error("" + a);
                        for (var l = 0; l < s.supertypeList.length; ++l) {
                            var u = s.supertypeList[l];
                            if (o.call(e, u)) {
                                t[a] = u;
                                break
                            }
                ...
                builders: N,
                defineMethod: function(e, t) {
                    var n = D[e];
                    return A.check(t) ? delete D[e] : (T.assert(t),
                ...
                getBuilderName: j,
                getStatementBuilderName: C,
                namedTypes: L,
                getFieldNames: k,
                getFieldValue: M,
                eachField: function(e, t, n) {
                    k(e).forEach((function(n) {
                            t.call(this, n, M(e, n))
                        }
                    ), n)
                },
                someField: function(e, t, n) {
                    return k(e).some((function(n) {
                            return t.call(this, n, M(e, n))
                        }
                    ), n)
                },
                finalize: function() {
    ...
    "43fd": function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.needsParens = function(e, t, n) {
                return !!t && (!(!u(t) || t.callee !== e || !function e(t) {
                    return !!o(t) || l(t) && e(t.object)
                }(e)) || y(c, e, t, n))
            }
        ;
        var r = n("fb84")
            , i = n("aa71")
            , a = n("252a");
        const {isCallExpression: o, isExpressionStatement: s, isMemberExpression: l, isNewExpression: u} = a;
        function p(e) {
            const t = {};
            function n(e, n) {
                const r = t[e];
            ...
            for (const t of Object.keys(e)) {
                const r = a.FLIPPED_ALIAS_KEYS[t];
                if (r)
                    for (const i of r)
                        n(i, e[t]);
                else
        ...
        function m(e, t, n) {
            ...
            if (!r) {
                const i = y(f, e, t);
                if (i)
                    for (let t = 0; t < i.length && (r = m(i[t], e, n),
                        !r); t++)
                        ;
            }
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.default = function(e, t, n) {
                if (!n || !e)
                    return e;
                const r = t + "Comments";
                return e[r] ? "leading" === t ? e[r] = n.concat(e[r]) : e[r].push(...n) : e[r] = n,
                    e
            }
    },
    "4b53": function(e, t, n) {
        ...
        var r = n("4f38")
            , i = r.__importDefault(n("9e61"))
            , a = r.__importDefault(n("41ba"))
            , o = r.__importDefault(n("09c8"));
        t.default = function(e) {
            e.use(i.default);
            var t = e.use(a.default).Type.def
                , n = e.use(o.default).defaults;
            t("Function").field("async", Boolean, n.false),
                t("AwaitExpression").bases("Expression").build("argument").field("argument", t("Expression"))
        }
            ,
            e.exports = t.default
    },
    "4ee2": function(e, t, n) {
        ...
        const s = /e/i
            ...
            , u = /^0[box]/
            , p = /^\s*[@#]__PURE__\s*$/
            , {isProgram: c, isFile: d, isEmptyStatement: f} = a
            , {needsParens: y, needsWhitespaceAfter: m, needsWhitespaceBefore: h} = i;
        class T {
            constructor(e, t) {
            ...
            number(e) {
                this.word(e),
                    this._endsWithInteger = Number.isInteger(+e) && !u.test(e) && !s.test(e) && !l.test(e) && 46 !== e.charCodeAt(e.length - 1)
            }
            token(e) {
            ...
            _maybeAddParen(e) {
                ...
                if ("\n" !== r) {
                    ...
                    const t = e[n + 1];
                    if ("*" === t) {
                        if (p.test(e.slice(n + 2, e.length - 2)))
                            return
                    } else if ("/" !== t)
                        return void (this._parenPushNewlineState = null)
                }
            ...
            startTerminatorless(e=!1) {
                return e ? (this._noLineTerminator = !0,
            ...
            print(e, t) {
                ...
                const r = this[e.type];
                if (!r)
                    throw new ReferenceError(`unknown node of type ${JSON.stringify(e.type)} with constructor ${JSON.stringify(null == e ? void 0 : e.constructor.name)}`);
                this._printStack.push(e);
                const i = this._insideAux;
                this._insideAux = !e.loc,
                    this._maybeAddAuxComment(this._insideAux && !i);
                let a = y(e, t, this._printStack);
                this.format.retainFunctionParens && "FunctionExpression" === e.type && e.extra && e.extra.parenthesized && (a = !0),
                a && this.token("("),
                    this._printLeadingComments(e);
                const o = c(e) || d(e) ? null : e.loc;
            ...
            printJoin(e, t, n={}) {
                ...
                for (let i = 0; i < e.length; i++) {
                    const a = e[i];
                    a && (n.statement && this._printNewline(!0, a, t, r),
                        this.print(a, t),
            ...
            printInnerComments(e, t=!0) {
                var n;
                null != (n = e.innerComments) && n.length && (t && this.indent(),
                    this._printComments(e.innerComments),
                t && this.dedent())
            }
            printSequence(e, t, n={}) {
                return n.statement = !0,
                    this.printJoin(e, t, n)
            }
            printList(e, t, n={}) {
                return null == n.separator && (n.separator = S),
                    this.printJoin(e, t, n)
            }
            ...
            _printComment(e, t) {
                if (!this.format.shouldPrintComment(e.value))
                    return;
                if (e.ignore)
                    return;
                if (this._printedComments.has(e))
                    return;
                this._printedComments.add(e);
                const n = "CommentBlock" === e.type
                    , r = n && !t && !this._noLineTerminator;
                r && this._buf.hasContent() && this.newline(1);
                const i = this.getLastChar();
                91 !== i && 123 !== i && this.space();
                let a = n || this._noLineTerminator ? `/*${e.value}*/` : `//${e.value}\n`;
                if (n && this.format.indent.adjustMultilineComment) {
                    var o;
                    const t = null == (o = e.loc) ? void 0 : o.start.column;
                    if (t) {
                        const e = new RegExp("\\n\\s{1," + t + "}","g");
                        a = a.replace(e, "\n")
                    }
            ...
            _printComments(e, t) {
                if (null != e && e.length)
                    if (t && 1 === e.length && p.test(e[0].value))
                        this._printComment(e[0], this._buf.hasContent() && !this.endsWith(10));
                    else
                        for (const t of e)
                            this._printComment(t)
            }
            printAssertions(e) {
                var t;
                null != (t = e.assertions) && t.length && (this.space(),
                    this.word("assert"),
                    this.space(),
                    this.token("{"),
                    this.space(),
    ...
    "4f38": function(e, t, n) {
        ...
        function E(e, t, n) {
            ...
            function s(e, t) {
                try {
                    !function(e) {
                        e.value instanceof S ? Promise.resolve(e.value.v).then(l, u) : p(a[0][2], e)
                    }(i[e](t))
                } catch (e) {
                    p(a[0][3], e)
                }
    ...
    5024: function(e, t, n) {
        ...
        s.prototype._version = 3,
            ...
            s.prototype.applySourceMap = function(e, t, n) {
                ...
                this._mappings.unsortedForEach((function(t) {
                        if (t.source === r && null != t.originalLine) {
                            ...
                            null != a.source && (t.source = a.source,
            ...
            s.prototype._serializeMappings = function() {
                for (var e, t, n, a, o = 0, s = 1, l = 0, u = 0, p = 0, c = 0, d = "", f = this._mappings.toArray(), y = 0, m = f.length; y < m; y++) {
                    if (e = "",
                    (t = f[y]).generatedLine !== s)
                        for (o = 0; t.generatedLine !== s; )
                            e += ";",
                                s++;
                    else if (y > 0) {
                        if (!i.compareByGeneratedPositionsInflated(t, f[y - 1]))
                            continue;
                        e += ","
                    }
                    e += r.encode(t.generatedColumn - o),
                        o = t.generatedColumn,
                    null != t.source && (a = this._sources.indexOf(t.source),
                        e += r.encode(a - c),
                        c = a,
    ...
    5673: function(e, t, n) {
        ...
        var r = n("4f38")
            , i = r.__importDefault(n("1267"))
            , a = r.__importDefault(n("e04a"));
        t.default = function(e) {
            e.use(i.default),
                e.use(a.default)
        }
    ...
    "57de": function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
                ...
                function t(t, n, a) {
                    for (const o of e)
                        if (d(a) === o || (0,
                            r.default)(o, a))
                            return void (0,
                                i.validateChild)(t, n, a);
                    throw new TypeError(`Property ${n} of ${t.type} expected node to be of a type ${JSON.stringify(e)} but instead got ${JSON.stringify(null == a ? void 0 : a.type)}`)
                }
                return t.oneOfNodeOrValueTypes = e,
                    t
            }
            ,
            t.assertNodeType = b,
            t.assertOneOf = function(...e) {
                function t(t, n, r) {
                    if (e.indexOf(r) < 0)
                        throw new TypeError(`Property ${n} expected value to be one of ${JSON.stringify(e)} but got ${JSON.stringify(r)}`)
                }
                return t.oneOf = e,
                    t
            }
            ...
            t.chain = E,
            t.default = P,
            t.defineAliasedType = function(...e) {
                return (t,n={})=>{
                    let r = n.aliases;
                    var i;
                    r || (n.inherits && (r = null == (i = x[n.inherits].aliases) ? void 0 : i.slice()),
                    null != r || (r = []),
                        n.aliases = r);
                    const a = e.filter(e=>!r.includes(e));
                    return r.unshift(...a),
                        P(t, n)
                }
            }
        ...
        function b(...e) {
            ...
            return t.oneOfNodeTypes = e,
                t
        }
        function S(e) {
            function t(t, n, r) {
                if (!(d(r) === e))
                    throw new TypeError(`Property ${n} expected type of ${e} but got ${d(r)}`)
            }
            return t.type = e,
                t
        }
        function E(...e) {
            ...
            if (t.chainOf = e,
            e.length >= 2 && "type"in e[0] && "array" === e[0].type && !("each"in e[1]))
                throw new Error('An assertValueType("array") validator can only be followed by an assertEach(...) validator.');
            return t
        }
        t.NODE_PARENT_VALIDATIONS = c;
        const v = ["aliases", "builder", "deprecatedAlias", "fields", "inherits", "visitor", "validate"]
            , g = ["default", "optional", "validate"];
        function P(e, t={}) {
            const n = t.inherits && x[t.inherits] || {};
            let r = t.fields;
            if (!r && (r = {},
                n.fields)) {
                ...
                for (const t of e) {
                    const e = n.fields[t]
                        , i = e.default;
                    if (Array.isArray(i) ? i.length > 0 : i && "object" == typeof i)
            ...
            for (const e of i.concat(y))
                r[e] = r[e] || {};
            for (const t of Object.keys(r)) {
                const n = r[t];
                void 0 !== n.default && -1 === y.indexOf(t) && (n.optional = !0),
                    void 0 === n.default ? n.default = null : n.validate || null == n.default || (n.validate = S(d(n.default)));
                for (const r of Object.keys(n))
                    if (-1 === g.indexOf(r))
                        throw new Error(`Unknown field key "${r}" on ${e}.${t}`)
            }
            a[e] = t.visitor = i,
                u[e] = t.builder = y,
                l[e] = t.fields = r,
    ...
    "59be": function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.ClassExpression = t.ClassDeclaration = function(e, t) {
                this.format.decoratorsBeforeExport && (i(t) || a(t)) || this.printJoin(e.decorators, e),
                e.declare && (this.word("declare"),
                    this.space()),
                e.abstract && (this.word("abstract"),
                    this.space()),
                    this.word("class"),
                e.id && (this.space(),
                    this.print(e.id, e)),
                    this.print(e.typeParameters, e),
                e.superClass && (this.space(),
                    this.word("extends"),
                    this.space(),
                    this.print(e.superClass, e),
                    this.print(e.superTypeParameters, e)),
                e.implements && (this.space(),
            ...
            t.ClassBody = function(e) {
                this.token("{"),
                    ...
                    0 === e.body.length ? this.token("}") : (this.newline(),
                        this.indent(),
        ...
        ;
        var r = n("252a");
        const {isExportDefaultDeclaration: i, isExportNamedDeclaration: a} = r
    },
    "5a5c": function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
    ...
    "62a0": function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.default = function(e) {
                const t = e.map(e=>(0,
                    a.isTSTypeAnnotation)(e) ? e.typeAnnotation : e)
                    , n = (0,
                    i.default)(t);
                    ...
                    if (null != i || null != o) {
                        ...
                        if (Array.isArray(i)) {
                            ...
                            for (let t = 0; t < i.length; t++)
                                if (!e(i[t], o[t]))
                                    return !1
                        } else if ("object" != typeof i || null != a && a.includes(r)) {
                            if (!e(i, o))
                                return !1
                        } else
    ...
    "63bb": function(e, t, n) {
        ...
        o("TSParameterProperty", {
            ...
            o("TSDeclareFunction", {
                ...
                fields: Object.assign({}, (0,
                    i.functionDeclarationCommon)(), l())
            }),
            o("TSDeclareMethod", {
                visitor: ["decorators", "key", "typeParameters", "params", "returnType"],
                fields: Object.assign({}, (0,
                    i.classMethodOrDeclareMethodCommon)(), l())
            }),
            o("TSQualifiedName", {
        ...
        o("TSFunctionType", Object.assign({}, f, {
            fields: u()
        })),
            o("TSConstructorType", Object.assign({}, f, {
                    ...
                    literal: {
                        validate: function() {
                            const e = (0,
                                ...
                                r.assertOneOf)("-")
                                , n = (0,
                                r.assertNodeType)("NumericLiteral", "StringLiteral", "BooleanLiteral", "BigIntLiteral", "TemplateLiteral");
                            function i(r, i, o) {
                                (0,
                                    a.default)("UnaryExpression", o) ? (t(o, "operator", o.operator),
                                    e(o, "argument", o.argument)) : n(r, i, o)
                            }
                            return i.oneOfNodeTypes = ["NumericLiteral", "StringLiteral", "BooleanLiteral", "BigIntLiteral", "TemplateLiteral", "UnaryExpression"],
                                i
                        }()
                    }
                }
    ...
    6911: function(e, t, n) {
        ...
        var r = n("4f38")
            , i = r.__importDefault(n("41ba"))
            , a = r.__importDefault(n("7f4b"))
            , o = r.__importDefault(n("826a"));
        t.default = function(e) {
            var t = e.use(i.default)
                , n = t.namedTypes
                , r = t.builders
                , s = t.builtInTypes.number
                , l = t.builtInTypes.array
                , u = e.use(a.default)
                , p = e.use(o.default)
                , c = function e(t, n, r) {
                ...
                , d = c.prototype = Object.create(u.prototype, {
                constructor: {
                    value: c,
                    enumerable: !1,
                    writable: !0,
            ...
            function f(e) {
                return n.BinaryExpression.check(e) || n.LogicalExpression.check(e)
            }
            Object.defineProperties(d, {
                ...
                d.replace = function() {
                    return delete this.node,
                        delete this.parent,
                        delete this.scope,
                        u.prototype.replace.apply(this, arguments)
                }
                ,
                d.prune = function() {
                    var e = this.parent;
                    return this.replace(),
                        function(e) {
                            if (n.VariableDeclaration.check(e.node)) {
                                var t = e.get("declarations").value;
                                if (!t || 0 === t.length)
                                    return e.prune()
                            } else if (n.ExpressionStatement.check(e.node)) {
                                if (!e.get("expression").value)
                                    return e.prune()
                            } else
                                n.IfStatement.check(e.node) && function(e) {
                                    var t = e.get("test").value
                                        , i = e.get("alternate").value
                                        , a = e.get("consequent").value;
                                    if (a || i) {
                                        if (!a && i) {
                                            var o = r.unaryExpression("!", t, !0);
                                            n.UnaryExpression.check(t) && "!" === t.operator && (o = t.argument),
                                                e.get("test").replace(o),
                                                e.get("consequent").replace(i),
                                                e.get("alternate").replace()
                                        }
                                    } else {
                                        var s = r.expressionStatement(t);
                                        e.replace(s)
                                    }
                                }(e);
                            return e
                ...
                ,
                d._computeParent = function() {
                    var e = this.value
                        , t = this.parentPath;
                    if (!n.Node.check(e)) {
                        for (; t && !n.Node.check(t.value); )
                            t = t.parentPath;
                        t && (t = t.parentPath)
                    }
                    for (; t && !n.Node.check(t.value); )
                ...
                ,
                d._computeScope = function() {
                    var e = this.value
                        , t = this.parentPath
                        , r = t && t.scope;
                    return n.Node.check(e) && p.isEstablishedBy(e) && (r = new p(this,r)),
                    r || null
                }
                ,
                d.getValueProperty = function(e) {
                    return t.getFieldValue(this.value, e)
                }
                ,
                d.needsParens = function(e) {
                    var t = this.parentPath;
                    if (!t)
                        return !1;
                    var r = this.value;
                    if (!n.Expression.check(r))
                        return !1;
                    if ("Identifier" === r.type)
                        return !1;
                    for (; !n.Node.check(t.value); )
                        if (!(t = t.parentPath))
                            return !1;
                    var i = t.value;
                    switch (r.type) {
                        ...
                        case "SpreadElement":
                        case "SpreadProperty":
                            return "MemberExpression" === i.type && "object" === this.name && i.object === r;
                        case "BinaryExpression":
                        case "LogicalExpression":
                            switch (i.type) {
                                case "CallExpression":
                                    return "callee" === this.name && i.callee === r;
                                case "UnaryExpression":
                                case "SpreadElement":
                                case "SpreadProperty":
                                    return !0;
                                case "MemberExpression":
                                    return "object" === this.name && i.object === r;
                                case "BinaryExpression":
                                case "LogicalExpression":
                                    var a = r
                                        , o = i.operator
                        ...
                        case "Literal":
                            return "MemberExpression" === i.type && s.check(r.value) && "object" === this.name && i.object === r;
                        ...
                        case "ConditionalExpression":
                            switch (i.type) {
                                ...
                                case "CallExpression":
                                    return "callee" === this.name && i.callee === r;
                                case "ConditionalExpression":
                                    return "test" === this.name && i.test === r;
                                case "MemberExpression":
                                    return "object" === this.name && i.object === r;
                                default:
                                    return !1
                        ...
                        default:
                            if ("NewExpression" === i.type && "callee" === this.name && i.callee === r)
                                return m(r)
                    }
                    return !(!0 === e || this.canBeFirstInStatement() || !this.firstInStatement())
                }
            ;
            var y = {};
            function m(e) {
                return !!n.CallExpression.check(e) || (l.check(e) ? e.some(m) : !!n.Node.check(e) && t.someField(e, (function(e, t) {
                        return m(t)
                    }
                )))
            }
            return [["||"], ["&&"], ["|"], ["^"], ["&"], ["==", "===", "!=", "!=="], ["<", ">", "<=", ">=", "in", "instanceof"], [">>", "<<", ">>>"], ["+", "-"], ["*", "/", "%"]].forEach((function(e, t) {
                ...
                d.canBeFirstInStatement = function() {
                    var e = this.node;
                    return !n.FunctionExpression.check(e) && !n.ObjectExpression.check(e)
                }
                ,
                d.firstInStatement = function() {
                    return function(e) {
                        for (var t, r; e.parent; e = e.parent) {
                            if (t = e.node,
                                r = e.parent.node,
                            n.BlockStatement.check(r) && "body" === e.parent.name && 0 === e.name) {
                                if (r.body[0] !== t)
                                    throw new Error("Nodes must be equal");
                                return !0
                            }
                            if (n.ExpressionStatement.check(r) && "expression" === e.name) {
                                if (r.expression !== t)
                                    throw new Error("Nodes must be equal");
                                return !0
                            }
                            if (n.SequenceExpression.check(r) && "expressions" === e.parent.name && 0 === e.name) {
                                if (r.expressions[0] !== t)
                                    throw new Error("Nodes must be equal")
                            } else if (n.CallExpression.check(r) && "callee" === e.name) {
                                if (r.callee !== t)
                                    throw new Error("Nodes must be equal")
                            } else if (n.MemberExpression.check(r) && "object" === e.name) {
                                if (r.object !== t)
                                    throw new Error("Nodes must be equal")
                            } else if (n.ConditionalExpression.check(r) && "test" === e.name) {
                                if (r.test !== t)
                                    throw new Error("Nodes must be equal")
                            } else if (f(r) && "left" === e.name) {
                                if (r.left !== t)
                                    throw new Error("Nodes must be equal")
                            } else {
                                if (!n.UnaryExpression.check(r) || r.prefix || "argument" !== e.name)
                                    return !1;
                                if (r.argument !== t)
                                    throw new Error("Nodes must be equal")
                            }
    ...
    "6abd": function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.IfStatement = function(e) {
                this.word("if"),
                    ...
                    this.token(")"),
                    this.space();
                const t = e.alternate && o(function e(t) {
                    return s(t.body) ? e(t.body) : t
                }(e.consequent));
                t && (this.token("{"),
                    this.newline(),
                    this.indent()),
                ...
                t && (this.dedent(),
                    this.newline(),
                    this.token("}")),
                e.alternate && (this.endsWith(125) && this.space(),
                    this.word("else"),
                    this.space(),
            ...
            t.SwitchCase = function(e) {
                e.test ? (this.word("case"),
                    this.space(),
                    this.print(e.test, e),
                    this.token(":")) : (this.word("default"),
                    this.token(":")),
                e.consequent.length && (this.newline(),
        ...
        var r = n("252a");
        const {isFor: i, isForStatement: a, isIfStatement: o, isStatement: s} = r;
        const l = function(e) {
            return function(t) {
                this.word("for"),
                    this.space(),
                "of" === e && t.await && (this.word("await"),
                    this.space()),
                    this.token("("),
                    this.print(t.left, t),
                    this.space(),
        ...
        const f = c("return", "argument");
        t.ReturnStatement = f;
        const y = c("break");
        t.BreakStatement = y;
        const m = c("throw", "argument");
        function h() {
            if (this.token(","),
                this.newline(),
                this.endsWith(10))
    ...
    "6da0": function(e, t, n) {
        ...
        t.default = class {
            ...
            append(e) {
                this._flush();
                const {line: t, column: n, filename: r, identifierName: i, force: a} = this._sourcePosition;
                this._append(e, t, n, i, r, a)
            }
            queue(e) {
                if ("\n" === e)
                    for (; this._queue.length > 0 && r.test(this._queue[0][0]); )
                        this._queue.shift();
                const {line: t, column: n, filename: i, identifierName: a, force: o} = this._sourcePosition;
                this._queue.unshift([e, t, n, a, i, o])
            }
            _flush() {
                let e;
                for (; e = this._queue.pop(); )
                    this._append(...e)
            }
            _append(e, t, n, r, i, a) {
                this._buf += e,
                ...
                let o = e.indexOf("\n")
                    , s = 0;
                for (0 !== o && this._mark(t, n, r, i, a); -1 !== o; )
                    this._position.line++,
                        this._position.column = 0,
                        s = o + 1,
                    s < e.length && this._mark(++t, 0, r, i, a),
                        o = e.indexOf("\n", s);
                this._position.column += e.length - s
            }
            _mark(e, t, n, r, i) {
                var a;
                null == (a = this._map) || a.mark(this._position.line, this._position.column, e, t, n, r, i)
            }
            removeTrailingNewline() {
            ...
            withSource(e, t, n) {
                ...
                this.source(e, t),
                    n(),
                this._sourcePosition.force && this._sourcePosition.line === r && this._sourcePosition.column === i && this._sourcePosition.filename === a || this._disallowedPop && this._disallowedPop.line === r && this._disallowedPop.column === i && this._disallowedPop.filename === a || (this._sourcePosition.line = r,
            ...
            _normalizePosition(e, t, n, r) {
                ...
                const a = n.line
                    , o = n.column
                    , s = n.filename;
                return n.identifierName = "start" === e && (null == t ? void 0 : t.identifierName) || null,
                    n.line = null == i ? void 0 : i.line,
                    n.column = null == i ? void 0 : i.column,
                    n.filename = null == t ? void 0 : t.filename,
                (r || n.line !== a || n.column !== o || n.filename !== s) && (n.force = r),
                    n
            }
            getCurrentColumn() {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.default = function(e) {
                ...
                for (let n = 0; n < e.children.length; n++) {
                    ...
                    (0,
                        r.isJSXEmptyExpression)(a) || t.push(a))
                }
                return t
            }
        ;
    ...
    "73bd": function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.default = function e(t, n, s) {
                ...
                for (const p of t)
                    if ((0,
                        i.isEmptyStatement)(p) || (u = !1),
                        (0,
                            i.isExpression)(p))
                        l.push(p);
                    else if ((0,
                        i.isExpressionStatement)(p))
                        l.push(p.expression);
                    else if ((0,
                        ...
                        for (const e of p.declarations) {
                            ...
                            e.init && l.push((0,
                                a.assignmentExpression)("=", e.id, e.init))
                        }
                        u = !0
                    } else if ((0,
                        i.isIfStatement)(p)) {
                        const t = p.consequent ? e([p.consequent], n, s) : n.buildUndefinedNode()
                            , r = p.alternate ? e([p.alternate], n, s) : n.buildUndefinedNode();
                        if (!t || !r)
                            return;
                        l.push((0,
                            a.conditionalExpression)(p.test, t, r))
                    } else if ((0,
                        i.isBlockStatement)(p)) {
                        ...
                        if (!(0,
                            i.isEmptyStatement)(p))
                            return;
                        0 === t.indexOf(p) && (u = !0)
                    }
                return u && l.push(n.buildUndefinedNode()),
                    1 === l.length ? l[0] : (0,
                        a.sequenceExpression)(l)
            }
        ;
        var r = n("c1f7")
            , i = n("c485")
        ...
        class a extends i.default {
            constructor(e, t={}, n) {
                super(function(e, t) {
                    ...
                    return n.jsonCompatibleStrings = t.jsonCompatibleStrings,
                        n.minified ? (n.compact = !0,
                            n.shouldPrintComment = n.shouldPrintComment || (()=>n.comments)) : n.shouldPrintComment = n.shouldPrintComment || (e=>n.comments || e.indexOf("@license") >= 0 || e.indexOf("@preserve") >= 0),
                    "auto" === n.compact && (n.compact = e.length > 5e5,
                        n.compact),
    ...
    "7f4b": function(e, t, n) {
        ...
        t.default = function(e) {
            var t = e.use(r.default)
                , n = t.builtInTypes.array
                , a = t.builtInTypes.number
                , o = function e(t, n, r) {
                if (!(this instanceof e))
            ...
            function u(e, t) {
                var n = l(e)
                    , r = e.getValueProperty(t)
                    , a = n[t];
                return i.call(n, t) && a.value === r || (a = n[t] = new e.constructor(r,e,t)),
                    a
            }
            function p() {}
            function c(e, t, r, o) {
                ...
                2 === u ? (r = 0,
                    o = s) : 3 === u ? (r = Math.max(r, 0),
                    o = s) : (r = Math.max(r, 0),
                    o = Math.min(o, s)),
                    a.assert(r),
                    a.assert(o);
                for (var c = Object.create(null), d = l(e), f = r; f < o; ++f)
                    if (i.call(e.value, f)) {
                        var y = e.get(f);
                        if (y.name !== f)
                            throw new Error("");
            ...
            return s.getValueProperty = function(e) {
                return this.value[e]
            }
                ,
                s.get = function() {
                    for (var e = [], t = 0; t < arguments.length; t++)
                        e[t] = arguments[t];
                    for (var n = this, r = e.length, i = 0; i < r; ++i)
                        n = u(n, e[i]);
                    return n
                }
                ,
                s.each = function(e, t) {
                    var n = []
                        ...
                        , a = 0;
                    for (a = 0; a < r; ++a)
                        i.call(this.value, a) && (n[a] = this.get(a));
                    for (t = t || this,
                             a = 0; a < r; ++a)
                        i.call(n, a) && e.call(t, n[a])
                }
                ,
                s.map = function(e, t) {
                    var n = [];
                    return this.each((function(t) {
                            n.push(e.call(this, t))
                        }
                    ), t),
                        n
                }
                ...
                s.unshift = function() {
                    for (var e = [], t = 0; t < arguments.length; t++)
                        e[t] = arguments[t];
                    var n = c(this, e.length)
                        , r = this.value.unshift.apply(this.value, e);
                    return n(),
                        r
                }
                ,
                s.push = function() {
                    for (var e = [], t = 0; t < arguments.length; t++)
                        e[t] = arguments[t];
                    return n.assert(this.value),
                        delete l(this).length,
                        this.value.push.apply(this.value, e)
                }
                ,
                s.pop = function() {
                    n.assert(this.value);
                    var e = l(this);
                    return delete e[this.value.length - 1],
                        delete e.length,
                        this.value.pop()
                }
                ,
                s.insertAt = function(e) {
                ...
                s.insertBefore = function() {
                    for (var e = [], t = 0; t < arguments.length; t++)
                        e[t] = arguments[t];
                    for (var n = this.parentPath, r = e.length, i = [this.name], a = 0; a < r; ++a)
                        i.push(e[a]);
                    return n.insertAt.apply(n, i)
                }
                ,
                s.insertAfter = function() {
                    for (var e = [], t = 0; t < arguments.length; t++)
                        e[t] = arguments[t];
                    for (var n = this.parentPath, r = e.length, i = [this.name + 1], a = 0; a < r; ++a)
                        i.push(e[a]);
                    return n.insertAt.apply(n, i)
                }
                ,
                s.replace = function(e) {
                    var t = []
                        , r = this.parentPath.value
                        , i = l(this.parentPath)
                        , a = arguments.length;
                    if (d(this),
                        n.check(r)) {
                        for (var o = r.length, s = c(this.parentPath, a - 1, this.name + 1), u = [this.name, 1], p = 0; p < a; ++p)
                            u.push(arguments[p]);
                        var f = r.splice.apply(r, u);
                        if (f[0] !== this.value)
                            throw new Error("");
                        if (r.length !== o - 1 + a)
                            throw new Error("");
                        ...
                        0 === a)
                            ...
                            if (r[this.name] !== e)
                                throw new Error("");
                            for (this.value !== e && (this.value = e,
                                this.__childCache = null),
                                     p = 0; p < a; ++p)
                                t.push(this.parentPath.get(this.name + p));
                            if (t[0] !== this)
                                throw new Error("")
                        }
                    } else if (1 === a)
                        this.value !== e && (this.__childCache = null),
                            this.value = r[this.name] = e,
                            t.push(this);
                    else {
                        if (0 !== a)
    ...
    "826a": function(e, t, n) {
        ...
        t.default = function(e) {
            var t = e.use(r.default)
                ...
                , c = [a.Program, a.Function, a.CatchClause]
                , d = n.or.apply(n, c);
            p.isEstablishedBy = function(e) {
                return d.check(e)
            }
            ;
            var f = p.prototype;
            function y(e, n, r) {
                var i = e.value;
                e.parent && a.FunctionExpression.check(e.parent.node) && e.parent.node.id && h(e.parent.get("id"), n),
                i && (l.check(i) ? e.each((function(e) {
                        m(e, n, r)
                    }
                )) : a.Function.check(i) ? (e.get("params").each((function(e) {
                        h(e, n)
                    }
                )),
                    m(e.get("body"), n, r)) : a.TypeAlias && a.TypeAlias.check(i) || a.InterfaceDeclaration && a.InterfaceDeclaration.check(i) || a.TSTypeAliasDeclaration && a.TSTypeAliasDeclaration.check(i) || a.TSInterfaceDeclaration && a.TSInterfaceDeclaration.check(i) ? T(e.get("id"), r) : a.VariableDeclarator.check(i) ? (h(e.get("id"), n),
                    m(e.get("init"), n, r)) : "ImportSpecifier" === i.type || "ImportNamespaceSpecifier" === i.type || "ImportDefaultSpecifier" === i.type ? h(e.get(i.local ? "local" : i.name ? "name" : "id"), n) : o.check(i) && !s.check(i) && t.eachField(i, (function(t, i) {
                        var a = e.get(t);
                        if (!function(e, t) {
                            return e.value === t || !(!Array.isArray(e.value) || 0 !== e.value.length || !Array.isArray(t) || 0 !== t.length)
                        }(a, i))
                            throw new Error("");
                        m(a, n, r)
                    }
            ...
            function m(e, t, n) {
                ...
                if (!r || s.check(r))
                    ;
                else if (a.FunctionDeclaration.check(r) && null !== r.id)
                    h(e.get("id"), t);
                else if (a.ClassDeclaration && a.ClassDeclaration.check(r))
                    h(e.get("id"), t);
                else if (d.check(r)) {
                    if (a.CatchClause.check(r) && a.Identifier.check(r.param)) {
                        var o = r.param.name
                            , l = i.call(t, o);
                        y(e.get("body"), t, n),
                        l || delete t[o]
            ...
            function h(e, t) {
                var n = e.value;
                a.Pattern.assert(n),
                    a.Identifier.check(n) ? i.call(t, n.name) ? t[n.name].push(e) : t[n.name] = [e] : a.AssignmentPattern && a.AssignmentPattern.check(n) ? h(e.get("left"), t) : a.ObjectPattern && a.ObjectPattern.check(n) ? e.get("properties").each((function(e) {
                            var n = e.value;
                            a.Pattern.check(n) ? h(e, t) : a.Property.check(n) ? h(e.get("value"), t) : a.SpreadProperty && a.SpreadProperty.check(n) && h(e.get("argument"), t)
                        }
                    )) : a.ArrayPattern && a.ArrayPattern.check(n) ? e.get("elements").each((function(e) {
                            var n = e.value;
                            a.Pattern.check(n) ? h(e, t) : a.SpreadElement && a.SpreadElement.check(n) && h(e.get("argument"), t)
                        }
                    )) : a.PropertyPattern && a.PropertyPattern.check(n) ? h(e.get("pattern"), t) : (a.SpreadElementPattern && a.SpreadElementPattern.check(n) || a.RestElement && a.RestElement.check(n) || a.SpreadPropertyPattern && a.SpreadPropertyPattern.check(n)) && h(e.get("argument"), t)
            }
            function T(e, t) {
                var n = e.value;
                a.Pattern.assert(n),
                a.Identifier.check(n) && (i.call(t, n.name) ? t[n.name].push(e) : t[n.name] = [e])
            }
            return f.didScan = !1,
                f.declares = function(e) {
                    return this.scan(),
                        i.call(this.bindings, e)
                }
                ,
                ...
                f.injectTemporary = function(e, t) {
                    ...
                    var n = this.path.get("body");
                    return a.BlockStatement.check(n.value) && (n = n.get("body")),
                        n.unshift(u.variableDeclaration("var", [u.variableDeclarator(e, t || null)])),
                        e
                }
                ,
                f.scan = function(e) {
                    if (e || !this.didScan) {
                        ...
                        (function(e, t, n) {
                                var r = e.value;
                                if (d.assert(r),
                                    a.CatchClause.check(r)) {
                                    var i = e.get("param");
                                    i.value && h(i, t)
                                } else
                                    y(e, t, n)
                            }
                        )(this.path, this.bindings, this.types),
                            this.didScan = !0
                    }
                }
                ,
                ...
                ,
                f.lookup = function(e) {
                    for (var t = this; t && !t.declares(e); t = t.parent)
                        ;
                    return t
                }
                ,
                f.lookupType = function(e) {
                    for (var t = this; t && !t.declaresType(e); t = t.parent)
                        ;
                    return t
                }
                ,
                f.getGlobalScope = function() {
                    for (var e = this; !e.isGlobal; )
                        e = e.parent;
                    return e
                }
                ,
    ...
    "85ab": function(e, t, n) {
        ...
        t.default = function(e) {
            ...
            var t = e.use(o.default)
                ...
                , l = t.Type.or
                , u = e.use(s.default).defaults
                , p = t.Type.from((function(e, t) {
                    return !(!n.StringLiteral || !n.StringLiteral.check(e, t)) || !(!n.Literal || !n.Literal.check(e, t) || "string" != typeof e.value)
                }
            ), "StringLiteral");
            r("TSType").bases("Node");
            var c = l(r("Identifier"), r("TSQualifiedName"));
            r("TSTypeReference").bases("TSType", "TSHasOptionalTypeParameterInstantiation").build("typeName", "typeParameters").field("typeName", c),
                r("TSHasOptionalTypeParameterInstantiation").field("typeParameters", l(r("TSTypeParameterInstantiation"), null), u.null),
                r("TSHasOptionalTypeParameters").field("typeParameters", l(r("TSTypeParameterDeclaration"), null, void 0), u.null),
                r("TSHasOptionalTypeAnnotation").field("typeAnnotation", l(r("TSTypeAnnotation"), null), u.null),
                r("TSQualifiedName").bases("Node").build("left", "right").field("left", c).field("right", c),
                r("TSAsExpression").bases("Expression", "Pattern").build("expression", "typeAnnotation").field("expression", r("Expression")).field("typeAnnotation", r("TSType")).field("extra", l({
                    parenthesized: Boolean
                }, null), u.null),
                r("TSNonNullExpression").bases("Expression", "Pattern").build("expression").field("expression", r("Expression")),
                ["TSAnyKeyword", "TSBigIntKeyword", "TSBooleanKeyword", "TSNeverKeyword", "TSNullKeyword", "TSNumberKeyword", "TSObjectKeyword", "TSStringKeyword", "TSSymbolKeyword", "TSUndefinedKeyword", "TSUnknownKeyword", "TSVoidKeyword", "TSThisType"].forEach((function(e) {
                        r(e).bases("TSType").build()
                    }
                )),
                r("TSArrayType").bases("TSType").build("elementType").field("elementType", r("TSType")),
                r("TSLiteralType").bases("TSType").build("literal").field("literal", l(r("NumericLiteral"), r("StringLiteral"), r("BooleanLiteral"), r("TemplateLiteral"), r("UnaryExpression"))),
                ["TSUnionType", "TSIntersectionType"].forEach((function(e) {
                        r(e).bases("TSType").build("types").field("types", [r("TSType")])
                    }
                )),
                r("TSConditionalType").bases("TSType").build("checkType", "extendsType", "trueType", "falseType").field("checkType", r("TSType")).field("extendsType", r("TSType")).field("trueType", r("TSType")).field("falseType", r("TSType")),
                r("TSInferType").bases("TSType").build("typeParameter").field("typeParameter", r("TSTypeParameter")),
                r("TSParenthesizedType").bases("TSType").build("typeAnnotation").field("typeAnnotation", r("TSType"));
            var d = [l(r("Identifier"), r("RestElement"), r("ArrayPattern"), r("ObjectPattern"))];
            ["TSFunctionType", "TSConstructorType"].forEach((function(e) {
                    r(e).bases("TSType", "TSHasOptionalTypeParameters", "TSHasOptionalTypeAnnotation").build("parameters").field("parameters", d)
                }
            )),
                r("TSDeclareFunction").bases("Declaration", "TSHasOptionalTypeParameters").build("id", "params", "returnType").field("declare", Boolean, u.false).field("async", Boolean, u.false).field("generator", Boolean, u.false).field("id", l(r("Identifier"), null), u.null).field("params", [r("Pattern")]).field("returnType", l(r("TSTypeAnnotation"), r("Noop"), null), u.null),
                r("TSDeclareMethod").bases("Declaration", "TSHasOptionalTypeParameters").build("key", "params", "returnType").field("async", Boolean, u.false).field("generator", Boolean, u.false).field("params", [r("Pattern")]).field("abstract", Boolean, u.false).field("accessibility", l("public", "private", "protected", void 0), u[void 0]).field("static", Boolean, u.false).field("computed", Boolean, u.false).field("optional", Boolean, u.false).field("key", l(r("Identifier"), r("StringLiteral"), r("NumericLiteral"), r("Expression"))).field("kind", l("get", "set", "method", "constructor"), (function() {
                        return "method"
                    }
                )).field("access", l("public", "private", "protected", void 0), u[void 0]).field("decorators", l([r("Decorator")], null), u.null).field("returnType", l(r("TSTypeAnnotation"), r("Noop"), null), u.null),
                r("TSMappedType").bases("TSType").build("typeParameter", "typeAnnotation").field("readonly", l(Boolean, "+", "-"), u.false).field("typeParameter", r("TSTypeParameter")).field("optional", l(Boolean, "+", "-"), u.false).field("typeAnnotation", l(r("TSType"), null), u.null),
                r("TSTupleType").bases("TSType").build("elementTypes").field("elementTypes", [l(r("TSType"), r("TSNamedTupleMember"))]),
                r("TSNamedTupleMember").bases("TSType").build("label", "elementType", "optional").field("label", r("Identifier")).field("optional", Boolean, u.false).field("elementType", r("TSType")),
                r("TSRestType").bases("TSType").build("typeAnnotation").field("typeAnnotation", r("TSType")),
                r("TSOptionalType").bases("TSType").build("typeAnnotation").field("typeAnnotation", r("TSType")),
                r("TSIndexedAccessType").bases("TSType").build("objectType", "indexType").field("objectType", r("TSType")).field("indexType", r("TSType")),
                r("TSTypeOperator").bases("TSType").build("operator").field("operator", String).field("typeAnnotation", r("TSType")),
                r("TSTypeAnnotation").bases("Node").build("typeAnnotation").field("typeAnnotation", l(r("TSType"), r("TSTypeAnnotation"))),
                r("TSIndexSignature").bases("Declaration", "TSHasOptionalTypeAnnotation").build("parameters", "typeAnnotation").field("parameters", [r("Identifier")]).field("readonly", Boolean, u.false),
                r("TSPropertySignature").bases("Declaration", "TSHasOptionalTypeAnnotation").build("key", "typeAnnotation", "optional").field("key", r("Expression")).field("computed", Boolean, u.false).field("readonly", Boolean, u.false).field("optional", Boolean, u.false).field("initializer", l(r("Expression"), null), u.null),
                r("TSMethodSignature").bases("Declaration", "TSHasOptionalTypeParameters", "TSHasOptionalTypeAnnotation").build("key", "parameters", "typeAnnotation").field("key", r("Expression")).field("computed", Boolean, u.false).field("optional", Boolean, u.false).field("parameters", d),
                r("TSTypePredicate").bases("TSTypeAnnotation", "TSType").build("parameterName", "typeAnnotation", "asserts").field("parameterName", l(r("Identifier"), r("TSThisType"))).field("typeAnnotation", l(r("TSTypeAnnotation"), null), u.null).field("asserts", Boolean, u.false),
                ["TSCallSignatureDeclaration", "TSConstructSignatureDeclaration"].forEach((function(e) {
                        r(e).bases("Declaration", "TSHasOptionalTypeParameters", "TSHasOptionalTypeAnnotation").build("parameters", "typeAnnotation").field("parameters", d)
                    }
                )),
                r("TSEnumMember").bases("Node").build("id", "initializer").field("id", l(r("Identifier"), p)).field("initializer", l(r("Expression"), null), u.null),
                r("TSTypeQuery").bases("TSType").build("exprName").field("exprName", l(c, r("TSImportType")));
            var f = l(r("TSCallSignatureDeclaration"), r("TSConstructSignatureDeclaration"), r("TSIndexSignature"), r("TSMethodSignature"), r("TSPropertySignature"));
            r("TSTypeLiteral").bases("TSType").build("members").field("members", [f]),
                r("TSTypeParameter").bases("Identifier").build("name", "constraint", "default").field("name", String).field("constraint", l(r("TSType"), void 0), u[void 0]).field("default", l(r("TSType"), void 0), u[void 0]),
                r("TSTypeAssertion").bases("Expression", "Pattern").build("typeAnnotation", "expression").field("typeAnnotation", r("TSType")).field("expression", r("Expression")).field("extra", l({
                    parenthesized: Boolean
                }, null), u.null),
                r("TSTypeParameterDeclaration").bases("Declaration").build("params").field("params", [r("TSTypeParameter")]),
                r("TSTypeParameterInstantiation").bases("Node").build("params").field("params", [r("TSType")]),
                r("TSEnumDeclaration").bases("Declaration").build("id", "members").field("id", r("Identifier")).field("const", Boolean, u.false).field("declare", Boolean, u.false).field("members", [r("TSEnumMember")]).field("initializer", l(r("Expression"), null), u.null),
                r("TSTypeAliasDeclaration").bases("Declaration", "TSHasOptionalTypeParameters").build("id", "typeAnnotation").field("id", r("Identifier")).field("declare", Boolean, u.false).field("typeAnnotation", r("TSType")),
                r("TSModuleBlock").bases("Node").build("body").field("body", [r("Statement")]),
                r("TSModuleDeclaration").bases("Declaration").build("id", "body").field("id", l(p, c)).field("declare", Boolean, u.false).field("global", Boolean, u.false).field("body", l(r("TSModuleBlock"), r("TSModuleDeclaration"), null), u.null),
                r("TSImportType").bases("TSType", "TSHasOptionalTypeParameterInstantiation").build("argument", "qualifier", "typeParameters").field("argument", p).field("qualifier", l(c, void 0), u[void 0]),
                r("TSImportEqualsDeclaration").bases("Declaration").build("id", "moduleReference").field("id", r("Identifier")).field("isExport", Boolean, u.false).field("moduleReference", l(c, r("TSExternalModuleReference"))),
                r("TSExternalModuleReference").bases("Declaration").build("expression").field("expression", p),
                r("TSExportAssignment").bases("Statement").build("expression").field("expression", r("Expression")),
                r("TSNamespaceExportDeclaration").bases("Declaration").build("id").field("id", r("Identifier")),
                r("TSInterfaceBody").bases("Node").build("body").field("body", [f]),
                r("TSExpressionWithTypeArguments").bases("TSType", "TSHasOptionalTypeParameterInstantiation").build("expression", "typeParameters").field("expression", c),
                r("TSInterfaceDeclaration").bases("Declaration", "TSHasOptionalTypeParameters").build("id", "body").field("id", c).field("declare", Boolean, u.false).field("extends", l([r("TSExpressionWithTypeArguments")], null), u.null).field("body", r("TSInterfaceBody")),
                r("TSParameterProperty").bases("Pattern").build("parameter").field("accessibility", l("public", "private", "protected", void 0), u[void 0]).field("readonly", Boolean, u.false).field("parameter", l(r("Identifier"), r("AssignmentPattern"))),
                r("ClassProperty").field("access", l("public", "private", "protected", void 0), u[void 0]),
                r("ClassBody").field("body", [l(r("MethodDefinition"), r("VariableDeclarator"), r("ClassPropertyDefinition"), r("ClassProperty"), r("ClassPrivateProperty"), r("ClassMethod"), r("ClassPrivateMethod"), r("TSDeclareMethod"), f)])
        }
            ,
            e.exports = t.default
    },
    ...
    9046: function(e, t, n) {
        ...
        t.ASSIGNMENT_OPERATORS = p;
        const c = ["delete", "!"];
        t.BOOLEAN_UNARY_OPERATORS = c;
        const d = ["+", "-", "~"];
        t.NUMBER_UNARY_OPERATORS = d;
        const f = ["typeof"];
        t.STRING_UNARY_OPERATORS = f;
        const y = ["void", "throw", ...c, ...d, ...f];
        t.UNARY_OPERATORS = y;
        t.INHERIT_KEYS = {
        ...
        var r = n("b9c3")
            ...
            if ("number" == typeof t) {
                ...
                if (Number.isFinite(t))
                    e = (0,
                        i.numericLiteral)(Math.abs(t));
                else {
                    let n;
                    n = Number.isNaN(t) ? (0,
                        i.numericLiteral)(0) : (0,
                        i.numericLiteral)(1),
                        e = (0,
                            i.binaryExpression)("/", n, (0,
                            i.numericLiteral)(0))
                }
                return (t < 0 || Object.is(t, -0)) && (e = (0,
                    i.unaryExpression)("-", e)),
                    e
            }
            if (function(e) {
            ...
            if (function(e) {
                ...
                for (const a of Object.keys(t)) {
                    ...
                    o = (0,
                        ...
                        i.stringLiteral)(a),
                        n.push((0,
                            i.objectProperty)(o, e(t[a])))
                }
                return (0,
                    i.objectExpression)(n)
            }
            throw new Error("don't know how to turn this value into a node")
        };
        t.default = a;
        const o = Function.call.bind(Object.prototype.toString)
    },
    9539: function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            ...
            t.default = function(e) {
                return !!(0,
                    r.default)(e.type, "Immutable") || !!(0,
                    i.isIdentifier)(e) && "undefined" === e.name
            }
        ;
        var r = n("1093")
            , i = n("c485")
    ...
    "9a5c": function(e, t, n) {
        ...
        function s(e) {
            return r.builders.templateElement({
                raw: e,
                cooked: e
            }, !0)
        }
        function l(e, t, n) {
            var i = []
                , a = [];
            return 0 === t.length && 0 === n.length ? e.map((function(e) {
                    return i.push(s(e))
                }
            )) : t.length > 0 && 0 === n.length ? (e.map((function(e) {
                    return i.push(s(e))
                }
            )),
                t.map((function(e) {
                        return a.push(r.builders.identifier(e.name))
                    }
                ))) : 0 === t.length && n.length > 0 ? (i.push(s("".concat(e[0], "?").concat(n[0].name, "="))),
                a.push(r.builders.identifier(n[0].name)),
                n.map((function(e, t) {
                        t > 0 && (i.push(s("&".concat(e.name, "="))),
                            a.push(r.builders.identifier(e.name)))
                    }
                )),
                i.push(s(""))) : (e.map((function(t, r) {
                    r + 1 === e.length ? i.push(s("".concat(t, "?").concat(n[0].name, "="))) : i.push(s(t))
                }
            )),
                t.map((function(e) {
                        return a.push(r.builders.identifier(e.name))
                ...
                i.push(s(""))),
                r.builders.templateLiteral(i, a)
        }
        function u(e, t) {
            var n = [];
            return e.map((function(e) {
                    var r = t.filter((function(t) {
                            return t.name === e.schemaValue
                        }
                    ))[0];
                    r && (e.children = r.params,
                        u(e.children, t)),
                        n.push(e)
                }
            )),
        ...
        function c(e) {
            return r.builders.tsTypeReference(r.builders.identifier(e))
        }
        function d() {
            return r.builders.tsTypeReference(r.builders.identifier("Record"), r.builders.tsTypeParameterInstantiation([r.builders.tsStringKeyword(), r.builders.tsUnknownKeyword()]))
        }
        function f(e, t) {
            return e.map((function(e) {
                    return r.builders.tsPropertySignature(r.builders.identifier(e.name), r.builders.tsTypeAnnotation(function(e, t, n) {
                        if (["boolean", "string", "number"].includes(t))
                            return c(t);
                        if ("object" === t) {
                            if (e.children) {
                                var i = f(e.children, n);
                                return r.builders.tsTypeLiteral(i)
                            }
                            return d()
                        }
                        if ("array" === t) {
                            if (e.children) {
                                var a = f(e.children, n);
                                return r.builders.tsArrayType(r.builders.tsTypeLiteral(a))
                            }
                            return r.builders.tsArrayType(d())
                        }
                        return c(t)
                    }(e, p(e.type), t)), !!t && !e.require)
                }
            ))
        }
        function y(e) {
            ...
            Array.isArray(n) && n.map((function(e) {
                    "path" === e.in && (r += " * @param {string} ".concat(e.name, " ").concat(e.description, "\n ")),
                    "query" === e.in && (r += " * @param {string} ".concat(e.name, " ").concat(e.description, "\n ")),
                    "body" === e.in && (e.def && "object" === e.def.type || "object" === e.type ? r = function e(t, n, r) {
                        return Array.isArray(n) && n.map((function(n) {
                                e(t += " * @param {".concat(p(n.type), "} ").concat(r, ".").concat(n.name, " ").concat(n.description, "\n"), n.children, "".concat(r, ".").concat(n.name))
                            }
                        )),
                            t
                    }(r += " * @param {object} params ".concat(e.description, "\n"), e.children, "params") : (e.def && "array" === e.def.type || "array" === e.type) && (r += " * @param {array} params ".concat(e.description, "\n")))
                }
            )),
                r += " * @returns\n",
                r += " */\n"
        ...
        function m(e) {
            var t = r.builders.identifier(e.name);
            return t.typeAnnotation = r.builders.typeAnnotation(r.builders.genericTypeAnnotation(r.builders.identifier(e.type), null)),
                t
        }
        function h(e) {
            var t = e.name
                ...
                , d = [];
            d.push(l(o(i), s, u)),
                [].concat(s, u).map((function(e) {
                        c.push(r.builders.identifier(e.name))
                    }
                )),
                p.map((function(e) {
                        var t = r.builders.identifier(e.name);
            ...
            var f = r.builders.functionDeclaration(r.builders.identifier(t), c, r.builders.blockStatement([r.builders.returnStatement(r.builders.callExpression(r.builders.memberExpression(r.builders.identifier("request"), r.builders.identifier(n)), d))]));
            return a()(r.builders.exportNamedDeclaration(f)).code
        }
        function T(e, t, n) {
            var i = null;
            if ("object" === e.type) {
                if (!e.children)
                    return "\n";
                var o = f(e.children, n);
                i = r.builders.tsInterfaceDeclaration(r.builders.identifier(t), r.builders.tsInterfaceBody(o))
            } else if ("array" === e.type) {
                if (!e.children)
                    return "\n";
                var s = f(e.children, n);
                i = r.builders.tsInterfaceDeclaration(r.builders.identifier(t), r.builders.tsInterfaceBody(s))
            } else
                i = r.builders.tsInterfaceDeclaration(r.builders.identifier(t), r.builders.tsInterfaceBody([]));
            return a()(r.builders.exportNamedDeclaration(i)).code + "\n\n"
        }
        function b(e, t) {
            var n = e.name
                , i = e.method
                ...
                , y = [];
            y.push(l(o(s), u, p)),
                [].concat(u, p).map((function(e) {
                        f.push(m(e))
                    }
                )),
                c.map((function(e) {
                        "array" === e.type ? f.push(m({
                            name: e.name,
                            type: "any[]"
                        })) : "object" === e.type && f.push(m({
                            name: e.name,
                            type: "".concat(t, "Params")
                        })),
                            y.push(r.builders.identifier(e.name))
                    }
                ));
            var h = r.builders.functionDeclaration(r.builders.identifier(n), f, r.builders.blockStatement([r.builders.returnStatement(r.builders.callExpression(r.builders.memberExpression(r.builders.identifier("request"), r.builders.identifier(i)), y))]))
                , T = "array" === d.type ? "".concat(t, "Res[]") : "".concat(t, "Res");
            return h.returnType = r.builders.tsTypeAnnotation(r.builders.tsTypeReference(r.builders.identifier("Promise"), r.builders.tsTypeParameterInstantiation([r.builders.tsTypeReference(r.builders.identifier(T))]))),
                a()(r.builders.exportNamedDeclaration(h)).code
        }
        var S = {
            name: "ScriptView",
            components: {
                EditorScript: function() {
                    return Promise.all([n.e("chunk-3b888a65"), n.e("chunk-0fd67716"), n.e("chunk-0d102d5a")]).then(n.bind(null, "cf04"))
                }
            },
            props: {
                api: {
            ...
            created: function() {
                var e = function(e) {
                    var t = {
                        name: e.operationId.split("Using")[0],
                        method: e.methodType.toLowerCase(),
                        url: e.url,
                        pathParams: [],
                        queryParams: [],
                        bodyParams: [],
                    ...
                    if (Array.isArray(e.parameters) && e.parameters.map((function(e) {
                            switch (e.in) {
                                case "path":
                                    t.pathParams.push({
                                        name: e.name,
                                ...
                                default:
                                    t.bodyParams.push({
                                        name: "params",
                                        type: "array" === e.type ? "array" : "object",
                                        children: e.children
                                    })
                            }
                        }
                    )),
                        Array.isArray(e.responseCodes)) {
                        var n = "";
                        e.responseJson instanceof Array ? n = "array" : e.responseJson instanceof Object && (n = "object"),
                            t.resParam = {
                                name: "res",
                                type: n,
                                children: u(e.responseParameters, e.responseRefParameters)
                            }
                    }
                    return t
                }(this.api)
                ...
                try {
                    t = y(this.api),
                        ...
                        i = e.bodyParams[0] ? "// 参数接口\n" + T(e.bodyParams[0], "".concat(r, "Params"), !0) : "",
                        a = e.resParam ? "// 响应接口\n" + T(e.resParam, "".concat(r, "Res"), !1) : "",
                        o = y(this.api),
                        s = b(e, r)
                } catch (e) {}
                this.jsCode = t + n,
            ...
            , v = Object(E.a)(S, (function() {
                ...
                return n("div", {
                    ...
                    domProps: {
                        innerHTML: e._s(e.$t("script.JSExample"))
                    }
                }), n("editor-script", {
                    attrs: {
                        value: e.jsCode
                    ...
                    staticClass: "api-title",
                    domProps: {
                        innerHTML: e._s(e.$t("script.TSExample"))
                    }
                }), n("editor-script", {
                    attrs: {
                        value: e.tsCode,
    ...
    "9bee": function(e, t, n) {
        ...
        t.default = class {
            ...
            mark(e, t, n, r, i, a, o) {
                this._lastGenLine !== e && null === n || (o || this._lastGenLine !== e || this._lastSourceLine !== n || this._lastSourceColumn !== r) && (this._cachedMap = null,
                    this._lastGenLine = e,
    ...
    "9e61": function(e, t, n) {
        ...
        t.default = function(e) {
            ...
            var t = e.use(o.default)
                , n = t.Type.def
                , s = t.Type.or
                , l = s.apply(void 0, r.__spreadArrays(i.BinaryOperators, ["**"]));
            n("BinaryExpression").field("operator", l);
            var u = s.apply(void 0, r.__spreadArrays(i.AssignmentOperators, ["**="]));
            n("AssignmentExpression").field("operator", u)
        }
            ,
            e.exports = t.default
    },
    "9e80": function(e, t, n) {
        ...
        const a = r.FLIPPED_ALIAS_KEYS.Expression;
        t.EXPRESSION_TYPES = a;
        const o = r.FLIPPED_ALIAS_KEYS.Binary;
        t.BINARY_TYPES = o;
        ...
        t.BLOCK_TYPES = u;
        const p = r.FLIPPED_ALIAS_KEYS.Statement;
        t.STATEMENT_TYPES = p;
        const c = r.FLIPPED_ALIAS_KEYS.Terminatorless;
        t.TERMINATORLESS_TYPES = c;
        const d = r.FLIPPED_ALIAS_KEYS.CompletionStatement;
        t.COMPLETIONSTATEMENT_TYPES = d;
        const f = r.FLIPPED_ALIAS_KEYS.Conditional;
        t.CONDITIONAL_TYPES = f;
        const y = r.FLIPPED_ALIAS_KEYS.Loop;
        t.LOOP_TYPES = y;
        const m = r.FLIPPED_ALIAS_KEYS.While;
        t.WHILE_TYPES = m;
        const h = r.FLIPPED_ALIAS_KEYS.ExpressionWrapper;
        t.EXPRESSIONWRAPPER_TYPES = h;
        const T = r.FLIPPED_ALIAS_KEYS.For;
        t.FOR_TYPES = T;
        const b = r.FLIPPED_ALIAS_KEYS.ForXStatement;
        t.FORXSTATEMENT_TYPES = b;
        const S = r.FLIPPED_ALIAS_KEYS.Function;
        t.FUNCTION_TYPES = S;
        const E = r.FLIPPED_ALIAS_KEYS.FunctionParent;
        t.FUNCTIONPARENT_TYPES = E;
        const v = r.FLIPPED_ALIAS_KEYS.Pureish;
        t.PUREISH_TYPES = v;
        const g = r.FLIPPED_ALIAS_KEYS.Declaration;
        t.DECLARATION_TYPES = g;
        const P = r.FLIPPED_ALIAS_KEYS.PatternLike;
        t.PATTERNLIKE_TYPES = P;
        const x = r.FLIPPED_ALIAS_KEYS.LVal;
        t.LVAL_TYPES = x;
        const A = r.FLIPPED_ALIAS_KEYS.TSEntityName;
        t.TSENTITYNAME_TYPES = A;
        const O = r.FLIPPED_ALIAS_KEYS.Literal;
        t.LITERAL_TYPES = O;
        const _ = r.FLIPPED_ALIAS_KEYS.Immutable;
        t.IMMUTABLE_TYPES = _;
        const w = r.FLIPPED_ALIAS_KEYS.UserWhitespacable;
        t.USERWHITESPACABLE_TYPES = w;
        const I = r.FLIPPED_ALIAS_KEYS.Method;
        t.METHOD_TYPES = I;
        const N = r.FLIPPED_ALIAS_KEYS.ObjectMember;
        t.OBJECTMEMBER_TYPES = N;
        const D = r.FLIPPED_ALIAS_KEYS.Property;
        t.PROPERTY_TYPES = D;
        const j = r.FLIPPED_ALIAS_KEYS.UnaryLike;
        t.UNARYLIKE_TYPES = j;
        const C = r.FLIPPED_ALIAS_KEYS.Pattern;
        t.PATTERN_TYPES = C;
        ...
        const F = r.FLIPPED_ALIAS_KEYS.Accessor;
        t.ACCESSOR_TYPES = F;
        const R = r.FLIPPED_ALIAS_KEYS.Private;
        t.PRIVATE_TYPES = R;
        const K = r.FLIPPED_ALIAS_KEYS.Flow;
        t.FLOW_TYPES = K;
        const V = r.FLIPPED_ALIAS_KEYS.FlowType;
        t.FLOWTYPE_TYPES = V;
        const Y = r.FLIPPED_ALIAS_KEYS.FlowBaseAnnotation;
        t.FLOWBASEANNOTATION_TYPES = Y;
        const J = r.FLIPPED_ALIAS_KEYS.FlowDeclaration;
        t.FLOWDECLARATION_TYPES = J;
        const X = r.FLIPPED_ALIAS_KEYS.FlowPredicate;
        t.FLOWPREDICATE_TYPES = X;
        const U = r.FLIPPED_ALIAS_KEYS.EnumBody;
        t.ENUMBODY_TYPES = U;
        const q = r.FLIPPED_ALIAS_KEYS.EnumMember;
        t.ENUMMEMBER_TYPES = q;
        const W = r.FLIPPED_ALIAS_KEYS.JSX;
        t.JSX_TYPES = W;
        const G = r.FLIPPED_ALIAS_KEYS.Miscellaneous;
        t.MISCELLANEOUS_TYPES = G;
        const z = r.FLIPPED_ALIAS_KEYS.TypeScript;
        t.TYPESCRIPT_TYPES = z;
        const $ = r.FLIPPED_ALIAS_KEYS.TSTypeElement;
        t.TSTYPEELEMENT_TYPES = $;
        const H = r.FLIPPED_ALIAS_KEYS.TSType;
        t.TSTYPE_TYPES = H;
    ...
    "9ed8": function(e, t) {
        t.GREATEST_LOWER_BOUND = 1,
            ...
            t.search = function(e, n, r, i) {
                if (0 === n.length)
                    return -1;
                var a = function e(n, r, i, a, o, s) {
                    var l = Math.floor((r - n) / 2) + n
                        , u = o(i, a[l], !0);
                    return 0 === u ? l : u > 0 ? r - l > 1 ? e(l, r, i, a, o, s) : s == t.LEAST_UPPER_BOUND ? r < a.length ? r : -1 : l : l - n > 1 ? e(n, l, i, a, o, s) : s == t.LEAST_UPPER_BOUND ? l : n < 0 ? -1 : n
    ...
    a737: function(e, t, n) {
        ...
        t.default = function(e) {
            var t = e.use(i.default)
                , n = t.Type.def
                , r = t.Type.or
                , o = e.use(a.default).defaults
                , s = r(n("TypeAnnotation"), n("TSTypeAnnotation"), null)
                , l = r(n("TypeParameterDeclaration"), n("TSTypeParameterDeclaration"), null);
            n("Identifier").field("typeAnnotation", s, o.null),
                n("ObjectPattern").field("typeAnnotation", s, o.null),
                n("Function").field("returnType", s, o.null).field("typeParameters", l, o.null),
                n("ClassProperty").build("key", "value", "typeAnnotation", "static").field("value", r(n("Expression"), null)).field("static", Boolean, o.false).field("typeAnnotation", s, o.null),
                ["ClassDeclaration", "ClassExpression"].forEach((function(e) {
                        n(e).field("typeParameters", l, o.null).field("superTypeParameters", r(n("TypeParameterInstantiation"), n("TSTypeParameterInstantiation"), null), o.null).field("implements", r([n("ClassImplements")], [n("TSExpressionWithTypeArguments")]), o.emptyArray)
                    }
                ))
        }
            ,
    ...
    a89b: function(e, t, n) {
        ...
        function l(e) {
            ...
            return "string" == typeof e && (t = JSON.parse(e.replace(/^\)\]\}'/, ""))),
                null != t.sections ? new c(t) : new u(t)
        }
        function u(e) {
            var t = e;
            ...
            i = i.map(String).map(r.normalize).map((function(e) {
                ...
                this._names = a.fromArray(o.map(String), !0),
        ...
        l.fromSourceMap = function(e) {
            ...
            u.fromSourceMap = function(e) {
                var t = Object.create(u.prototype)
                    , n = t._names = a.fromArray(e._names.toArray(), !0)
                    , i = t._sources = a.fromArray(e._sources.toArray(), !0);
                t.sourceRoot = e._sourceRoot,
                    t.sourcesContent = e._generateSourcesContent(t._sources.toArray(), t.sourceRoot),
                    t.file = e._file;
                for (var o = e._mappings.toArray().slice(), l = t.__generatedMappings = [], c = t.__originalMappings = [], d = 0, f = o.length; d < f; d++) {
                    var y = o[d]
                        , m = new p;
                    m.generatedLine = y.generatedLine,
                        m.generatedColumn = y.generatedColumn,
                    y.source && (m.source = i.indexOf(y.source),
                        m.originalLine = y.originalLine,
                        m.originalColumn = y.originalColumn,
                    y.name && (m.name = n.indexOf(y.name)),
                        c.push(m)),
                        l.push(m)
                }
            ...
            u.prototype._parseMappings = function(e, t) {
                for (var n, i, a, l, u, c = 1, d = 0, f = 0, y = 0, m = 0, h = 0, T = e.length, b = 0, S = {}, E = {}, v = [], g = []; b < T; )
                    if (";" === e.charAt(b))
                        c++,
                            b++,
                            d = 0;
                        ...
                        for ((n = new p).generatedLine = c,
                                 l = b; l < T && !this._charIsMappingSeparator(e, l); l++)
                            ;
                        if (a = S[i = e.slice(b, l)])
                            b += i.length;
                        else {
                            for (a = []; b < l; )
                                o.decode(e, b, E),
                        ...
                        n.generatedColumn = d + a[0],
                            d = n.generatedColumn,
                        a.length > 1 && (n.source = m + a[1],
                            m += a[1],
                            n.originalLine = f + a[2],
                            f = n.originalLine,
                            n.originalLine += 1,
                            n.originalColumn = y + a[3],
                            y = n.originalColumn,
                        a.length > 4 && (n.name = h + a[4],
                            h += a[4])),
                            g.push(n),
                        "number" == typeof n.originalLine && v.push(n)
                    }
                s(g, r.compareByGeneratedPositionsDeflated),
                    this.__generatedMappings = g,
                    s(v, r.compareByOriginalPositions),
                    this.__originalMappings = v
            }
            ,
            u.prototype._findMapping = function(e, t, n, r, a, o) {
                if (e[n] <= 0)
    ...
    aa20: function(e, t, n) {
        ...
        var r = n("4f38")
            , i = r.__importDefault(n("41ba"))
            , a = r.__importDefault(n("6911"))
            , o = Object.prototype.hasOwnProperty;
        t.default = function(e) {
            var t = e.use(i.default)
                , n = e.use(a.default)
                , r = t.builtInTypes.array
                , s = t.builtInTypes.object
                , l = t.builtInTypes.function
                , u = function e() {
                if (!(this instanceof e))
                    throw new Error("PathVisitor constructor cannot be invoked without 'new'");
                this._reusableContextStack = [],
                    this._methodNameTable = function(e) {
                        var n = Object.create(null);
                        for (var r in e)
                            /^visit[A-Z]/.test(r) && (n[r.slice("visit".length)] = !0);
                        for (var i = t.computeSupertypeLookupTable(n), a = Object.create(null), o = Object.keys(i), s = o.length, u = 0; u < s; ++u) {
                            var p = o[u];
                            r = "visit" + i[p],
                            l.check(e[r]) && (a[p] = r)
                        }
                    ...
                    this._shouldVisitComments = o.call(this._methodNameTable, "Block") || o.call(this._methodNameTable, "Line"),
            ...
            u.fromMethodsObject = function(e) {
                if (e instanceof u)
                    return e;
                if (!s.check(e))
                    return new u;
                ...
                u.visit = function(e, t) {
                    return u.fromMethodsObject(t).visit(e)
                }
            ;
            var c = u.prototype;
            function d(e, i) {
                ...
                if (r.check(a))
                    ...
                    i._shouldVisitComments && a.comments && l.indexOf("comments") < 0 && l.push("comments");
                    for (var p = l.length, c = [], d = 0; d < p; ++d) {
                        var f = l[d];
                        o.call(a, f) || (a[f] = t.getFieldValue(a, f)),
                            c.push(e.get(f))
                    }
                    for (d = 0; d < p; ++d)
                        i.visitWithoutReset(c[d])
                }
                return e.value
            }
            c.visit = function() {
                ...
                for (var e, t = arguments.length, r = new Array(t), i = 0; i < t; ++i)
                    r[i] = arguments[i];
                r[0]instanceof n || (r[0] = new n({
                    root: r[0]
                }).get("root")),
                    this.reset.apply(this, r);
                try {
                    var a = this.visitWithoutReset(r[0]);
                    e = !0
                } finally {
                    if (this._visiting = !1,
                    !e && this._abortRequested)
                        return r[0].value
                }
                return a
            }
                ,
                c.AbortRequest = function() {}
                ,
                c.abort = function() {
                    var e = this;
                    e._abortRequested = !0;
                    var t = new e.AbortRequest;
                    throw t.cancel = function() {
                        e._abortRequested = !1
                    }
                        ,
                        t
                ...
                c.reset = function(e) {}
                ,
                c.visitWithoutReset = function(e) {
                    if (this instanceof this.Context)
                        return this.visitor.visitWithoutReset(e);
                    if (!(e instanceof n))
                        throw new Error("");
                    var t = e.value
                        , r = t && "object" == typeof t && "string" == typeof t.type && this._methodNameTable[t.type];
                    if (!r)
                        return d(e, this);
                    var i = this.acquireContext(e);
                    try {
                        return i.invokeVisitorMethod(r)
                    } finally {
                        this.releaseContext(i)
                    }
                }
                ,
                c.acquireContext = function(e) {
                    return 0 === this._reusableContextStack.length ? new this.Context(e) : this._reusableContextStack.pop().reset(e)
                }
                ,
                c.releaseContext = function(e) {
                ...
                ,
                c.wasChangeReported = function() {
                    return this._changeReported
                }
            ;
            var f = Object.create(null);
            return f.reset = function(e) {
                if (!(this instanceof this.Context))
                    throw new Error("");
                if (!(e instanceof n))
                    throw new Error("");
                ...
                ,
                f.invokeVisitorMethod = function(e) {
                    if (!(this instanceof this.Context))
                        throw new Error("");
                    if (!(this.currentPath instanceof n))
                        throw new Error("");
                    var t = this.visitor[e].call(this, this.currentPath);
                    if (!1 === t ? this.needToCallTraverse = !1 : void 0 !== t && (this.currentPath = this.currentPath.replace(t)[0],
                    this.needToCallTraverse && this.traverse(this.currentPath)),
                    !1 !== this.needToCallTraverse)
                        throw new Error("Must either call this.traverse or return false in " + e);
                    var r = this.currentPath;
                    return r && r.value
                }
                ,
                f.traverse = function(e, t) {
                    if (!(this instanceof this.Context))
                        throw new Error("");
                    if (!(e instanceof n))
                        throw new Error("");
                    if (!(this.currentPath instanceof n))
                        throw new Error("");
                    return this.needToCallTraverse = !1,
                        d(e, u.fromMethodsObject(t || this.visitor))
                }
                ,
                f.visit = function(e, t) {
                    if (!(this instanceof this.Context))
                        throw new Error("");
                    if (!(e instanceof n))
                        throw new Error("");
                    if (!(this.currentPath instanceof n))
                        throw new Error("");
                    return this.needToCallTraverse = !1,
                        u.fromMethodsObject(t || this.visitor).visitWithoutReset(e)
                }
                ,
                f.reportChanged = function() {
    ...
    aa71: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            ,
            t.FunctionTypeAnnotation = function(e, t, n) {
                return W(t) || x(t) || i(t) || U(t) && a(n[n.length - 3])
            }
            ,
            ...
            t.TSIntersectionType = t.TSUnionType = function(e, t) {
                return k(t) || R(t) || B(t) || Y(t) || K(t)
            }
            ,
            t.TSInferType = function(e, t) {
                return k(t) || R(t)
            }
            ,
            t.BinaryExpression = function(e, t) {
                return "in" === e.operator && (G(t) || b(t))
            }
            ,
            t.SequenceExpression = function(e, t) {
                return !(v(t) || X(t) || j(t) || g(t) && t.test === e || z(t) && t.test === e || S(t) && t.right === e || L(t) && t.discriminant === e || T(t) && t.expression === e)
            }
            ,
            t.AwaitExpression = t.YieldExpression = function(e, t) {
                return l(t) || q(t) || Z(e, t) || s(t) && $(e) || y(t) && e === t.test || Q(e, t)
            }
            ,
            ...
            ,
            t.ConditionalExpression = te,
            t.OptionalCallExpression = t.OptionalMemberExpression = function(e, t) {
                return p(t, {
                    callee: e
                }) || O(t, {
                    object: e
            ...
            ,
            t.AssignmentExpression = function(e, t) {
                return !!I(e.left) || te(e, t)
            }
            ,
            t.LogicalExpression = function(e, t) {
                switch (e.operator) {
                    case "||":
            ...
            t.Identifier = function(e, t, n) {
                ...
                return "async" === e.name && E(t) && e === t.left
            }
        ;
        var r = n("252a");
        const {isArrayTypeAnnotation: i, isArrowFunctionExpression: a, isAssignmentExpression: o, isAwaitExpression: s, isBinary: l, isBinaryExpression: u, isCallExpression: p, isClassDeclaration: c, isClassExpression: d, isConditional: f, isConditionalExpression: y, isExportDeclaration: m, isExportDefaultDeclaration: h, isExpressionStatement: T, isFor: b, isForInStatement: S, isForOfStatement: E, isForStatement: v, isIfStatement: g, isIndexedAccessType: P, isIntersectionTypeAnnotation: x, isLogicalExpression: A, isMemberExpression: O, isNewExpression: _, isNullableTypeAnnotation: w, isObjectPattern: I, isOptionalCallExpression: N, isOptionalMemberExpression: D, isReturnStatement: j, isSequenceExpression: C, isSwitchStatement: L, isTSArrayType: k, isTSAsExpression: M, isTSIntersectionType: B, isTSNonNullExpression: F, isTSOptionalType: R, isTSRestType: K, isTSTypeAssertion: V, isTSUnionType: Y, isTaggedTemplateExpression: J, isThrowStatement: X, isTypeAnnotation: U, isUnaryLike: q, isUnionTypeAnnotation: W, isVariableDeclarator: G, isWhileStatement: z, isYieldExpression: $} = r
            , H = {
            "||": 0,
            "??": 0,
            "&&": 1,
            ...
            , Q = (e,t)=>(c(t) || d(t)) && t.superClass === e
            , Z = (e,t)=>(O(t) || D(t)) && t.object === e || (p(t) || N(t) || _(t)) && t.callee === e || J(t) && t.tag === e || F(t);
        function ee(e, t) {
            return Z(e, t) || u(t, {
                operator: "**",
                left: e
        ...
        function ne(e, {expressionStatement: t=!1, arrowBody: n=!1, exportDefault: r=!1, forHead: i=!1, forInHead: s=!1, forOfHead: u=!1}) {
            let p = e.length - 1
                , c = e[p];
            p--;
            let d = e[p];
            for (; p >= 0; ) {
                if (t && T(d, {
                    ...
                    return !0;
                if (!(Z(c, d) && !_(d) || C(d) && d.expressions[0] === c || f(d, {
                    test: c
                }) || l(d, {
                    left: c
                }) || o(d, {
    ...
    ab23: function(e, t, n) {
        ...
        var r = n("4f38")
            ...
            , o = r.__importDefault(n("09c8"));
        t.default = function(e) {
            var t = e.use(a.default).Type
                , n = t.def
                , r = t.or
                , s = e.use(o.default)
                , l = s.defaults
                , u = s.geq;
            n("Printable").field("loc", r(n("SourceLocation"), null), l.null, !0),
                n("Node").bases("Printable").field("type", String).field("comments", r([n("Comment")], null), l.null, !0),
                n("SourceLocation").field("start", n("Position")).field("end", n("Position")).field("source", r(String, null), l.null),
                n("Position").field("line", u(1)).field("column", u(0)),
                n("File").bases("Node").build("program", "name").field("program", n("Program")).field("name", r(String, null), l.null),
                n("Program").bases("Node").build("body").field("body", [n("Statement")]),
                n("Function").bases("Node").field("id", r(n("Identifier"), null), l.null).field("params", [n("Pattern")]).field("body", n("BlockStatement")).field("generator", Boolean, l.false).field("async", Boolean, l.false),
                ...
                n("IfStatement").bases("Statement").build("test", "consequent", "alternate").field("test", n("Expression")).field("consequent", n("Statement")).field("alternate", r(n("Statement"), null), l.null),
                n("LabeledStatement").bases("Statement").build("label", "body").field("label", n("Identifier")).field("body", n("Statement")),
                n("BreakStatement").bases("Statement").build("label").field("label", r(n("Identifier"), null), l.null),
                n("ContinueStatement").bases("Statement").build("label").field("label", r(n("Identifier"), null), l.null),
                n("WithStatement").bases("Statement").build("object", "body").field("object", n("Expression")).field("body", n("Statement")),
                n("SwitchStatement").bases("Statement").build("discriminant", "cases", "lexical").field("discriminant", n("Expression")).field("cases", [n("SwitchCase")]).field("lexical", Boolean, l.false),
                n("ReturnStatement").bases("Statement").build("argument").field("argument", r(n("Expression"), null)),
                n("ThrowStatement").bases("Statement").build("argument").field("argument", n("Expression")),
                n("TryStatement").bases("Statement").build("block", "handler", "finalizer").field("block", n("BlockStatement")).field("handler", r(n("CatchClause"), null), (function() {
                        return this.handlers && this.handlers[0] || null
                    }
                )).field("handlers", [n("CatchClause")], (function() {
                        return this.handler ? [this.handler] : []
                    }
                ), !0).field("guardedHandlers", [n("CatchClause")], l.emptyArray).field("finalizer", r(n("BlockStatement"), null), l.null),
                n("CatchClause").bases("Node").build("param", "guard", "body").field("param", n("Pattern")).field("guard", r(n("Expression"), null), l.null).field("body", n("BlockStatement")),
                ...
                n("ForStatement").bases("Statement").build("init", "test", "update", "body").field("init", r(n("VariableDeclaration"), n("Expression"), null)).field("test", r(n("Expression"), null)).field("update", r(n("Expression"), null)).field("body", n("Statement")),
                n("ForInStatement").bases("Statement").build("left", "right", "body").field("left", r(n("VariableDeclaration"), n("Expression"))).field("right", n("Expression")).field("body", n("Statement")),
                ...
                n("VariableDeclaration").bases("Declaration").build("kind", "declarations").field("kind", r("var", "let", "const")).field("declarations", [n("VariableDeclarator")]),
                n("VariableDeclarator").bases("Node").build("id", "init").field("id", n("Pattern")).field("init", r(n("Expression"), null), l.null),
                n("Expression").bases("Node"),
                n("ThisExpression").bases("Expression").build(),
                n("ArrayExpression").bases("Expression").build("elements").field("elements", [r(n("Expression"), null)]),
                n("ObjectExpression").bases("Expression").build("properties").field("properties", [n("Property")]),
                n("Property").bases("Node").build("kind", "key", "value").field("kind", r("init", "get", "set")).field("key", r(n("Literal"), n("Identifier"))).field("value", n("Expression")),
                n("SequenceExpression").bases("Expression").build("expressions").field("expressions", [n("Expression")]);
            var p = r("-", "+", "!", "~", "typeof", "void", "delete");
            n("UnaryExpression").bases("Expression").build("operator", "argument", "prefix").field("operator", p).field("argument", n("Expression")).field("prefix", Boolean, l.true);
            var c = r.apply(void 0, i.BinaryOperators);
            ...
            var d = r.apply(void 0, i.AssignmentOperators);
            n("AssignmentExpression").bases("Expression").build("operator", "left", "right").field("operator", d).field("left", r(n("Pattern"), n("MemberExpression"))).field("right", n("Expression"));
            var f = r("++", "--");
            n("UpdateExpression").bases("Expression").build("operator", "argument", "prefix").field("operator", f).field("argument", n("Expression")).field("prefix", Boolean);
            var y = r.apply(void 0, i.LogicalOperators);
            n("LogicalExpression").bases("Expression").build("operator", "left", "right").field("operator", y).field("left", n("Expression")).field("right", n("Expression")),
                ...
                n("MemberExpression").bases("Expression").build("object", "property", "computed").field("object", n("Expression")).field("property", r(n("Identifier"), n("Expression"))).field("computed", Boolean, (function() {
                        var e = this.property.type;
                        return "Literal" === e || "MemberExpression" === e || "BinaryExpression" === e
                    }
                )),
                n("Pattern").bases("Node"),
                n("SwitchCase").bases("Node").build("test", "consequent").field("test", r(n("Expression"), null)).field("consequent", [n("Statement")]),
                n("Identifier").bases("Expression", "Pattern").build("name").field("name", String).field("optional", Boolean, l.false),
                n("Literal").bases("Expression").build("value").field("value", r(String, Boolean, null, Number, RegExp)).field("regex", r({
                    pattern: String,
                    flags: String
                }, null), (function() {
                        if (this.value instanceof RegExp) {
                            var e = "";
                            return this.value.ignoreCase && (e += "i"),
                            this.value.multiline && (e += "m"),
                            this.value.global && (e += "g"),
                                {
                ...
                n("Comment").bases("Printable").field("value", String).field("leading", Boolean, l.true).field("trailing", Boolean, l.false)
        }
            ,
            e.exports = t.default
    },
    ad79: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t._methodHead = function(e) {
                const t = e.kind
                    , n = e.key;
                "get" !== t && "set" !== t || (this.word(t),
                    this.space()),
                e.async && (this._catchUp("start", n.loc),
                    this.word("async"),
                    this.space()),
                "method" !== t && "init" !== t || e.generator && this.token("*"),
                    e.computed ? (this.token("["),
                        this.print(n, e),
                        this.token("]")) : this.print(n, e),
                e.optional && this.token("?"),
                    this._params(e)
            }
            ,
            t._predicate = function(e) {
                e.predicate && (e.returnType || this.token(":"),
                    this.space(),
                    this.print(e.predicate, e))
            }
            ,
            t._functionHead = function(e) {
                e.async && (this.word("async"),
                    this.space()),
                    this.word("function"),
    ...
    b0d3: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.BlockStatement = function(e) {
                ...
                this.endsWith(10) || this.newline(),
                    this.rightBrace()) : (this.source("end", e.loc),
                    this.token("}"))
            }
            ,
    ...
    b0fe: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.TSTypeParameter = function(e) {
                this.word(e.name),
                e.constraint && (this.space(),
                    this.word("extends"),
                    this.space(),
                    this.print(e.constraint, e)),
                e.default && (this.space(),
                    this.token("="),
                    this.space(),
            ...
            t.TSParameterProperty = function(e) {
                e.accessibility && (this.word(e.accessibility),
                    this.space()),
                e.readonly && (this.word("readonly"),
                    this.space()),
            ...
            t.TSTypePredicate = function(e) {
                e.asserts && (this.word("asserts"),
                    this.space()),
                    this.print(e.parameterName),
                e.typeAnnotation && (this.space(),
                    this.word("is"),
                    this.space(),
            ...
            ,
            t.TSNamedTupleMember = function(e) {
                this.print(e.label, e),
                e.optional && this.token("?"),
                    this.token(":"),
                    this.space(),
            ...
            t.TSMappedType = function(e) {
                const {nameType: t, optional: n, readonly: i, typeParameter: a} = e;
                this.token("{"),
                    this.space(),
                i && (r(this, i),
                    this.word("readonly"),
            ...
            t.TSModuleDeclaration = function(e) {
                ...
                if (t && (this.word("declare"),
                    this.space()),
                e.global || (this.word("Identifier" === n.type ? "namespace" : "module"),
                    this.space()),
                    this.print(n, e),
                    !e.body)
            ...
            ,
            t.tsPrintClassMemberModifiers = function(e, t) {
                t && e.declare && (this.word("declare"),
                    this.space()),
                e.accessibility && (this.word(e.accessibility),
                    this.space()),
                e.static && (this.word("static"),
                    this.space()),
                e.override && (this.word("override"),
                    this.space()),
                e.abstract && (this.word("abstract"),
                    this.space()),
                t && e.readonly && (this.word("readonly"),
                    this.space())
            }
            ,
            n("252a")
    ...
    b469e: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            ,
            t.EnumNumberMember = function(e) {
                p(this, e)
            }
            ,
            t.EnumStringMember = function(e) {
                p(this, e)
            }
            ,
            ...
            t.FunctionTypeAnnotation = function(e, t) {
                this.print(e.typeParameters, e),
                    this.token("("),
                e.this && (this.word("this"),
                    this.token(":"),
                    this.space(),
                    this.print(e.this.typeAnnotation, e),
                (e.params.length || e.rest) && (this.token(","),
                    this.space())),
                    this.printList(e.params, e),
                e.rest && (e.params.length && (this.token(","),
                    this.space()),
                    this.token("..."),
                    this.print(e.rest, e)),
                    this.token(")"),
                    "ObjectTypeCallProperty" === t.type || "DeclareFunction" === t.type || "ObjectTypeProperty" === t.type && t.method ? this.token(":") : (this.space(),
                        this.token("=>")),
                    this.space(),
                    this.print(e.returnType, e)
            }
            ...
            t._interfaceish = function(e) {
                ...
                this.print(e.id, e),
                    this.print(e.typeParameters, e),
                null != (t = e.extends) && t.length && (this.space(),
                    this.word("extends"),
                    this.space(),
                    this.printList(e.extends, e)),
                e.mixins && e.mixins.length && (this.space(),
                    this.word("mixins"),
                    this.space(),
                    this.printList(e.mixins, e)),
                e.implements && e.implements.length && (this.space(),
                    this.word("implements"),
                    this.space(),
                    this.printList(e.implements, e)),
                    this.space(),
            ...
            t.InterfaceTypeAnnotation = function(e) {
                this.word("interface"),
                e.extends && e.extends.length && (this.space(),
                    this.word("extends"),
                    this.space(),
                    this.printList(e.extends, e)),
                    this.space(),
            ...
            t.OpaqueType = function(e) {
                this.word("opaque"),
                    ...
                    this.print(e.id, e),
                    this.print(e.typeParameters, e),
                e.supertype && (this.token(":"),
                    this.space(),
                    this.print(e.supertype, e)),
                e.impltype && (this.space(),
                    this.token("="),
                    this.space(),
            ...
            t.ObjectTypeAnnotation = function(e) {
                ...
                t.length && (this.space(),
                    this.printJoin(t, e, {
                        ...
                        statement: !0,
                        iterator: ()=>{
                            (1 !== t.length || e.inexact) && (this.token(","),
                                this.space())
                        }
                    }),
                    this.space()),
                e.inexact && (this.indent(),
                    this.token("..."),
            ...
            t.ObjectTypeProperty = function(e) {
                e.proto && (this.word("proto"),
                    this.space()),
                e.static && (this.word("static"),
                    this.space()),
                "get" !== e.kind && "set" !== e.kind || (this.word(e.kind),
                    this.space()),
                    this._variance(e),
                    this.print(e.key, e),
                e.optional && this.token("?"),
            ...
            ,
            t.IndexedAccessType = function(e) {
                this.print(e.objectType, e),
                    this.token("["),
                    this.print(e.indexType, e),
                    this.token("]")
            ...
            ,
            t.OptionalIndexedAccessType = function(e) {
                this.print(e.objectType, e),
                e.optional && this.token("?."),
                    this.token("["),
                    this.print(e.indexType, e),
        ...
        var r = n("252a")
            , i = n("36cd")
            , a = n("d062");
        const {isDeclareExportDeclaration: o, isStatement: s} = r;
        function l(e, t, n) {
            n && (e.space(),
                e.word("of"),
                e.space(),
        ...
        function c(e) {
            if (e.declaration) {
                ...
                this.token("{"),
                e.specifiers.length && (this.space(),
    ...
    b59d: function(e, t, n) {
        ...
        (function(t) {
                const n = {}
                    ...
                    , o = Array.isArray
                    , s = t.isBuffer
                    , l = e=>"[object Object]" == a.call(e)
                    , u = e=>"string" == typeof e || "[object String]" == a.call(e)
                    , p = e=>"number" == typeof e || "[object Number]" == a.call(e)
                    , c = e=>"[object Map]" == a.call(e)
                    , d = e=>"[object Set]" == a.call(e)
                    , f = {
                        '"': '\\"',
                        "'": "\\'",
                        "\\": "\\\\",
                    ...
                    , T = (e,t)=>{
                        const n = ()=>{
                            g = v,
                                ++t.indentLevel,
                                v = t.indent.repeat(t.indentLevel)
                        }
                            , r = {
                            escapeEverything: !1,
                            minimal: !1,
                        ...
                        a && (r.quotes = "double",
                            r.wrap = !0),
                        "single" != (t = ((e,t)=>t ? (i(t, (t,n)=>{
                                e[t] = n
                            }
                        ),
                            e) : e)(r, t)).quotes && "double" != t.quotes && "backtick" != t.quotes && (t.quotes = "single");
                        const b = "double" == t.quotes ? '"' : "backtick" == t.quotes ? "`" : "'"
                            , S = t.compact
                            , E = t.lowercaseHex;
                        let v = t.indent.repeat(t.indentLevel)
                            , g = "";
                        const P = t.__inline1__
                            , x = t.__inline2__
                            , A = S ? "" : "\n";
                        let O, _ = !0;
                        const w = "binary" == t.numbers
                            , I = "octal" == t.numbers
                            , N = "decimal" == t.numbers
                            , D = "hexadecimal" == t.numbers;
                        if (a && e && (e=>"function" == typeof e)(e.toJSON) && (e = e.toJSON()),
                            !u(e)) {
                            if (c(e))
                                return 0 == e.size ? "new Map()" : (S || (t.__inline1__ = !0,
                                    t.__inline2__ = !1),
                                "new Map(" + T(Array.from(e), t) + ")");
                            if (d(e))
                                return 0 == e.size ? "new Set()" : "new Set(" + T(Array.from(e), t) + ")";
                            if (s(e))
                                return 0 == e.length ? "Buffer.from([])" : "Buffer.from(" + T(Array.from(e), t) + ")";
                            if (o(e))
                                return O = [],
                                    t.wrap = !0,
                                P && (t.__inline1__ = !1,
                            ...
                            if (!p(e))
                                return l(e) ? (O = [],
                                    ...
                                    i(e, (e,n)=>{
                                            _ = !1,
                                                O.push((S ? "" : v) + T(e, t) + ":" + (S ? "" : " ") + T(n, t))
                                        }
                                    ),
                                    _ ? "{}" : "{" + A + O.join("," + A) + A + (S ? "" : g) + "}") : a ? JSON.stringify(e) || "null" : String(e);
                            if (a)
                        ...
                        for (O = ""; ++C < L; ) {
                            const e = j.charAt(C);
                            if (t.es6) {
                                const e = j.charCodeAt(C);
                                if (e >= 55296 && e <= 56319 && L > C + 1) {
                                    const t = j.charCodeAt(C + 1);
                                    if (t >= 56320 && t <= 57343) {
                            ...
                            let r = n.toString(16);
                            E || (r = r.toUpperCase());
                            const i = r.length > 2 || a
                                , o = "\\" + (i ? "u" : "x") + ("0000" + r).slice(i ? -4 : -2);
                            O += o
                        }
                        return t.wrap && (O = b + O + b),
                        "`" == b && (O = O.replace(/\$\{/g, "\\${")),
                            t.isScriptContext ? O.replace(/<\/(script|style)/gi, "<\\/$1").replace(/<!--/g, a ? "\\u003C!--" : "\\x3C!--") : O
                    }
                ;
                T.version = "2.5.2",
                    e.exports = T
    ...
    b9c3: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.default = function(e, t=!0) {
                return "string" == typeof e && (!t || !(0,
                    r.isKeyword)(e) && !(0,
                    r.isStrictReservedWord)(e, !0)) && (0,
    ...
    bda9: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.readCodePoint = p,
            t.readInt = u,
            t.readStringContents = function(e, t, n, r, i, a) {
                const l = n
                    , u = r
                    , p = i;
                let c = ""
                ...
                for (; ; ) {
                    if (n >= y) {
                        a.unterminated(l, u, p),
                            c += t.slice(f, n);
                        break
                    }
                    const m = t.charCodeAt(n);
                    if (o(e, m, t, n)) {
                        c += t.slice(f, n);
                        break
                    }
                    if (92 === m) {
                        let o;
                        c += t.slice(f, n),
                            ({ch: o, pos: n, lineStart: r, curLine: i} = s(t, n, r, i, "template" === e, a)),
                            null === o ? d = !0 : c += o,
                            f = n
                    } else
                        8232 === m || 8233 === m ? (++n,
                            ++i,
                            r = n) : 10 === m || 13 === m ? "template" === e ? (c += t.slice(f, n) + "\n",
                            ++n,
                        13 === m && 10 === t.charCodeAt(n) && ++n,
                            ++i,
                            f = r = n) : a.unterminated(l, u, p) : ++n
                }
                return {
                    pos: n,
                    str: c,
        ...
        function o(e, t, n, r) {
            return "template" === e ? 96 === t || 36 === t && 123 === n.charCodeAt(r + 1) : t === ("double" === e ? 34 : 39)
        }
        function s(e, t, n, r, i, a) {
            ...
            switch (u) {
                ...
                {
                    let i;
                    return ({code: i, pos: t} = l(e, t, n, r, 2, !1, o, a)),
                        s(null === i ? null : String.fromCharCode(i))
                }
                case 117:
                {
                    let i;
                    return ({code: i, pos: t} = p(e, t, n, r, o, a)),
                        s(null === i ? null : String.fromCodePoint(i))
                }
                case 116:
                    return s("\t");
                case 98:
                ...
                default:
                    if (u >= 48 && u <= 55) {
                        const o = t - 1;
                        let l = e.slice(o, t + 2).match(/^[0-7]+/)[0]
                            , u = parseInt(l, 8);
                        u > 255 && (l = l.slice(0, -1),
                            u = parseInt(l, 8)),
                            t += l.length - 1;
                        ...
                        return s(String.fromCharCode(u))
                    }
                    return s(String.fromCharCode(u))
            }
        }
        function l(e, t, n, r, i, a, o, s) {
            const l = t;
            let p;
            return ({n: p, pos: t} = u(e, t, n, r, 16, i, a, !1, s)),
            null === p && (o ? s.invalidEscapeSequence(l, n, r) : t = l - 1),
                {
                    code: p,
                    pos: t
                }
        }
        function u(e, t, n, o, s, l, u, p, c) {
            const d = t
                , f = 16 === s ? i.hex : i.decBinOct
                , y = 16 === s ? a.hex : 10 === s ? a.dec : 8 === s ? a.oct : a.bin;
            let m = !1
                , h = 0;
            for (let i = 0, a = null == l ? 1 / 0 : l; i < a; ++i) {
                const i = e.charCodeAt(t);
                let a;
                if (95 !== i || "bail" === p) {
                    if (a = i >= 97 ? i - 97 + 10 : i >= 65 ? i - 65 + 10 : r(i) ? i - 48 : 1 / 0,
                    a >= s)
                        if (a <= 9 && c.invalidDigit(t, n, o, s))
                            a = 0;
                        else {
                            if (!u)
                                break;
                    ...
                    const r = e.charCodeAt(t - 1)
                        , i = e.charCodeAt(t + 1);
                    p ? (Number.isNaN(i) || !y(i) || f.has(r) || f.has(i)) && c.unexpectedNumericSeparator(t, n, o) : c.numericSeparatorInEscapeSequence(t, n, o),
                        ++t
                }
            }
        ...
        function p(e, t, n, r, i, a) {
            ...
            if (123 === e.charCodeAt(t)) {
                if (++t,
                    ({code: o, pos: t} = l(e, t, n, r, e.indexOf("}", t) - t, !0, i, a)),
                    ++t,
                null !== o && o > 1114111) {
                    if (!i)
                        return {
                ...
                ({code: o, pos: t} = l(e, t, n, r, 4, !1, i, a));
            return {
                code: o,
                pos: t
            }
    ...
    beaa: function(e, t, n) {
        ...
        var r = n("57de")
            , i = n("cf44");
        const a = (0,
            r.defineAliasedType)("Miscellaneous");
        a("Noop", {
            visitor: []
        }),
            a("Placeholder", {
    ...
    bf78: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.default = function(e, t=!0, n=!1) {
                return l(e, t, n, new Map)
            }
        ;
        var r = n("b978")
            , i = n("c485");
        const a = Function.call.bind(Object.prototype.hasOwnProperty);
        function o(e, t, n, r) {
            return e && "string" == typeof e.type ? l(e, t, n, r) : e
        }
        function s(e, t, n, r) {
            return Array.isArray(e) ? e.map(e=>o(e, t, n, r)) : o(e, t, n, r)
        }
        function l(e, t=!0, n=!1, o) {
            if (!e)
                return e;
            const {type: l} = e
                , p = {
            ...
            if ((0,
                i.isIdentifier)(e))
                p.name = e.name,
                a(e, "optional") && "boolean" == typeof e.optional && (p.optional = e.optional),
                a(e, "typeAnnotation") && (p.typeAnnotation = t ? s(e.typeAnnotation, !0, n, o) : e.typeAnnotation);
            else {
                if (!a(r.NODE_FIELDS, l))
                    throw new Error(`Unknown node type: "${l}"`);
                for (const c of Object.keys(r.NODE_FIELDS[l]))
                    a(e, c) && (p[c] = t ? (0,
                        i.isFile)(e) && "comments" === c ? u(e.comments, t, n, o) : s(e[c], !0, n, o) : e[c])
            }
            return a(e, "loc") && (p.loc = n ? null : e.loc),
            a(e, "leadingComments") && (p.leadingComments = u(e.leadingComments, t, n, o)),
            a(e, "innerComments") && (p.innerComments = u(e.innerComments, t, n, o)),
            a(e, "trailingComments") && (p.trailingComments = u(e.trailingComments, t, n, o)),
            a(e, "extra") && (p.extra = Object.assign({}, e.extra)),
                p
        }
        function u(e, t, n, r) {
            return e && t ? e.map(e=>{
    ...
    c10d: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.default = function(e) {
                return (0,
                    r.isVariableDeclaration)(e) && ("var" !== e.kind || e[i.BLOCK_SCOPED_SYMBOL])
            }
        ;
        var r = n("c485")
            , i = n("9046")
        ...
        function i(e, t, n) {
            ...
            for (; a.length; ) {
                ...
                if ((0,
                    ...
                    r.isExportDeclaration)(e) || (0,
                    r.isExportAllDeclaration)(e)) {
                    if (n) {
                        if ((0,
                            r.isFunctionDeclaration)(e)) {
                            a.push(e.id);
                            continue
                        }
                        if ((0,
                            r.isFunctionExpression)(e))
                            continue
                    }
                    if (s)
                        for (let t = 0; t < s.length; t++) {
                            const n = e[s[t]];
                            n && (Array.isArray(n) ? a.push(...n) : a.push(n))
                        }
                } else
                    (0,
                        r.isDeclaration)(e.declaration) && a.push(e.declaration)
            }
            return o
        }
        i.keys = {
    ...
    c485: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.isAccessor = function(e, t) {
                if (!e)
                    return !1;
                return "ClassAccessorProperty" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isAnyTypeAnnotation = function(e, t) {
                if (!e)
                    return !1;
                return "AnyTypeAnnotation" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isArgumentPlaceholder = function(e, t) {
                if (!e)
                    return !1;
                return "ArgumentPlaceholder" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isArrayExpression = function(e, t) {
                if (!e)
                    return !1;
                return "ArrayExpression" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isArrayPattern = function(e, t) {
                if (!e)
                    return !1;
                return "ArrayPattern" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isArrayTypeAnnotation = function(e, t) {
                if (!e)
                    return !1;
                return "ArrayTypeAnnotation" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isArrowFunctionExpression = function(e, t) {
                if (!e)
                    return !1;
                return "ArrowFunctionExpression" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isAssignmentExpression = function(e, t) {
                if (!e)
                    return !1;
                return "AssignmentExpression" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isAssignmentPattern = function(e, t) {
                if (!e)
                    return !1;
                return "AssignmentPattern" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isAwaitExpression = function(e, t) {
                if (!e)
                    return !1;
                return "AwaitExpression" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isBigIntLiteral = function(e, t) {
                if (!e)
                    return !1;
                return "BigIntLiteral" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isBinary = function(e, t) {
                if (!e)
                    return !1;
                const n = e.type;
                return ("BinaryExpression" === n || "LogicalExpression" === n) && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isBinaryExpression = function(e, t) {
                if (!e)
                    return !1;
                return "BinaryExpression" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isBindExpression = function(e, t) {
                if (!e)
                    return !1;
                return "BindExpression" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isBlock = function(e, t) {
                if (!e)
                    return !1;
                const n = e.type;
                return ("BlockStatement" === n || "Program" === n || "TSModuleBlock" === n || "Placeholder" === n && "BlockStatement" === e.expectedNode) && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            ...
            t.isBlockStatement = function(e, t) {
                if (!e)
                    return !1;
                return "BlockStatement" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isBooleanLiteral = function(e, t) {
                if (!e)
                    return !1;
                return "BooleanLiteral" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isBooleanLiteralTypeAnnotation = function(e, t) {
                if (!e)
                    return !1;
                return "BooleanLiteralTypeAnnotation" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isBooleanTypeAnnotation = function(e, t) {
                if (!e)
                    return !1;
                return "BooleanTypeAnnotation" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isBreakStatement = function(e, t) {
                if (!e)
                    return !1;
                return "BreakStatement" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isCallExpression = function(e, t) {
                if (!e)
                    return !1;
                return "CallExpression" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isCatchClause = function(e, t) {
                if (!e)
                    return !1;
                return "CatchClause" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isClass = function(e, t) {
                if (!e)
                    return !1;
                const n = e.type;
                return ("ClassExpression" === n || "ClassDeclaration" === n) && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isClassAccessorProperty = function(e, t) {
                if (!e)
                    return !1;
                return "ClassAccessorProperty" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            ...
            t.isClassBody = function(e, t) {
                if (!e)
                    return !1;
                return "ClassBody" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isClassDeclaration = function(e, t) {
                if (!e)
                    return !1;
                return "ClassDeclaration" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isClassExpression = function(e, t) {
                if (!e)
                    return !1;
                return "ClassExpression" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isClassImplements = function(e, t) {
                if (!e)
                    return !1;
                return "ClassImplements" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isClassMethod = function(e, t) {
                if (!e)
                    return !1;
                return "ClassMethod" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isClassPrivateMethod = function(e, t) {
                if (!e)
                    return !1;
                return "ClassPrivateMethod" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isClassPrivateProperty = function(e, t) {
                if (!e)
                    return !1;
                return "ClassPrivateProperty" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isClassProperty = function(e, t) {
                if (!e)
                    return !1;
                return "ClassProperty" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isCompletionStatement = function(e, t) {
                if (!e)
                    return !1;
                const n = e.type;
                return ("BreakStatement" === n || "ContinueStatement" === n || "ReturnStatement" === n || "ThrowStatement" === n) && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isConditional = function(e, t) {
                if (!e)
                    return !1;
                const n = e.type;
                return ("ConditionalExpression" === n || "IfStatement" === n) && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isConditionalExpression = function(e, t) {
                if (!e)
                    return !1;
                return "ConditionalExpression" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isContinueStatement = function(e, t) {
                if (!e)
                    return !1;
                return "ContinueStatement" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDebuggerStatement = function(e, t) {
                if (!e)
                    return !1;
                return "DebuggerStatement" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDecimalLiteral = function(e, t) {
                if (!e)
                    return !1;
                return "DecimalLiteral" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            ...
            t.isDeclareClass = function(e, t) {
                if (!e)
                    return !1;
                return "DeclareClass" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDeclareExportAllDeclaration = function(e, t) {
                if (!e)
                    return !1;
                return "DeclareExportAllDeclaration" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDeclareExportDeclaration = function(e, t) {
                if (!e)
                    return !1;
                return "DeclareExportDeclaration" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDeclareFunction = function(e, t) {
                if (!e)
                    return !1;
                return "DeclareFunction" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDeclareInterface = function(e, t) {
                if (!e)
                    return !1;
                return "DeclareInterface" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDeclareModule = function(e, t) {
                if (!e)
                    return !1;
                return "DeclareModule" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDeclareModuleExports = function(e, t) {
                if (!e)
                    return !1;
                return "DeclareModuleExports" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDeclareOpaqueType = function(e, t) {
                if (!e)
                    return !1;
                return "DeclareOpaqueType" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDeclareTypeAlias = function(e, t) {
                if (!e)
                    return !1;
                return "DeclareTypeAlias" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDeclareVariable = function(e, t) {
                if (!e)
                    return !1;
                return "DeclareVariable" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDeclaredPredicate = function(e, t) {
                if (!e)
                    return !1;
                return "DeclaredPredicate" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDecorator = function(e, t) {
                if (!e)
                    return !1;
                return "Decorator" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDirective = function(e, t) {
                if (!e)
                    return !1;
                return "Directive" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDirectiveLiteral = function(e, t) {
                if (!e)
                    return !1;
                return "DirectiveLiteral" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDoExpression = function(e, t) {
                if (!e)
                    return !1;
                return "DoExpression" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isDoWhileStatement = function(e, t) {
                if (!e)
                    return !1;
                return "DoWhileStatement" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isEmptyStatement = function(e, t) {
                if (!e)
                    return !1;
                return "EmptyStatement" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isEmptyTypeAnnotation = function(e, t) {
                if (!e)
                    return !1;
                return "EmptyTypeAnnotation" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isEnumBody = function(e, t) {
                if (!e)
                    return !1;
                const n = e.type;
                return ("EnumBooleanBody" === n || "EnumNumberBody" === n || "EnumStringBody" === n || "EnumSymbolBody" === n) && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isEnumBooleanBody = function(e, t) {
                if (!e)
                    return !1;
                return "EnumBooleanBody" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isEnumBooleanMember = function(e, t) {
                if (!e)
                    return !1;
                return "EnumBooleanMember" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isEnumDeclaration = function(e, t) {
                if (!e)
                    return !1;
                return "EnumDeclaration" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isEnumDefaultedMember = function(e, t) {
                if (!e)
                    return !1;
                return "EnumDefaultedMember" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isEnumMember = function(e, t) {
                if (!e)
                    return !1;
                const n = e.type;
                return ("EnumBooleanMember" === n || "EnumNumberMember" === n || "EnumStringMember" === n || "EnumDefaultedMember" === n) && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isEnumNumberBody = function(e, t) {
                if (!e)
                    return !1;
                return "EnumNumberBody" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isEnumNumberMember = function(e, t) {
                if (!e)
                    return !1;
                return "EnumNumberMember" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isEnumStringBody = function(e, t) {
                if (!e)
                    return !1;
                return "EnumStringBody" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isEnumStringMember = function(e, t) {
                if (!e)
                    return !1;
                return "EnumStringMember" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isEnumSymbolBody = function(e, t) {
                if (!e)
                    return !1;
                return "EnumSymbolBody" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isExistsTypeAnnotation = function(e, t) {
                if (!e)
                    return !1;
                return "ExistsTypeAnnotation" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isExportAllDeclaration = function(e, t) {
                if (!e)
                    return !1;
                return "ExportAllDeclaration" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isExportDeclaration = function(e, t) {
                if (!e)
                    return !1;
                const n = e.type;
                return ("ExportAllDeclaration" === n || "ExportDefaultDeclaration" === n || "ExportNamedDeclaration" === n) && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isExportDefaultDeclaration = function(e, t) {
                if (!e)
                    return !1;
                return "ExportDefaultDeclaration" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isExportDefaultSpecifier = function(e, t) {
                if (!e)
                    return !1;
                return "ExportDefaultSpecifier" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isExportNamedDeclaration = function(e, t) {
                if (!e)
                    return !1;
                return "ExportNamedDeclaration" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isExportNamespaceSpecifier = function(e, t) {
                if (!e)
                    return !1;
                return "ExportNamespaceSpecifier" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isExportSpecifier = function(e, t) {
                if (!e)
                    return !1;
                return "ExportSpecifier" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            ...
            t.isExpressionStatement = function(e, t) {
                if (!e)
                    return !1;
                return "ExpressionStatement" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isExpressionWrapper = function(e, t) {
                if (!e)
                    return !1;
                const n = e.type;
                return ("ExpressionStatement" === n || "ParenthesizedExpression" === n || "TypeCastExpression" === n) && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            ...
            t.isFlowBaseAnnotation = function(e, t) {
                if (!e)
                    return !1;
                const n = e.type;
                return ("AnyTypeAnnotation" === n || "BooleanTypeAnnotation" === n || "NullLiteralTypeAnnotation" === n || "MixedTypeAnnotation" === n || "EmptyTypeAnnotation" === n || "NumberTypeAnnotation" === n || "StringTypeAnnotation" === n || "SymbolTypeAnnotation" === n || "ThisTypeAnnotation" === n || "VoidTypeAnnotation" === n) && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isFlowDeclaration = function(e, t) {
                if (!e)
                    return !1;
                const n = e.type;
                return ("DeclareClass" === n || "DeclareFunction" === n || "DeclareInterface" === n || "DeclareModule" === n || "DeclareModuleExports" === n || "DeclareTypeAlias" === n || "DeclareOpaqueType" === n || "DeclareVariable" === n || "DeclareExportDeclaration" === n || "DeclareExportAllDeclaration" === n || "InterfaceDeclaration" === n || "OpaqueType" === n || "TypeAlias" === n) && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isFlowPredicate = function(e, t) {
                if (!e)
                    return !1;
                const n = e.type;
                return ("DeclaredPredicate" === n || "InferredPredicate" === n) && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            ...
            t.isFor = function(e, t) {
                if (!e)
                    return !1;
                const n = e.type;
                return ("ForInStatement" === n || "ForStatement" === n || "ForOfStatement" === n) && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isForInStatement = function(e, t) {
                if (!e)
                    return !1;
                return "ForInStatement" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isForOfStatement = function(e, t) {
                if (!e)
                    return !1;
                return "ForOfStatement" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isForStatement = function(e, t) {
                if (!e)
                    return !1;
                return "ForStatement" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isForXStatement = function(e, t) {
                if (!e)
                    return !1;
                const n = e.type;
                return ("ForInStatement" === n || "ForOfStatement" === n) && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isFunction = function(e, t) {
                if (!e)
                    return !1;
                const n = e.type;
                return ("FunctionDeclaration" === n || "FunctionExpression" === n || "ObjectMethod" === n || "ArrowFunctionExpression" === n || "ClassMethod" === n || "ClassPrivateMethod" === n) && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isFunctionDeclaration = function(e, t) {
                if (!e)
                    return !1;
                return "FunctionDeclaration" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isFunctionExpression = function(e, t) {
                if (!e)
                    return !1;
                return "FunctionExpression" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isFunctionParent = function(e, t) {
                if (!e)
                    return !1;
                const n = e.type;
                return ("FunctionDeclaration" === n || "FunctionExpression" === n || "ObjectMethod" === n || "ArrowFunctionExpression" === n || "ClassMethod" === n || "ClassPrivateMethod" === n || "StaticBlock" === n) && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isFunctionTypeAnnotation = function(e, t) {
                if (!e)
                    return !1;
                return "FunctionTypeAnnotation" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isFunctionTypeParam = function(e, t) {
                if (!e)
                    return !1;
                return "FunctionTypeParam" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isGenericTypeAnnotation = function(e, t) {
                if (!e)
                    return !1;
                return "GenericTypeAnnotation" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isIdentifier = function(e, t) {
                if (!e)
                    return !1;
                return "Identifier" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
            ,
            t.isIfStatement = function(e, t) {
                if (!e)
                    return !1;
                return "IfStatement" === e.type && (void 0 === t || (0,
                    r.default)(e, t))
            }
        ,
        t.isImmutable = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("StringLiteral" === n || "NumericLiteral" === n || "NullLiteral" === n || "BooleanLiteral" === n || "BigIntLiteral" === n || "JSXAttribute" === n || "JSXClosingElement" === n || "JSXElement" === n || "JSXExpressionContainer" === n || "JSXSpreadChild" === n || "JSXOpeningElement" === n || "JSXText" === n || "JSXFragment" === n || "JSXOpeningFragment" === n || "JSXClosingFragment" === n || "DecimalLiteral" === n || "Placeholder" === n && "StringLiteral" === e.expectedNode) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isImport = function(e, t) {
            if (!e)
                return !1;
            return "Import" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isImportAttribute = function(e, t) {
            if (!e)
                return !1;
            return "ImportAttribute" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isImportDeclaration = function(e, t) {
            if (!e)
                return !1;
            return "ImportDeclaration" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isImportDefaultSpecifier = function(e, t) {
            if (!e)
                return !1;
            return "ImportDefaultSpecifier" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isImportNamespaceSpecifier = function(e, t) {
            if (!e)
                return !1;
            return "ImportNamespaceSpecifier" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isImportSpecifier = function(e, t) {
            if (!e)
                return !1;
            return "ImportSpecifier" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isIndexedAccessType = function(e, t) {
            if (!e)
                return !1;
            return "IndexedAccessType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isInferredPredicate = function(e, t) {
            if (!e)
                return !1;
            return "InferredPredicate" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isInterfaceDeclaration = function(e, t) {
            if (!e)
                return !1;
            return "InterfaceDeclaration" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isInterfaceExtends = function(e, t) {
            if (!e)
                return !1;
            return "InterfaceExtends" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isInterfaceTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "InterfaceTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isInterpreterDirective = function(e, t) {
            if (!e)
                return !1;
            return "InterpreterDirective" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isIntersectionTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "IntersectionTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isJSX = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("JSXAttribute" === n || "JSXClosingElement" === n || "JSXElement" === n || "JSXEmptyExpression" === n || "JSXExpressionContainer" === n || "JSXSpreadChild" === n || "JSXIdentifier" === n || "JSXMemberExpression" === n || "JSXNamespacedName" === n || "JSXOpeningElement" === n || "JSXSpreadAttribute" === n || "JSXText" === n || "JSXFragment" === n || "JSXOpeningFragment" === n || "JSXClosingFragment" === n) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isJSXAttribute = function(e, t) {
            if (!e)
                return !1;
            return "JSXAttribute" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isJSXClosingElement = function(e, t) {
            if (!e)
                return !1;
            return "JSXClosingElement" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isJSXClosingFragment = function(e, t) {
            if (!e)
                return !1;
            return "JSXClosingFragment" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isJSXElement = function(e, t) {
            if (!e)
                return !1;
            return "JSXElement" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isJSXEmptyExpression = function(e, t) {
            if (!e)
                return !1;
            return "JSXEmptyExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isJSXExpressionContainer = function(e, t) {
            if (!e)
                return !1;
            return "JSXExpressionContainer" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isJSXFragment = function(e, t) {
            if (!e)
                return !1;
            return "JSXFragment" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isJSXIdentifier = function(e, t) {
            if (!e)
                return !1;
            return "JSXIdentifier" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isJSXMemberExpression = function(e, t) {
            if (!e)
                return !1;
            return "JSXMemberExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isJSXNamespacedName = function(e, t) {
            if (!e)
                return !1;
            return "JSXNamespacedName" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isJSXOpeningElement = function(e, t) {
            if (!e)
                return !1;
            return "JSXOpeningElement" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isJSXOpeningFragment = function(e, t) {
            if (!e)
                return !1;
            return "JSXOpeningFragment" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isJSXSpreadAttribute = function(e, t) {
            if (!e)
                return !1;
            return "JSXSpreadAttribute" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isJSXSpreadChild = function(e, t) {
            if (!e)
                return !1;
            return "JSXSpreadChild" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isJSXText = function(e, t) {
            if (!e)
                return !1;
            return "JSXText" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isLVal = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("Identifier" === n || "MemberExpression" === n || "RestElement" === n || "AssignmentPattern" === n || "ArrayPattern" === n || "ObjectPattern" === n || "TSParameterProperty" === n || "TSAsExpression" === n || "TSTypeAssertion" === n || "TSNonNullExpression" === n || "Placeholder" === n && ("Pattern" === e.expectedNode || "Identifier" === e.expectedNode)) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isLabeledStatement = function(e, t) {
            if (!e)
                return !1;
            return "LabeledStatement" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isLiteral = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("StringLiteral" === n || "NumericLiteral" === n || "NullLiteral" === n || "BooleanLiteral" === n || "RegExpLiteral" === n || "TemplateLiteral" === n || "BigIntLiteral" === n || "DecimalLiteral" === n || "Placeholder" === n && "StringLiteral" === e.expectedNode) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isLogicalExpression = function(e, t) {
            if (!e)
                return !1;
            return "LogicalExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isLoop = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("DoWhileStatement" === n || "ForInStatement" === n || "ForStatement" === n || "WhileStatement" === n || "ForOfStatement" === n) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isMemberExpression = function(e, t) {
            if (!e)
                return !1;
            return "MemberExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isMetaProperty = function(e, t) {
            if (!e)
                return !1;
            return "MetaProperty" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isMethod = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("ObjectMethod" === n || "ClassMethod" === n || "ClassPrivateMethod" === n) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isMiscellaneous = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("Noop" === n || "Placeholder" === n || "V8IntrinsicIdentifier" === n) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isMixedTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "MixedTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isModuleDeclaration = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("ExportAllDeclaration" === n || "ExportDefaultDeclaration" === n || "ExportNamedDeclaration" === n || "ImportDeclaration" === n) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isModuleExpression = function(e, t) {
            if (!e)
                return !1;
            return "ModuleExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isModuleSpecifier = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("ExportSpecifier" === n || "ImportDefaultSpecifier" === n || "ImportNamespaceSpecifier" === n || "ImportSpecifier" === n || "ExportNamespaceSpecifier" === n || "ExportDefaultSpecifier" === n) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isNewExpression = function(e, t) {
            if (!e)
                return !1;
            return "NewExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        ...
        t.isNullLiteral = function(e, t) {
            if (!e)
                return !1;
            return "NullLiteral" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isNullLiteralTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "NullLiteralTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isNullableTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "NullableTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isNumberLiteral = function(e, t) {
            if (!e)
                return !1;
            return "NumberLiteral" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isNumberLiteralTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "NumberLiteralTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isNumberTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "NumberTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isNumericLiteral = function(e, t) {
            if (!e)
                return !1;
            return "NumericLiteral" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isObjectExpression = function(e, t) {
            if (!e)
                return !1;
            return "ObjectExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isObjectMember = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("ObjectMethod" === n || "ObjectProperty" === n) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isObjectMethod = function(e, t) {
            if (!e)
                return !1;
            return "ObjectMethod" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isObjectPattern = function(e, t) {
            if (!e)
                return !1;
            return "ObjectPattern" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isObjectProperty = function(e, t) {
            if (!e)
                return !1;
            return "ObjectProperty" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isObjectTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "ObjectTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isObjectTypeCallProperty = function(e, t) {
            if (!e)
                return !1;
            return "ObjectTypeCallProperty" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isObjectTypeIndexer = function(e, t) {
            if (!e)
                return !1;
            return "ObjectTypeIndexer" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isObjectTypeInternalSlot = function(e, t) {
            if (!e)
                return !1;
            return "ObjectTypeInternalSlot" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isObjectTypeProperty = function(e, t) {
            if (!e)
                return !1;
            return "ObjectTypeProperty" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isObjectTypeSpreadProperty = function(e, t) {
            if (!e)
                return !1;
            return "ObjectTypeSpreadProperty" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isOpaqueType = function(e, t) {
            if (!e)
                return !1;
            return "OpaqueType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isOptionalCallExpression = function(e, t) {
            if (!e)
                return !1;
            return "OptionalCallExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isOptionalIndexedAccessType = function(e, t) {
            if (!e)
                return !1;
            return "OptionalIndexedAccessType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isOptionalMemberExpression = function(e, t) {
            if (!e)
                return !1;
            return "OptionalMemberExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isParenthesizedExpression = function(e, t) {
            if (!e)
                return !1;
            return "ParenthesizedExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isPattern = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("AssignmentPattern" === n || "ArrayPattern" === n || "ObjectPattern" === n || "Placeholder" === n && "Pattern" === e.expectedNode) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isPatternLike = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("Identifier" === n || "RestElement" === n || "AssignmentPattern" === n || "ArrayPattern" === n || "ObjectPattern" === n || "TSAsExpression" === n || "TSTypeAssertion" === n || "TSNonNullExpression" === n || "Placeholder" === n && ("Pattern" === e.expectedNode || "Identifier" === e.expectedNode)) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isPipelineBareFunction = function(e, t) {
            if (!e)
                return !1;
            return "PipelineBareFunction" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isPipelinePrimaryTopicReference = function(e, t) {
            if (!e)
                return !1;
            return "PipelinePrimaryTopicReference" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isPipelineTopicExpression = function(e, t) {
            if (!e)
                return !1;
            return "PipelineTopicExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isPlaceholder = function(e, t) {
            if (!e)
                return !1;
            return "Placeholder" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isPrivate = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("ClassPrivateProperty" === n || "ClassPrivateMethod" === n || "PrivateName" === n) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isPrivateName = function(e, t) {
            if (!e)
                return !1;
            return "PrivateName" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isProgram = function(e, t) {
            if (!e)
                return !1;
            return "Program" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isProperty = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("ObjectProperty" === n || "ClassProperty" === n || "ClassAccessorProperty" === n || "ClassPrivateProperty" === n) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isPureish = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("FunctionDeclaration" === n || "FunctionExpression" === n || "StringLiteral" === n || "NumericLiteral" === n || "NullLiteral" === n || "BooleanLiteral" === n || "RegExpLiteral" === n || "ArrowFunctionExpression" === n || "BigIntLiteral" === n || "DecimalLiteral" === n || "Placeholder" === n && "StringLiteral" === e.expectedNode) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isQualifiedTypeIdentifier = function(e, t) {
            if (!e)
                return !1;
            return "QualifiedTypeIdentifier" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isRecordExpression = function(e, t) {
            if (!e)
                return !1;
            return "RecordExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isRegExpLiteral = function(e, t) {
            if (!e)
                return !1;
            return "RegExpLiteral" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isRegexLiteral = function(e, t) {
            if (!e)
                return !1;
            return "RegexLiteral" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isRestElement = function(e, t) {
            if (!e)
                return !1;
            return "RestElement" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isRestProperty = function(e, t) {
            if (!e)
                return !1;
            return "RestProperty" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isReturnStatement = function(e, t) {
            if (!e)
                return !1;
            return "ReturnStatement" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        ...
        t.isSequenceExpression = function(e, t) {
            if (!e)
                return !1;
            return "SequenceExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isSpreadElement = function(e, t) {
            if (!e)
                return !1;
            return "SpreadElement" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isSpreadProperty = function(e, t) {
            if (!e)
                return !1;
            return "SpreadProperty" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        ...
        t.isStaticBlock = function(e, t) {
            if (!e)
                return !1;
            return "StaticBlock" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isStringLiteral = function(e, t) {
            if (!e)
                return !1;
            return "StringLiteral" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isStringLiteralTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "StringLiteralTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isStringTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "StringTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isSuper = function(e, t) {
            if (!e)
                return !1;
            return "Super" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isSwitchCase = function(e, t) {
            if (!e)
                return !1;
            return "SwitchCase" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isSwitchStatement = function(e, t) {
            if (!e)
                return !1;
            return "SwitchStatement" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isSymbolTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "SymbolTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSAnyKeyword = function(e, t) {
            if (!e)
                return !1;
            return "TSAnyKeyword" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSArrayType = function(e, t) {
            if (!e)
                return !1;
            return "TSArrayType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSAsExpression = function(e, t) {
            if (!e)
                return !1;
            return "TSAsExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSBaseType = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("TSAnyKeyword" === n || "TSBooleanKeyword" === n || "TSBigIntKeyword" === n || "TSIntrinsicKeyword" === n || "TSNeverKeyword" === n || "TSNullKeyword" === n || "TSNumberKeyword" === n || "TSObjectKeyword" === n || "TSStringKeyword" === n || "TSSymbolKeyword" === n || "TSUndefinedKeyword" === n || "TSUnknownKeyword" === n || "TSVoidKeyword" === n || "TSThisType" === n || "TSLiteralType" === n) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSBigIntKeyword = function(e, t) {
            if (!e)
                return !1;
            return "TSBigIntKeyword" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSBooleanKeyword = function(e, t) {
            if (!e)
                return !1;
            return "TSBooleanKeyword" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSCallSignatureDeclaration = function(e, t) {
            if (!e)
                return !1;
            return "TSCallSignatureDeclaration" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSConditionalType = function(e, t) {
            if (!e)
                return !1;
            return "TSConditionalType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSConstructSignatureDeclaration = function(e, t) {
            if (!e)
                return !1;
            return "TSConstructSignatureDeclaration" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSConstructorType = function(e, t) {
            if (!e)
                return !1;
            return "TSConstructorType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSDeclareFunction = function(e, t) {
            if (!e)
                return !1;
            return "TSDeclareFunction" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSDeclareMethod = function(e, t) {
            if (!e)
                return !1;
            return "TSDeclareMethod" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSEntityName = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("Identifier" === n || "TSQualifiedName" === n || "Placeholder" === n && "Identifier" === e.expectedNode) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSEnumDeclaration = function(e, t) {
            if (!e)
                return !1;
            return "TSEnumDeclaration" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSEnumMember = function(e, t) {
            if (!e)
                return !1;
            return "TSEnumMember" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSExportAssignment = function(e, t) {
            if (!e)
                return !1;
            return "TSExportAssignment" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSExpressionWithTypeArguments = function(e, t) {
            if (!e)
                return !1;
            return "TSExpressionWithTypeArguments" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSExternalModuleReference = function(e, t) {
            if (!e)
                return !1;
            return "TSExternalModuleReference" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSFunctionType = function(e, t) {
            if (!e)
                return !1;
            return "TSFunctionType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSImportEqualsDeclaration = function(e, t) {
            if (!e)
                return !1;
            return "TSImportEqualsDeclaration" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSImportType = function(e, t) {
            if (!e)
                return !1;
            return "TSImportType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSIndexSignature = function(e, t) {
            if (!e)
                return !1;
            return "TSIndexSignature" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSIndexedAccessType = function(e, t) {
            if (!e)
                return !1;
            return "TSIndexedAccessType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSInferType = function(e, t) {
            if (!e)
                return !1;
            return "TSInferType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSInstantiationExpression = function(e, t) {
            if (!e)
                return !1;
            return "TSInstantiationExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSInterfaceBody = function(e, t) {
            if (!e)
                return !1;
            return "TSInterfaceBody" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSInterfaceDeclaration = function(e, t) {
            if (!e)
                return !1;
            return "TSInterfaceDeclaration" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSIntersectionType = function(e, t) {
            if (!e)
                return !1;
            return "TSIntersectionType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSIntrinsicKeyword = function(e, t) {
            if (!e)
                return !1;
            return "TSIntrinsicKeyword" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSLiteralType = function(e, t) {
            if (!e)
                return !1;
            return "TSLiteralType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSMappedType = function(e, t) {
            if (!e)
                return !1;
            return "TSMappedType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSMethodSignature = function(e, t) {
            if (!e)
                return !1;
            return "TSMethodSignature" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSModuleBlock = function(e, t) {
            if (!e)
                return !1;
            return "TSModuleBlock" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSModuleDeclaration = function(e, t) {
            if (!e)
                return !1;
            return "TSModuleDeclaration" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSNamedTupleMember = function(e, t) {
            if (!e)
                return !1;
            return "TSNamedTupleMember" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSNamespaceExportDeclaration = function(e, t) {
            if (!e)
                return !1;
            return "TSNamespaceExportDeclaration" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSNeverKeyword = function(e, t) {
            if (!e)
                return !1;
            return "TSNeverKeyword" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSNonNullExpression = function(e, t) {
            if (!e)
                return !1;
            return "TSNonNullExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSNullKeyword = function(e, t) {
            if (!e)
                return !1;
            return "TSNullKeyword" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSNumberKeyword = function(e, t) {
            if (!e)
                return !1;
            return "TSNumberKeyword" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSObjectKeyword = function(e, t) {
            if (!e)
                return !1;
            return "TSObjectKeyword" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSOptionalType = function(e, t) {
            if (!e)
                return !1;
            return "TSOptionalType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSParameterProperty = function(e, t) {
            if (!e)
                return !1;
            return "TSParameterProperty" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSParenthesizedType = function(e, t) {
            if (!e)
                return !1;
            return "TSParenthesizedType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSPropertySignature = function(e, t) {
            if (!e)
                return !1;
            return "TSPropertySignature" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSQualifiedName = function(e, t) {
            if (!e)
                return !1;
            return "TSQualifiedName" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSRestType = function(e, t) {
            if (!e)
                return !1;
            return "TSRestType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSStringKeyword = function(e, t) {
            if (!e)
                return !1;
            return "TSStringKeyword" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSSymbolKeyword = function(e, t) {
            if (!e)
                return !1;
            return "TSSymbolKeyword" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSThisType = function(e, t) {
            if (!e)
                return !1;
            return "TSThisType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSTupleType = function(e, t) {
            if (!e)
                return !1;
            return "TSTupleType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        ...
        t.isTSTypeAliasDeclaration = function(e, t) {
            if (!e)
                return !1;
            return "TSTypeAliasDeclaration" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "TSTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSTypeAssertion = function(e, t) {
            if (!e)
                return !1;
            return "TSTypeAssertion" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSTypeElement = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("TSCallSignatureDeclaration" === n || "TSConstructSignatureDeclaration" === n || "TSPropertySignature" === n || "TSMethodSignature" === n || "TSIndexSignature" === n) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSTypeLiteral = function(e, t) {
            if (!e)
                return !1;
            return "TSTypeLiteral" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSTypeOperator = function(e, t) {
            if (!e)
                return !1;
            return "TSTypeOperator" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSTypeParameter = function(e, t) {
            if (!e)
                return !1;
            return "TSTypeParameter" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSTypeParameterDeclaration = function(e, t) {
            if (!e)
                return !1;
            return "TSTypeParameterDeclaration" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSTypeParameterInstantiation = function(e, t) {
            if (!e)
                return !1;
            return "TSTypeParameterInstantiation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSTypePredicate = function(e, t) {
            if (!e)
                return !1;
            return "TSTypePredicate" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSTypeQuery = function(e, t) {
            if (!e)
                return !1;
            return "TSTypeQuery" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSTypeReference = function(e, t) {
            if (!e)
                return !1;
            return "TSTypeReference" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSUndefinedKeyword = function(e, t) {
            if (!e)
                return !1;
            return "TSUndefinedKeyword" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSUnionType = function(e, t) {
            if (!e)
                return !1;
            return "TSUnionType" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSUnknownKeyword = function(e, t) {
            if (!e)
                return !1;
            return "TSUnknownKeyword" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTSVoidKeyword = function(e, t) {
            if (!e)
                return !1;
            return "TSVoidKeyword" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTaggedTemplateExpression = function(e, t) {
            if (!e)
                return !1;
            return "TaggedTemplateExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTemplateElement = function(e, t) {
            if (!e)
                return !1;
            return "TemplateElement" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTemplateLiteral = function(e, t) {
            if (!e)
                return !1;
            return "TemplateLiteral" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTerminatorless = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("BreakStatement" === n || "ContinueStatement" === n || "ReturnStatement" === n || "ThrowStatement" === n || "YieldExpression" === n || "AwaitExpression" === n) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isThisExpression = function(e, t) {
            if (!e)
                return !1;
            return "ThisExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isThisTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "ThisTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isThrowStatement = function(e, t) {
            if (!e)
                return !1;
            return "ThrowStatement" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTopicReference = function(e, t) {
            if (!e)
                return !1;
            return "TopicReference" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTryStatement = function(e, t) {
            if (!e)
                return !1;
            return "TryStatement" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTupleExpression = function(e, t) {
            if (!e)
                return !1;
            return "TupleExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTupleTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "TupleTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTypeAlias = function(e, t) {
            if (!e)
                return !1;
            return "TypeAlias" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "TypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTypeCastExpression = function(e, t) {
            if (!e)
                return !1;
            return "TypeCastExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTypeParameter = function(e, t) {
            if (!e)
                return !1;
            return "TypeParameter" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTypeParameterDeclaration = function(e, t) {
            if (!e)
                return !1;
            return "TypeParameterDeclaration" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isTypeParameterInstantiation = function(e, t) {
            if (!e)
                return !1;
            return "TypeParameterInstantiation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        ...
        t.isTypeofTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "TypeofTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isUnaryExpression = function(e, t) {
            if (!e)
                return !1;
            return "UnaryExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isUnaryLike = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("UnaryExpression" === n || "SpreadElement" === n) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isUnionTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "UnionTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isUpdateExpression = function(e, t) {
            if (!e)
                return !1;
            return "UpdateExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isUserWhitespacable = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("ObjectMethod" === n || "ObjectProperty" === n || "ObjectTypeInternalSlot" === n || "ObjectTypeCallProperty" === n || "ObjectTypeIndexer" === n || "ObjectTypeProperty" === n || "ObjectTypeSpreadProperty" === n) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isV8IntrinsicIdentifier = function(e, t) {
            if (!e)
                return !1;
            return "V8IntrinsicIdentifier" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isVariableDeclaration = function(e, t) {
            if (!e)
                return !1;
            return "VariableDeclaration" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isVariableDeclarator = function(e, t) {
            if (!e)
                return !1;
            return "VariableDeclarator" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isVariance = function(e, t) {
            if (!e)
                return !1;
            return "Variance" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isVoidTypeAnnotation = function(e, t) {
            if (!e)
                return !1;
            return "VoidTypeAnnotation" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isWhile = function(e, t) {
            if (!e)
                return !1;
            const n = e.type;
            return ("DoWhileStatement" === n || "WhileStatement" === n) && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isWhileStatement = function(e, t) {
            if (!e)
                return !1;
            return "WhileStatement" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isWithStatement = function(e, t) {
            if (!e)
                return !1;
            return "WithStatement" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ,
        t.isYieldExpression = function(e, t) {
            if (!e)
                return !1;
            return "YieldExpression" === e.type && (void 0 === t || (0,
                r.default)(e, t))
        }
        ;
        var r = n("392e")
    ...
    c8da: function(e, t, n) {
        ...
        t.default = function(e) {
            ...
            var t = e.use(a.default)
                ...
                , r = t.Type.or
                , s = e.use(o.default).defaults;
            n("CatchClause").field("param", r(n("Pattern"), null), s.null)
        }
            ,
            e.exports = t.default
    },
    ...
    d062: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.ObjectProperty = function(e) {
                if (this.printJoin(e.decorators, e),
                    e.computed)
                    this.token("["),
                        this.print(e.key, e),
                        this.token("]");
                else {
                    if (a(e.value) && o(e.key) && e.key.name === e.value.left.name)
                        return void this.print(e.value, e);
                    if (this.print(e.key, e),
                    e.shorthand && o(e.key) && o(e.value) && e.key.name === e.value.name)
                        return
                }
                this.token(":"),
                    this.space(),
            ...
            t.BigIntLiteral = function(e) {
                const t = this.getPossibleRaw(e);
                this.format.minified || null == t ? this.word(e.value + "n") : this.word(t)
            }
            ,
            t.DecimalLiteral = function(e) {
                const t = this.getPossibleRaw(e);
                this.format.minified || null == t ? this.word(e.value + "m") : this.word(t)
            }
            ,
        ...
        var r = n("252a")
            , i = n("b59d");
        const {isAssignmentPattern: a, isIdentifier: o} = r
    },
    d192: function(e, t, n) {
        "use strict";
        let r = null;
        function i(e) {
            if (null !== r && (r.property,
                1)) {
                const e = r;
                return r = i.prototype = null,
                    e
            }
            return r = i.prototype = null == e ? Object.create(null) : e,
                new i
        }
        i(),
    ...
    d5ad: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.UnaryExpression = function(e) {
                "void" === e.operator || "delete" === e.operator || "typeof" === e.operator || "throw" === e.operator ? (this.word(e.operator),
                    this.space()) : this.token(e.operator),
                    this.print(e.argument, e)
            }
            ,
            ...
            t.UpdateExpression = function(e) {
                e.prefix ? (this.token(e.operator),
                    this.print(e.argument, e)) : (this.startTerminatorless(!0),
                    this.print(e.argument, e),
            ...
            t.NewExpression = function(e, t) {
                this.word("new"),
                    this.space(),
                    this.print(e.callee, e),
                (!this.format.minified || 0 !== e.arguments.length || e.optional || a(t, {
                    callee: e
                }) || s(t) || l(t)) && (this.print(e.typeArguments, e),
                    this.print(e.typeParameters, e),
                e.optional && this.token("?."),
                    this.token("("),
            ...
            t.OptionalMemberExpression = function(e) {
                if (this.print(e.object, e),
                !e.computed && s(e.property))
                    throw new TypeError("Got a MemberExpression for MemberExpression property");
                let t = e.computed;
                o(e.property) && "number" == typeof e.property.value && (t = !0),
                e.optional && this.token("?."),
                    t ? (this.token("["),
                        this.print(e.property, e),
                        this.token("]")) : (e.optional || this.token("."),
                        this.print(e.property, e))
            }
            ,
            ...
            t.ModuleExpression = function(e) {
                this.word("module"),
                    this.space(),
                    this.token("{"),
                    0 === e.body.body.length ? this.token("}") : (this.newline(),
        ...
        var r = n("252a")
            , i = n("43fd");
        const {isCallExpression: a, isLiteral: o, isMemberExpression: s, isNewExpression: l} = r;
        function u(e) {
            return function(t) {
                if (this.word(e),
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.JSXOpeningElement = function(e) {
                this.token("<"),
                    this.print(e.name, e),
                    this.print(e.typeParameters, e),
                e.attributes.length > 0 && (this.space(),
                    this.printJoin(e.attributes, e, {
                        separator: r
                    })),
                    e.selfClosing ? (this.space(),
                        this.token("/>")) : this.token(">")
            }
            ,
    ...
    d83d: function(e, t, n) {
        ...
        t.default = function(e) {
            ...
            var t = e.use(a.default)
                ...
                , r = t.Type.or
                , s = e.use(o.default).defaults;
            n("JSXAttribute").bases("Node").build("name", "value").field("name", r(n("JSXIdentifier"), n("JSXNamespacedName"))).field("value", r(n("Literal"), n("JSXExpressionContainer"), n("JSXElement"), n("JSXFragment"), null), s.null),
                n("JSXIdentifier").bases("Identifier").build("name").field("name", String),
                n("JSXNamespacedName").bases("Node").build("namespace", "name").field("namespace", n("JSXIdentifier")).field("name", n("JSXIdentifier")),
                n("JSXMemberExpression").bases("MemberExpression").build("object", "property").field("object", r(n("JSXIdentifier"), n("JSXMemberExpression"))).field("property", n("JSXIdentifier")).field("computed", Boolean, s.false);
            var l = r(n("JSXIdentifier"), n("JSXNamespacedName"), n("JSXMemberExpression"));
            n("JSXSpreadAttribute").bases("Node").build("argument").field("argument", n("Expression"));
            var u = [r(n("JSXAttribute"), n("JSXSpreadAttribute"))];
            n("JSXExpressionContainer").bases("Expression").build("expression").field("expression", r(n("Expression"), n("JSXEmptyExpression")));
            var p = [r(n("JSXText"), n("JSXExpressionContainer"), n("JSXSpreadChild"), n("JSXElement"), n("JSXFragment"), n("Literal"))];
            n("JSXElement").bases("Expression").build("openingElement", "closingElement", "children").field("openingElement", n("JSXOpeningElement")).field("closingElement", r(n("JSXClosingElement"), null), s.null).field("children", p, s.emptyArray).field("name", l, (function() {
                    return this.openingElement.name
                }
            ), !0).field("selfClosing", Boolean, (function() {
                    return this.openingElement.selfClosing
                }
            ), !0).field("attributes", u, (function() {
                    return this.openingElement.attributes
                }
            ), !0),
                n("JSXOpeningElement").bases("Node").build("name", "attributes", "selfClosing").field("name", l).field("attributes", u, s.emptyArray).field("selfClosing", Boolean, s.false),
                n("JSXClosingElement").bases("Node").build("name").field("name", l),
                n("JSXFragment").bases("Expression").build("openingFragment", "closingFragment", "children").field("openingFragment", n("JSXOpeningFragment")).field("closingFragment", n("JSXClosingFragment")).field("children", p, s.emptyArray),
                n("JSXOpeningFragment").bases("Node").build(),
                n("JSXClosingFragment").bases("Node").build(),
                n("JSXText").bases("Literal").build("value", "raw").field("value", String).field("raw", String, (function() {
                        return this.value
                    }
                )),
                n("JSXEmptyExpression").bases("Node").build(),
                n("JSXSpreadChild").bases("Node").build("expression").field("expression", n("Expression"))
        }
            ,
            e.exports = t.default
    },
    d87b: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.visit = t.use = t.Type = t.someField = t.PathVisitor = t.Path = t.NodePath = t.namedTypes = t.getSupertypeNames = t.getFieldValue = t.getFieldNames = t.getBuilderName = t.finalize = t.eachField = t.defineMethod = t.builtInTypes = t.builders = t.astNodesAreEquivalent = void 0;
        var r = n("4f38")
            , i = r.__importDefault(n("fcea"))
            , a = r.__importDefault(n("ab23"))
            , o = r.__importDefault(n("d965"))
            , s = r.__importDefault(n("9e61"))
            , l = r.__importDefault(n("4b53"))
            , u = r.__importDefault(n("2908"))
            , p = r.__importDefault(n("c8da"))
            , c = r.__importDefault(n("1e1f"))
            , d = r.__importDefault(n("d83d"))
            , f = r.__importDefault(n("e04a"))
            , y = r.__importDefault(n("19fa3"))
            , m = r.__importDefault(n("5673"))
            , h = r.__importDefault(n("85ab"))
            , T = r.__importDefault(n("3fe2"))
            , b = n("b03d");
        Object.defineProperty(t, "namedTypes", {
            enumerable: !0,
            get: function() {
                return b.namedTypes
            }
        });
        var S = i.default([a.default, o.default, s.default, l.default, u.default, p.default, c.default, d.default, f.default, y.default, m.default, h.default, T.default])
            , E = S.astNodesAreEquivalent
            , v = S.builders
            , g = S.builtInTypes
            , P = S.defineMethod
            , x = S.eachField
    ...
    d965: function(e, t, n) {
        ...
        t.default = function(e) {
            ...
            var t = e.use(a.default)
                ...
                , r = t.Type.or
                , s = e.use(o.default).defaults;
            n("Function").field("generator", Boolean, s.false).field("expression", Boolean, s.false).field("defaults", [r(n("Expression"), null)], s.emptyArray).field("rest", r(n("Identifier"), null), s.null),
                n("RestElement").bases("Pattern").build("argument").field("argument", n("Pattern")).field("typeAnnotation", r(n("TypeAnnotation"), n("TSTypeAnnotation"), null), s.null),
                n("SpreadElementPattern").bases("Pattern").build("argument").field("argument", n("Pattern")),
                n("FunctionDeclaration").build("id", "params", "body", "generator", "expression").field("id", r(n("Identifier"), null)),
                n("FunctionExpression").build("id", "params", "body", "generator", "expression"),
                n("ArrowFunctionExpression").bases("Function", "Expression").build("params", "body", "expression").field("id", null, s.null).field("body", r(n("BlockStatement"), n("Expression"))).field("generator", !1, s.false),
                n("ForOfStatement").bases("Statement").build("left", "right", "body").field("left", r(n("VariableDeclaration"), n("Pattern"))).field("right", n("Expression")).field("body", n("Statement")),
                n("YieldExpression").bases("Expression").build("argument", "delegate").field("argument", r(n("Expression"), null)).field("delegate", Boolean, s.false),
                n("GeneratorExpression").bases("Expression").build("body", "blocks", "filter").field("body", n("Expression")).field("blocks", [n("ComprehensionBlock")]).field("filter", r(n("Expression"), null)),
                n("ComprehensionExpression").bases("Expression").build("body", "blocks", "filter").field("body", n("Expression")).field("blocks", [n("ComprehensionBlock")]).field("filter", r(n("Expression"), null)),
                n("ComprehensionBlock").bases("Node").build("left", "right", "each").field("left", n("Pattern")).field("right", n("Expression")).field("each", Boolean),
                n("Property").field("key", r(n("Literal"), n("Identifier"), n("Expression"))).field("value", r(n("Expression"), n("Pattern"))).field("method", Boolean, s.false).field("shorthand", Boolean, s.false).field("computed", Boolean, s.false),
                n("ObjectProperty").field("shorthand", Boolean, s.false),
                n("PropertyPattern").bases("Pattern").build("key", "pattern").field("key", r(n("Literal"), n("Identifier"), n("Expression"))).field("pattern", n("Pattern")).field("computed", Boolean, s.false),
                n("ObjectPattern").bases("Pattern").build("properties").field("properties", [r(n("PropertyPattern"), n("Property"))]),
                n("ArrayPattern").bases("Pattern").build("elements").field("elements", [r(n("Pattern"), null)]),
                n("SpreadElement").bases("Node").build("argument").field("argument", n("Expression")),
                n("ArrayExpression").field("elements", [r(n("Expression"), n("SpreadElement"), n("RestElement"), null)]),
                n("NewExpression").field("arguments", [r(n("Expression"), n("SpreadElement"))]),
                n("CallExpression").field("arguments", [r(n("Expression"), n("SpreadElement"))]),
                n("AssignmentPattern").bases("Pattern").build("left", "right").field("left", n("Pattern")).field("right", n("Expression")),
                n("MethodDefinition").bases("Declaration").build("kind", "key", "value", "static").field("kind", r("constructor", "method", "get", "set")).field("key", n("Expression")).field("value", n("Function")).field("computed", Boolean, s.false).field("static", Boolean, s.false);
            var l = r(n("MethodDefinition"), n("VariableDeclarator"), n("ClassPropertyDefinition"), n("ClassProperty"));
            n("ClassProperty").bases("Declaration").build("key").field("key", r(n("Literal"), n("Identifier"), n("Expression"))).field("computed", Boolean, s.false),
                n("ClassPropertyDefinition").bases("Declaration").build("definition").field("definition", l),
                n("ClassBody").bases("Declaration").build("body").field("body", [l]),
                n("ClassDeclaration").bases("Declaration").build("id", "body", "superClass").field("id", r(n("Identifier"), null)).field("body", n("ClassBody")).field("superClass", r(n("Expression"), null), s.null),
                n("ClassExpression").bases("Expression").build("id", "body", "superClass").field("id", r(n("Identifier"), null), s.null).field("body", n("ClassBody")).field("superClass", r(n("Expression"), null), s.null),
                n("Super").bases("Expression").build(),
                n("Specifier").bases("Node"),
                n("ModuleSpecifier").bases("Specifier").field("local", r(n("Identifier"), null), s.null).field("id", r(n("Identifier"), null), s.null).field("name", r(n("Identifier"), null), s.null),
                ...
                n("ImportDeclaration").bases("Declaration").build("specifiers", "source", "importKind").field("specifiers", [r(n("ImportSpecifier"), n("ImportNamespaceSpecifier"), n("ImportDefaultSpecifier"))], s.emptyArray).field("source", n("Literal")).field("importKind", r("value", "type"), (function() {
                        return "value"
                    }
                )),
                n("ExportNamedDeclaration").bases("Declaration").build("declaration", "specifiers", "source").field("declaration", r(n("Declaration"), null)).field("specifiers", [n("ExportSpecifier")], s.emptyArray).field("source", r(n("Literal"), null), s.null),
                n("ExportSpecifier").bases("ModuleSpecifier").build("local", "exported").field("exported", n("Identifier")),
                n("ExportDefaultDeclaration").bases("Declaration").build("declaration").field("declaration", r(n("Declaration"), n("Expression"))),
                n("ExportAllDeclaration").bases("Declaration").build("source").field("source", n("Literal")),
                n("TaggedTemplateExpression").bases("Expression").build("tag", "quasi").field("tag", n("Expression")).field("quasi", n("TemplateLiteral")),
                n("TemplateLiteral").bases("Expression").build("quasis", "expressions").field("quasis", [n("TemplateElement")]).field("expressions", [n("Expression")]),
                n("TemplateElement").bases("Node").build("value", "tail").field("value", {
                    cooked: String,
                    raw: String
                }).field("tail", Boolean),
    ...
    da7f: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.default = void 0;
        var r = (0,
            n("57fa").default)("React.Component");
        t.default = r
    },
    dc04: function(e, t, n) {
        ...
        s.fromStringWithSourceMap = function(e, t, n) {
            ...
            return t.eachMapping((function(e) {
                    if (null !== d) {
                        if (!(p < e.generatedLine)) {
                            var t = o[l]
                                , n = t.substr(0, e.generatedColumn - c);
                            return o[l] = t.substr(e.generatedColumn - c),
                                c = e.generatedColumn,
                                f(d, n),
                                void (d = e)
                        }
            ...
            function f(e, t) {
                if (null === e || void 0 === e.source)
                    ...
                    r.add(new s(e.originalLine,e.originalColumn,a,t,e.name))
                }
            }
        }
            ,
            ...
            s.prototype.toStringWithSourceMap = function(e) {
                ...
                return this.walk((function(e, r) {
                        t.code += e,
                            null !== r.source && null !== r.line && null !== r.column ? (a === r.source && o === r.line && s === r.column && l === r.name || n.addMapping({
                                source: r.source,
                                original: {
                                    line: r.line,
                                    column: r.column
    ...
    dc74: function(e, t, n) {
        t.SourceMapGenerator = n("5024").SourceMapGenerator,
            t.SourceMapConsumer = n("a89b").SourceMapConsumer,
            t.SourceNode = n("dc04").SourceNode
    },
    dd87: function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
    ...
    e04a: function(e, t, n) {
        ...
        t.default = function(e) {
            ...
            var t = e.use(o.default)
                , n = t.Type.def
                , r = t.Type.or
                , l = e.use(s.default).defaults;
            n("Flow").bases("Node"),
                n("FlowType").bases("Flow"),
                n("AnyTypeAnnotation").bases("FlowType").build(),
                n("EmptyTypeAnnotation").bases("FlowType").build(),
                n("MixedTypeAnnotation").bases("FlowType").build(),
                n("VoidTypeAnnotation").bases("FlowType").build(),
                n("SymbolTypeAnnotation").bases("FlowType").build(),
                n("NumberTypeAnnotation").bases("FlowType").build(),
                n("BigIntTypeAnnotation").bases("FlowType").build(),
                n("NumberLiteralTypeAnnotation").bases("FlowType").build("value", "raw").field("value", Number).field("raw", String),
                n("NumericLiteralTypeAnnotation").bases("FlowType").build("value", "raw").field("value", Number).field("raw", String),
                n("BigIntLiteralTypeAnnotation").bases("FlowType").build("value", "raw").field("value", null).field("raw", String),
                n("StringTypeAnnotation").bases("FlowType").build(),
                n("StringLiteralTypeAnnotation").bases("FlowType").build("value", "raw").field("value", String).field("raw", String),
                n("BooleanTypeAnnotation").bases("FlowType").build(),
                n("BooleanLiteralTypeAnnotation").bases("FlowType").build("value", "raw").field("value", Boolean).field("raw", String),
                n("TypeAnnotation").bases("Node").build("typeAnnotation").field("typeAnnotation", n("FlowType")),
                n("NullableTypeAnnotation").bases("FlowType").build("typeAnnotation").field("typeAnnotation", n("FlowType")),
                n("NullLiteralTypeAnnotation").bases("FlowType").build(),
                n("NullTypeAnnotation").bases("FlowType").build(),
                n("ThisTypeAnnotation").bases("FlowType").build(),
                n("ExistsTypeAnnotation").bases("FlowType").build(),
                n("ExistentialTypeParam").bases("FlowType").build(),
                n("FunctionTypeAnnotation").bases("FlowType").build("params", "returnType", "rest", "typeParameters").field("params", [n("FunctionTypeParam")]).field("returnType", n("FlowType")).field("rest", r(n("FunctionTypeParam"), null)).field("typeParameters", r(n("TypeParameterDeclaration"), null)),
                n("FunctionTypeParam").bases("Node").build("name", "typeAnnotation", "optional").field("name", r(n("Identifier"), null)).field("typeAnnotation", n("FlowType")).field("optional", Boolean),
                n("ArrayTypeAnnotation").bases("FlowType").build("elementType").field("elementType", n("FlowType")),
                n("ObjectTypeAnnotation").bases("FlowType").build("properties", "indexers", "callProperties").field("properties", [r(n("ObjectTypeProperty"), n("ObjectTypeSpreadProperty"))]).field("indexers", [n("ObjectTypeIndexer")], l.emptyArray).field("callProperties", [n("ObjectTypeCallProperty")], l.emptyArray).field("inexact", r(Boolean, void 0), l[void 0]).field("exact", Boolean, l.false).field("internalSlots", [n("ObjectTypeInternalSlot")], l.emptyArray),
                n("Variance").bases("Node").build("kind").field("kind", r("plus", "minus"));
            var u = r(n("Variance"), "plus", "minus", null);
            n("ObjectTypeProperty").bases("Node").build("key", "value", "optional").field("key", r(n("Literal"), n("Identifier"))).field("value", n("FlowType")).field("optional", Boolean).field("variance", u, l.null),
                n("ObjectTypeIndexer").bases("Node").build("id", "key", "value").field("id", n("Identifier")).field("key", n("FlowType")).field("value", n("FlowType")).field("variance", u, l.null).field("static", Boolean, l.false),
                n("ObjectTypeCallProperty").bases("Node").build("value").field("value", n("FunctionTypeAnnotation")).field("static", Boolean, l.false),
                n("QualifiedTypeIdentifier").bases("Node").build("qualification", "id").field("qualification", r(n("Identifier"), n("QualifiedTypeIdentifier"))).field("id", n("Identifier")),
                n("GenericTypeAnnotation").bases("FlowType").build("id", "typeParameters").field("id", r(n("Identifier"), n("QualifiedTypeIdentifier"))).field("typeParameters", r(n("TypeParameterInstantiation"), null)),
                n("MemberTypeAnnotation").bases("FlowType").build("object", "property").field("object", n("Identifier")).field("property", r(n("MemberTypeAnnotation"), n("GenericTypeAnnotation"))),
                n("UnionTypeAnnotation").bases("FlowType").build("types").field("types", [n("FlowType")]),
                n("IntersectionTypeAnnotation").bases("FlowType").build("types").field("types", [n("FlowType")]),
                n("TypeofTypeAnnotation").bases("FlowType").build("argument").field("argument", n("FlowType")),
                n("ObjectTypeSpreadProperty").bases("Node").build("argument").field("argument", n("FlowType")),
                n("ObjectTypeInternalSlot").bases("Node").build("id", "value", "optional", "static", "method").field("id", n("Identifier")).field("value", n("FlowType")).field("optional", Boolean).field("static", Boolean).field("method", Boolean),
                n("TypeParameterDeclaration").bases("Node").build("params").field("params", [n("TypeParameter")]),
                n("TypeParameterInstantiation").bases("Node").build("params").field("params", [n("FlowType")]),
                n("TypeParameter").bases("FlowType").build("name", "variance", "bound", "default").field("name", String).field("variance", u, l.null).field("bound", r(n("TypeAnnotation"), null), l.null).field("default", r(n("FlowType"), null), l.null),
                n("ClassProperty").field("variance", u, l.null),
                n("ClassImplements").bases("Node").build("id").field("id", n("Identifier")).field("superClass", r(n("Expression"), null), l.null).field("typeParameters", r(n("TypeParameterInstantiation"), null), l.null),
                n("InterfaceTypeAnnotation").bases("FlowType").build("body", "extends").field("body", n("ObjectTypeAnnotation")).field("extends", r([n("InterfaceExtends")], null), l.null),
                n("InterfaceDeclaration").bases("Declaration").build("id", "body", "extends").field("id", n("Identifier")).field("typeParameters", r(n("TypeParameterDeclaration"), null), l.null).field("body", n("ObjectTypeAnnotation")).field("extends", [n("InterfaceExtends")]),
                n("DeclareInterface").bases("InterfaceDeclaration").build("id", "body", "extends"),
                n("InterfaceExtends").bases("Node").build("id").field("id", n("Identifier")).field("typeParameters", r(n("TypeParameterInstantiation"), null), l.null),
                n("TypeAlias").bases("Declaration").build("id", "typeParameters", "right").field("id", n("Identifier")).field("typeParameters", r(n("TypeParameterDeclaration"), null)).field("right", n("FlowType")),
                n("DeclareTypeAlias").bases("TypeAlias").build("id", "typeParameters", "right"),
                n("OpaqueType").bases("Declaration").build("id", "typeParameters", "impltype", "supertype").field("id", n("Identifier")).field("typeParameters", r(n("TypeParameterDeclaration"), null)).field("impltype", n("FlowType")).field("supertype", r(n("FlowType"), null)),
                n("DeclareOpaqueType").bases("OpaqueType").build("id", "typeParameters", "supertype").field("impltype", r(n("FlowType"), null)),
                n("TypeCastExpression").bases("Expression").build("expression", "typeAnnotation").field("expression", n("Expression")).field("typeAnnotation", n("TypeAnnotation")),
                n("TupleTypeAnnotation").bases("FlowType").build("types").field("types", [n("FlowType")]),
                n("DeclareVariable").bases("Statement").build("id").field("id", n("Identifier")),
                n("DeclareFunction").bases("Statement").build("id").field("id", n("Identifier")).field("predicate", r(n("FlowPredicate"), null), l.null),
                n("DeclareClass").bases("InterfaceDeclaration").build("id"),
                n("DeclareModule").bases("Statement").build("id", "body").field("id", r(n("Identifier"), n("Literal"))).field("body", n("BlockStatement")),
                n("DeclareModuleExports").bases("Statement").build("typeAnnotation").field("typeAnnotation", n("TypeAnnotation")),
                n("DeclareExportDeclaration").bases("Declaration").build("default", "declaration", "specifiers", "source").field("default", Boolean).field("declaration", r(n("DeclareVariable"), n("DeclareFunction"), n("DeclareClass"), n("FlowType"), n("TypeAlias"), n("DeclareOpaqueType"), n("InterfaceDeclaration"), null)).field("specifiers", [r(n("ExportSpecifier"), n("ExportBatchSpecifier"))], l.emptyArray).field("source", r(n("Literal"), null), l.null),
                n("DeclareExportAllDeclaration").bases("Declaration").build("source").field("source", r(n("Literal"), null), l.null),
                n("ImportDeclaration").field("importKind", r("value", "type", "typeof"), (function() {
                        return "value"
                    }
                )),
                n("FlowPredicate").bases("Flow"),
                n("InferredPredicate").bases("FlowPredicate").build(),
                n("DeclaredPredicate").bases("FlowPredicate").build("value").field("value", n("Expression")),
                n("Function").field("predicate", r(n("FlowPredicate"), null), l.null),
                n("CallExpression").field("typeArguments", r(null, n("TypeParameterInstantiation")), l.null),
                n("NewExpression").field("typeArguments", r(null, n("TypeParameterInstantiation")), l.null),
                n("EnumDeclaration").bases("Declaration").build("id", "body").field("id", n("Identifier")).field("body", r(n("EnumBooleanBody"), n("EnumNumberBody"), n("EnumStringBody"), n("EnumSymbolBody"))),
                n("EnumBooleanBody").build("members", "explicitType").field("members", [n("EnumBooleanMember")]).field("explicitType", Boolean),
                n("EnumNumberBody").build("members", "explicitType").field("members", [n("EnumNumberMember")]).field("explicitType", Boolean),
                n("EnumStringBody").build("members", "explicitType").field("members", r([n("EnumStringMember")], [n("EnumDefaultedMember")])).field("explicitType", Boolean),
                n("EnumSymbolBody").build("members").field("members", [n("EnumDefaultedMember")]),
                n("EnumBooleanMember").build("id", "init").field("id", n("Identifier")).field("init", r(n("Literal"), Boolean)),
                n("EnumNumberMember").build("id", "init").field("id", n("Identifier")).field("init", n("Literal")),
                n("EnumStringMember").build("id", "init").field("id", n("Identifier")).field("init", n("Literal")),
                n("EnumDefaultedMember").build("id").field("id", n("Identifier"))
        }
            ,
            e.exports = t.default
    },
    ...
    ead6: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.default = function e(t) {
                ...
                for (let l = 0; l < t.length; l++) {
                    ...
                    if (u && !(s.indexOf(u) >= 0)) {
                        if ((0,
                            r.isAnyTypeAnnotation)(u))
                            return [u];
                        if ((0,
                            r.isFlowBaseAnnotation)(u))
                            a.set(u.type, u);
                        else if ((0,
                            r.isUnionTypeAnnotation)(u))
                            o.has(u.types) || (t = t.concat(u.types),
                                o.add(u.types));
                        else if ((0,
                            r.isGenericTypeAnnotation)(u)) {
                            const t = i(u.id);
                            if (n.has(t)) {
                                let r = n.get(t);
                                r.typeParameters ? u.typeParameters && (r.typeParameters.params = e(r.typeParameters.params.concat(u.typeParameters.params))) : r = u.typeParameters
        ...
        function i(e) {
            return (0,
                r.isIdentifier)(e) ? e.name : `${e.id.name}.${i(e.qualification)}`
        }
    },
    eb5b: function(e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            ...
            ,
            t.arrowFunctionExpression = function(e, t, n=!1) {
                return (0,
                    r.default)({
            ...
            ,
            t.breakStatement = function(e=null) {
                return (0,
                    r.default)({
                    type: "BreakStatement",
                    label: e
            ...
            ,
            t.catchClause = function(e=null, t) {
                return (0,
                    r.default)({
                    type: "CatchClause",
                    param: e,
            ...
            ,
            t.classAccessorProperty = function(e, t=null, n=null, i=null, a=!1, o=!1) {
                return (0,
                    r.default)({
            ...
            ,
            t.classDeclaration = function(e, t=null, n, i=null) {
                return (0,
                    r.default)({
            ...
            ,
            t.classExpression = function(e=null, t=null, n, i=null) {
                return (0,
                    r.default)({
            ...
            ,
            t.classImplements = function(e, t=null) {
                return (0,
                    r.default)({
            ...
            ,
            t.classMethod = function(e="method", t, n, i, a=!1, o=!1, s=!1, l=!1) {
                return (0,
                    r.default)({
                    type: "ClassMethod",
                    kind: e,
            ...
            ,
            t.classPrivateMethod = function(e="method", t, n, i, a=!1) {
                return (0,
                    r.default)({
            ...
            ,
            t.classPrivateProperty = function(e, t=null, n=null, i=!1) {
                return (0,
                    r.default)({
            ...
            ,
            t.classProperty = function(e, t=null, n=null, i=null, a=!1, o=!1) {
                return (0,
                    r.default)({
                    type: "ClassProperty",
                    key: e,
            ...
            ,
            t.continueStatement = function(e=null) {
                return (0,
                    r.default)({
            ...
            ,
            t.declareClass = function(e, t=null, n=null, i) {
                return (0,
                    r.default)({
                    type: "DeclareClass",
                    id: e,
            ...
            ,
            t.declareExportDeclaration = function(e=null, t=null, n=null) {
                return (0,
                    r.default)({
            ...
            ,
            t.declareInterface = function(e, t=null, n=null, i) {
                return (0,
                    r.default)({
            ...
            ,
            t.declareModule = function(e, t, n=null) {
                return (0,
                    r.default)({
                    type: "DeclareModule",
                    id: e,
            ...
            ,
            t.declareOpaqueType = function(e, t=null, n=null) {
                return (0,
                    r.default)({
            ...
            ,
            t.declareTypeAlias = function(e, t=null, n) {
                return (0,
                    r.default)({
            ...
            ,
            t.exportNamedDeclaration = function(e=null, t=[], n=null) {
                return (0,
                    r.default)({
            ...
            ,
            t.file = function(e, t=null, n=null) {
                return (0,
                    r.default)({
                    type: "File",
                    program: e,
            ...
            ,
            t.forOfStatement = function(e, t, n, i=!1) {
                return (0,
                    r.default)({
                    type: "ForOfStatement",
                    left: e,
            ...
            ,
            t.forStatement = function(e=null, t=null, n=null, i) {
                return (0,
                    r.default)({
                    type: "ForStatement",
                    init: e,
            ...
            ,
            t.functionDeclaration = function(e=null, t, n, i=!1, a=!1) {
                return (0,
                    r.default)({
            ...
            ,
            t.functionExpression = function(e=null, t, n, i=!1, a=!1) {
                return (0,
                    r.default)({
            ...
            ,
            t.functionTypeAnnotation = function(e=null, t, n=null, i) {
                return (0,
                    r.default)({
            ...
            ,
            t.functionTypeParam = function(e=null, t) {
                return (0,
                    r.default)({
            ...
            ,
            t.genericTypeAnnotation = function(e, t=null) {
                return (0,
                    r.default)({
            ...
            ,
            t.ifStatement = function(e, t, n=null) {
                return (0,
                    r.default)({
                    type: "IfStatement",
                    test: e,
            ...
            ,
            t.interfaceDeclaration = function(e, t=null, n=null, i) {
                return (0,
                    r.default)({
            ...
            ,
            t.interfaceExtends = function(e, t=null) {
                return (0,
                    r.default)({
            ...
            ,
            t.interfaceTypeAnnotation = function(e=null, t) {
                return (0,
                    r.default)({
            ...
            ,
            t.jSXAttribute = t.jsxAttribute = function(e, t=null) {
                return (0,
                    r.default)({
                    type: "JSXAttribute",
                    name: e,
            ...
            ,
            t.jSXElement = t.jsxElement = function(e, t=null, n, i=null) {
                return (0,
                    r.default)({
                    type: "JSXElement",
                    openingElement: e,
        ...
        ,
        t.jSXOpeningElement = t.jsxOpeningElement = function(e, t, n=!1) {
            return (0,
                r.default)({
        ...
        ,
        t.memberExpression = function(e, t, n=!1, i=null) {
            return (0,
                r.default)({
        ...
        ,
        t.objectMethod = function(e="method", t, n, i, a=!1, o=!1, s=!1) {
            return (0,
                r.default)({
                type: "ObjectMethod",
                kind: e,
        ...
        ,
        t.objectProperty = function(e, t, n=!1, i=!1, a=null) {
            return (0,
                r.default)({
                type: "ObjectProperty",
                key: e,
        ...
        ,
        t.objectTypeAnnotation = function(e, t=[], n=[], i=[], a=!1) {
            return (0,
                r.default)({
        ...
        ,
        t.objectTypeIndexer = function(e=null, t, n, i=null) {
            return (0,
                r.default)({
        ...
        ,
        t.objectTypeInternalSlot = function(e, t, n, i, a) {
            return (0,
                r.default)({
        ...
        ,
        t.objectTypeProperty = function(e, t, n=null) {
            return (0,
                r.default)({
        ...
        ,
        t.opaqueType = function(e, t=null, n=null, i) {
            return (0,
                r.default)({
                type: "OpaqueType",
                id: e,
        ...
        ,
        t.optionalMemberExpression = function(e, t, n=!1, i) {
            return (0,
                r.default)({
        ...
        ,
        t.program = function(e, t=[], n="script", i=null) {
            return (0,
                r.default)({
                type: "Program",
                body: e,
        ...
        ,
        t.returnStatement = function(e=null) {
            return (0,
                r.default)({
        ...
        ,
        t.switchCase = function(e=null, t) {
            return (0,
                r.default)({
                type: "SwitchCase",
                test: e,
        ...
        ,
        t.templateElement = function(e, t=!1) {
            return (0,
                r.default)({
        ...
        ,
        t.tryStatement = function(e, t=null, n=null) {
            return (0,
                r.default)({
                type: "TryStatement",
                block: e,
        ...
        ,
        t.tSCallSignatureDeclaration = t.tsCallSignatureDeclaration = function(e=null, t, n=null) {
            return (0,
                r.default)({
        ...
        ,
        t.tSConditionalType = t.tsConditionalType = function(e, t, n, i) {
            return (0,
                r.default)({
        ...
        ,
        t.tSConstructSignatureDeclaration = t.tsConstructSignatureDeclaration = function(e=null, t, n=null) {
            return (0,
                r.default)({
        ...
        ,
        t.tSConstructorType = t.tsConstructorType = function(e=null, t, n=null) {
            return (0,
                r.default)({
        ...
        ,
        t.tSDeclareFunction = t.tsDeclareFunction = function(e=null, t=null, n, i=null) {
            return (0,
                r.default)({
        ...
        ,
        t.tSDeclareMethod = t.tsDeclareMethod = function(e=null, t, n=null, i, a=null) {
            return (0,
                r.default)({
        ...
        ,
        t.tSEnumMember = t.tsEnumMember = function(e, t=null) {
            return (0,
                r.default)({
                type: "TSEnumMember",
                id: e,
        ...
        ,
        t.tSExpressionWithTypeArguments = t.tsExpressionWithTypeArguments = function(e, t=null) {
            return (0,
                r.default)({
        ...
        ,
        t.tSFunctionType = t.tsFunctionType = function(e=null, t, n=null) {
            return (0,
                r.default)({
                type: "TSFunctionType",
                typeParameters: e,
        ...
        ,
        t.tSImportType = t.tsImportType = function(e, t=null, n=null) {
            return (0,
                r.default)({
                type: "TSImportType",
                argument: e,
        ...
        ,
        t.tSIndexSignature = t.tsIndexSignature = function(e, t=null) {
            return (0,
                r.default)({
        ...
        ,
        t.tSInstantiationExpression = t.tsInstantiationExpression = function(e, t=null) {
            return (0,
                r.default)({
        ...
        ,
        t.tSInterfaceDeclaration = t.tsInterfaceDeclaration = function(e, t=null, n=null, i) {
            return (0,
                r.default)({
        ...
        ,
        t.tSMappedType = t.tsMappedType = function(e, t=null, n=null) {
            return (0,
                r.default)({
                type: "TSMappedType",
                typeParameter: e,
        ...
        ,
        t.tSMethodSignature = t.tsMethodSignature = function(e, t=null, n, i=null) {
            return (0,
                r.default)({
        ...
        ,
        t.tSNamedTupleMember = t.tsNamedTupleMember = function(e, t, n=!1) {
            return (0,
                r.default)({
        ...
        ,
        t.tSPropertySignature = t.tsPropertySignature = function(e, t=null, n=null) {
            return (0,
                r.default)({
        ...
        ,
        t.tSTypeAliasDeclaration = t.tsTypeAliasDeclaration = function(e, t=null, n) {
            return (0,
                r.default)({
        ...
        ,
        t.tSTypeParameter = t.tsTypeParameter = function(e=null, t=null, n) {
            return (0,
                r.default)({
        ...
        ,
        t.tSTypePredicate = t.tsTypePredicate = function(e, t=null, n=null) {
            return (0,
                r.default)({
        ...
        ,
        t.tSTypeQuery = t.tsTypeQuery = function(e, t=null) {
            return (0,
                r.default)({
                type: "TSTypeQuery",
                exprName: e,
        ...
        ,
        t.tSTypeReference = t.tsTypeReference = function(e, t=null) {
            return (0,
                r.default)({
        ...
        ,
        t.typeAlias = function(e, t=null, n) {
            return (0,
                r.default)({
                type: "TypeAlias",
                id: e,
        ...
        ,
        t.typeParameter = function(e=null, t=null, n=null) {
            return (0,
                r.default)({
                type: "TypeParameter",
                bound: e,
        ...
        ,
        t.unaryExpression = function(e, t, n=!0) {
            return (0,
                r.default)({
        ...
        ,
        t.updateExpression = function(e, t, n=!1) {
            return (0,
                r.default)({
        ...
        ,
        t.variableDeclarator = function(e, t=null) {
            return (0,
                r.default)({
        ...
        ,
        t.yieldExpression = function(e=null, t=!1) {
            return (0,
                r.default)({
    ...
    f28d: function(e, t, n) {
        ...
        u("ArrayExpression", {
                ...
                fields: {
                    operator: {
                        validate: function() {
                            ...
                            const e = (0,
                                l.assertOneOf)(...s.ASSIGNMENT_OPERATORS)
                                , t = (0,
                                l.assertOneOf)("=");
                            return function(n, i, a) {
                                ((0,
                                    r.default)("Pattern", n.left) ? t : e)(n, i, a)
                            }
                        }()
                    },
                    left: {
                        validate: Object({
                            ...
                            l.assertNodeType)("Identifier", "MemberExpression", "ArrayPattern", "ObjectPattern", "TSAsExpression", "TSTypeAssertion", "TSNonNullExpression") : (0,
            ...
            u("BinaryExpression", {
                ...
                fields: {
                    operator: {
                        validate: (0,
                            l.assertOneOf)(...s.BINARY_OPERATORS)
                    },
                    left: {
                        validate: function() {
                            const e = (0,
            ...
            u("CallExpression", {
                ...
                fields: Object.assign({
                    callee: {
                        validate: (0,
                            l.assertNodeType)("Expression", "Super", "V8IntrinsicIdentifier")
                    },
                    arguments: {
                        validate: (0,
                            l.chain)((0,
                ...
                fields: {
                    left: {
                        validate: Object({
                            ...
                            l.assertNodeType)("VariableDeclaration", "Identifier", "MemberExpression", "ArrayPattern", "ObjectPattern", "TSAsExpression", "TSTypeAssertion", "TSNonNullExpression") : (0,
        ...
        t.functionTypeAnnotationCommon = c;
        ...
        t.functionDeclarationCommon = d,
            u("FunctionDeclaration", {
                ...
                fields: Object.assign({}, d(), c(), {
                    ...
                    predicate: {
                        validate: (0,
                            l.assertNodeType)("DeclaredPredicate", "InferredPredicate"),
                        optional: !0
                    }
                }),
                ...
                validate: function() {
                    ...
                    return function(t, n, i) {
                        (0,
                            r.default)("ExportDefaultDeclaration", t) || e(i, "id", i.id)
                    }
                }()
            }),
        ...
        t.patternLikeCommon = f,
            u("Identifier", {
                        ...
                        validate: (0,
                            ...
                            l.assertValueType)("string"), Object.assign((function(e, t, n) {
                                if (Object({
                                    ...
                                    i.default)(n, !1))
                                    throw new TypeError(`"${n}" is not a valid identifier name`)
                            }
                        ), {
                            type: "string"
                        }))
                ...
                validate(e, t, n) {
                    ...
                    if ("property" === o) {
                        if ((0,
                            r.default)("MemberExpression", e, s))
                            return;
                        if ((0,
                            r.default)("OptionalMemberExpression", e, s))
                            return
                    } else if ("key" === o) {
                        if ((0,
                            r.default)("Property", e, s))
                            return;
                        if ((0,
                            r.default)("Method", e, s))
                            return
                    } else if ("exported" === o) {
                        if ((0,
                            r.default)("ExportSpecifier", e))
                            return
                    } else if ("imported" === o) {
                        if ((0,
                            r.default)("ImportSpecifier", e, {
                            imported: n
                        }))
                            return
                    } else if ("meta" === o && (0,
                        r.default)("MetaProperty", e, {
                        meta: n
                    }))
                        return;
                    if (((0,
                        a.isKeyword)(n.name) || (0,
                        a.isReservedWord)(n.name, !1)) && "this" !== n.name)
                    ...
                    flags: {
                        validate: (0,
                            ...
                            l.assertValueType)("string"), Object.assign((function(e, t, n) {
                                ...
                                if (r)
                                    throw new TypeError(`"${r[0]}" is not a valid RegExp flag`)
                            }
                        ), {
                            type: "string"
                        })),
            ...
            u("LogicalExpression", {
                ...
                fields: {
                    operator: {
                        validate: (0,
                            l.assertOneOf)(...s.LOGICAL_OPERATORS)
                    },
                    left: {
                        validate: (0,
                            l.assertNodeType)("Expression")
            ...
            u("MemberExpression", {
                builder: ["object", "property", "computed", ...Object({
                    NODE_ENV: "production",
                    BASE_URL: ""
                ...
                fields: Object.assign({
                    object: {
                        validate: (0,
                            l.assertNodeType)("Expression", "Super")
                    },
                    property: {
                        validate: function() {
                            const e = (0,
            ...
            u("ObjectMethod", {
                ...
                fields: Object.assign({}, p(), c(), {
                    ...
                    key: {
                        validate: function() {
                            const e = (0,
                                l.assertNodeType)("Identifier", "StringLiteral", "NumericLiteral", "BigIntLiteral")
                                , t = (0,
                                l.assertNodeType)("Expression")
                                , n = function(n, r, i) {
                                (n.computed ? t : e)(n, r, i)
                            };
                            return n.oneOfNodeTypes = ["Expression", "Identifier", "StringLiteral", "NumericLiteral", "BigIntLiteral"],
                                n
                        }()
                    },
                    decorators: {
            ...
            u("ObjectProperty", {
                builder: ["key", "value", "computed", "shorthand", ...Object({
                    NODE_ENV: "production",
                    BASE_URL: ""
                ...
                fields: {
                    ...
                    key: {
                        validate: function() {
                            const e = (0,
                                l.assertNodeType)("Identifier", "StringLiteral", "NumericLiteral", "BigIntLiteral", "DecimalLiteral", "PrivateName")
                                , t = (0,
                                l.assertNodeType)("Expression");
                            return Object.assign((function(n, r, i) {
                                    (n.computed ? t : e)(n, r, i)
                ...
                validate: function() {
                    const e = (0,
                        l.assertNodeType)("Identifier", "Pattern", "TSAsExpression", "TSNonNullExpression", "TSTypeAssertion")
                        , t = (0,
                        l.assertNodeType)("Expression");
                    return function(n, i, a) {
                        if (!Object({
                            ...
                            return;
                        ((0,
                            r.default)("ObjectPattern", n) ? e : t)(a, "value", a.value)
                    }
                }()
            }),
            u("RestElement", {
                ...
                fields: Object.assign({}, f(), {
                    argument: {
                        validate: Object({
                            ...
                            l.assertNodeType)("Identifier", "ArrayPattern", "ObjectPattern", "MemberExpression", "TSAsExpression", "TSTypeAssertion", "TSNonNullExpression") : (0,
                            l.assertNodeType)("LVal")
                    },
                    optional: {
                        validate: (0,
                ...
                validate(e, t) {
                    ...
                    const [,r,i] = n;
                    if (e[r].length > +i + 1)
                        throw new TypeError("RestElement must be last element of " + r)
                }
            }),
            u("ReturnStatement", {
                visitor: ["argument"],
            ...
            u("UnaryExpression", {
                ...
                fields: {
                    ...
                    operator: {
                        validate: (0,
                            l.assertOneOf)(...s.UNARY_OPERATORS)
                    }
                },
                visitor: ["argument"],
            ...
            u("UpdateExpression", {
                ...
                fields: {
                    ...
                    operator: {
                        validate: (0,
                            l.assertOneOf)(...s.UPDATE_OPERATORS)
                    }
                },
                visitor: ["argument"],
                aliases: ["Expression"]
            ...
            u("AssignmentPattern", {
                ...
                fields: Object.assign({}, f(), {
                    left: {
                        validate: (0,
                            l.assertNodeType)("Identifier", "ObjectPattern", "ArrayPattern", "MemberExpression", "TSAsExpression", "TSTypeAssertion", "TSNonNullExpression")
                    },
                    right: {
                        validate: (0,
                            l.assertNodeType)("Expression")
                ...
                fields: Object.assign({}, f(), {
                    elements: {
                        validate: (0,
                            ...
                            l.assertValueType)("array"), (0,
                            l.assertEach)((0,
                            l.assertNodeOrValueType)("null", "PatternLike", "LVal")))
                    },
                    decorators: {
                        validate: (0,
                            l.chain)((0,
                ...
                fields: {
                    body: {
                        validate: (0,
                            ...
                            l.assertValueType)("array"), (0,
                            l.assertEach)((0,
                            l.assertNodeType)("ClassMethod", "ClassPrivateMethod", "ClassProperty", "ClassPrivateProperty", "ClassAccessorProperty", "TSDeclareMethod", "TSIndexSignature", "StaticBlock")))
                    }
                }
            }),
            u("ClassExpression", {
            ...
            u("ExportDefaultDeclaration", {
                ...
                fields: {
                    declaration: {
                        validate: (0,
                            l.assertNodeType)("TSDeclareFunction", "FunctionDeclaration", "ClassDeclaration", "Expression")
                    },
                    exportKind: (0,
                        l.validateOptional)((0,
                        l.assertOneOf)("value"))
                    ...
                    left: {
                        validate: function() {
                            ...
                            const e = (0,
                                ...
                                , t = (0,
                                l.assertNodeType)("Identifier", "MemberExpression", "ArrayPattern", "ObjectPattern", "TSAsExpression", "TSTypeAssertion", "TSNonNullExpression");
                            return function(n, i, a) {
                                (0,
                                    r.default)("VariableDeclaration", a) ? e(n, i, a) : t(n, i, a)
                            }
                        }()
                    },
                    right: {
                    ...
                    meta: {
                        validate: (0,
                            ...
                            l.assertNodeType)("Identifier"), Object.assign((function(e, t, n) {
                                ...
                                if (!(0,
                                    r.default)("Identifier", e.property, {
                                    name: i
                                }))
        ...
        const y = ()=>({
            ...
            key: {
                validate: (0,
                    ...
                    l.assertNodeType)("Identifier", "StringLiteral", "NumericLiteral", "BigIntLiteral", "Expression"))
            }
        });
                        ...
                        validate: (0,
                            ...
                            cooked: {
                                ...
                                try {
                                    ...
                                    ;
                                    ({str: n, containsInvalid: r} = (0,
                                        o.readStringContents)("template", t, 0, 0, 0, {
                                        unterminated() {
                                            i = !0
                                        },
                ...
                fields: Object.assign({}, y(), {
                    key: {
                        validate: (0,
                            l.chain)(function() {
                            const e = (0,
                                l.assertNodeType)("Identifier", "StringLiteral", "NumericLiteral", "BigIntLiteral", "PrivateName")
                                , t = (0,
                                l.assertNodeType)("Expression");
                            return function(n, r, i) {
                                (n.computed ? t : e)(n, r, i)
                            ...
                            l.assertNodeType)("Identifier", "StringLiteral", "NumericLiteral", "BigIntLiteral", "Expression", "PrivateName"))
                    },
                    value: {
                        validate: (0,
                            l.assertNodeType)("Expression"),
    ...
    fb84: function(e, t, n) {
        ...
        var r = n("252a");
        const {isArrayExpression: i, isAssignmentExpression: a, isBinary: o, isBlockStatement: s, isCallExpression: l, isFunction: u, isIdentifier: p, isLiteral: c, isMemberExpression: d, isObjectExpression: f, isOptionalCallExpression: y, isOptionalMemberExpression: m, isStringLiteral: h} = r;
        function T(e, t={}) {
            return d(e) || m(e) ? (T(e.object, t),
            e.computed && T(e.property, t)) : o(e) || a(e) ? (T(e.left, t),
                T(e.right, t)) : l(e) || y(e) ? (t.hasCall = !0,
                T(e.callee, t)) : u(e) ? t.hasFunction = !0 : p(e) && (t.hasHelper = t.hasHelper || b(e.callee)),
                t
        }
        function b(e) {
            return d(e) ? b(e.object) || b(e.property) : p(e) ? "require" === e.name || "_" === e.name[0] : l(e) ? b(e.callee) : !(!o(e) && !a(e)) && (p(e.left) && b(e.left) || b(e.right))
        }
        function S(e) {
            return c(e) || f(e) || i(e) || p(e) || d(e)
        }
        const E = {
    ...
    fcea: function(e, t, n) {
        ...
        var r = n("4f38")
            , i = r.__importDefault(n("41ba"))
            , a = r.__importDefault(n("aa20"))
            , o = r.__importDefault(n("21b1"))
            , s = r.__importDefault(n("7f4b"))
            , l = r.__importDefault(n("6911"));
        t.default = function(e) {
            var t = function() {
                var e = []
                    , t = [];
            ...
            return {
                ...
                getBuilderName: n.getBuilderName,
                astNodesAreEquivalent: t.use(o.default),
                finalize: n.finalize,
                Path: t.use(s.default),
    ...
    fe0d: function(e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            t.default = function(e, t, n) {
                ...
                let o;
                for (o = e; (0,
                    r.isMemberExpression)(o); o = o.object)
                    a.push(o.property);
                if (a.push(o),
                a.length < i.length)
                    return !1;
                if (!n && a.length > i.length)
                    return !1;
                for (let e = 0, t = a.length - 1; e < i.length; e++,
                    t--) {
                    const n = a[t];
                    let o;
                    if ((0,
