...
(window.webpackJsonp = window.webpackJsonp || []).push([["chunk-adb9e944"], {
    "19aa0": function(t, e, n) {
        "use strict";
        n.r(e);
        var o = (n("b0c0"),
            n("d3b7"),
            ...
            created: function() {
                var t = this;
                this.openApiRaw = o.a.json5stringify(this.api.openApiRaw),
            ...
            methods: {
                ...
                triggerDownloadOpen: function() {
                    var t = this.openApiRaw
                ...
                copyOpenApi: function() {
                    var t = this
                        , e = "btnCopyOpenApi" + this.api.id
                        , n = new i.a("#" + e,{
                        text: function() {
                            return t.openApiRaw
                        }
                    ...
                    n.on("success", (function() {
                            var e = t.getCurrentI18nInstance().message.copy.open.success;
                            t.$message.info(e)
                        }
                    )),
                        n.on("error", (function(e) {
                                var n = t.getCurrentI18nInstance().message.copy.open.fail;
                                t.$message.info(n)
                            }
                        ))
                }
            ...
            , u = Object(c.a)(a, (function() {
                ...
                return n("div", {
                    ...
                    domProps: {
                        innerHTML: t._s(t.$t("open.copy"))
                    }
                }, [t._v(" 复 制 ")])], 1), n("a-button", {
                    staticStyle: {
                        "margin-left": "10px"
                    },
                    on: {
                        click: t.triggerDownloadOpen
                    }
                }, [n("a-icon", {
                    attrs: {
                        type: "download"
                    ...
                    domProps: {
                        innerHTML: t._s(t.$t("open.download"))
                    }
                }, [t._v(" 下 载 ")])], 1)], 1), n("a-row", {
                    staticStyle: {
                        "margin-top": "10px"
                    },
                    attrs: {
                        id: "knife4jDocumentOpenApiShowEditor"
                    }
                }, [n("editor-show", {
                    attrs: {
                        value: t.openApiRaw
